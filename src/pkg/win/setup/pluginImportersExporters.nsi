...
Section "Download glib 2.4"
	...
	;;;;;;;
	; iconv
	${dlFile} "http://www.abisource.com/downloads/dependencies/libiconv/libiconv-1.9.1.bin.woe32.zip" "$TEMP\libiconv-1.9.1.bin.woe32.zip" "ERROR: failed to download http://www.gimp.org/~tml/gimp/win32/libiconv-1.9.1.bin.woe32.zip"
	...
	;;;;;;
	; intl
	${dlFile} "http://www.abisource.com/downloads/dependencies/gettext/gettext-runtime-0.13.1.zip" "$TEMP\gettext-runtime-0.13.1.zip" "ERROR: failed to download http://www.gimp.org/~tml/gimp/win32/gettext-runtime-0.13.1.zip"
	StrCmp $0 "success" 0 doCleanup
	...
	;;;;;;;;;;;;;;;;;;
	; glib and gobject
	${dlFile} "http://www.abisource.com/downloads/dependencies/glib/glib-2.4.5.zip" "$TEMP\glib-2.4.5.zip" "ERROR: failed to download http://www.gimp.org/~tml/gimp/win32/glib-2.4.5.zip"
	StrCmp $0 "success" 0 doCleanup
	...
	;;;;;;;;
	; libgsf
	${dlFile} "http://www.abisource.com/downloads/dependencies/libgsf/libgsf-1.8.2-20040121.zip" "$TEMP\libgsf-1.8.2-20040121.zip" "ERROR: failed to download http://www.gimp.org/~tml/gimp/win32/libgsf-1.8.2-20040121.zip"
	StrCmp $0 "success" 0 doCleanup
	...
	;;;;;;;;;
	; libxml2
	${dlFile} "http://www.abisource.com/downloads/dependencies/libxml2/libxml2-2.4.12-bin.zip" "$TEMP\libxml2-2.4.12-bin.zip" "ERROR: failed to download http://dl.sourceforge.net/gnuwin32/libxml2-2.4.12-bin.zip"
	StrCmp $0 "success" 0 doCleanup
