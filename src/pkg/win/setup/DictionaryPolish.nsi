...
Name "AbiWord Dictionary - Polish"
Icon "..\..\pkg\win\setup\setup.ico"
OutFile "AbiWord_Dictionary_Polish.exe"
...
ComponentText "This will install Abiword's Polish Dictionary on your computer."
