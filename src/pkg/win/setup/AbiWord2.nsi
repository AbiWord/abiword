...
Section "Abiword.exe (required)"
	...
	WriteRegStr HKLM SOFTWARE\Abisuite\AbiWord\v2 "Install_Dir" "$INSTDIR"
	...
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Abiword2" "DisplayName" "Abiword 2 (remove only)"
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Abiword2" "UninstallString" '"$INSTDIR\UninstallAbiWord2.exe"'

	; New Uninstaller 
	WriteUninstaller "UninstallAbiWord2.exe"
...
Section "Start Menu Shortcuts (Current User)"
	...
	CreateShortCut "$SMPROGRAMS\Abiword\Uninstall Abiword.lnk" "$INSTDIR\UninstallAbiWord2.exe" "" "$INSTDIR\UninstallAbiWord2.exe" 0
...
Section "Uninstall"
	...
	DeleteRegKey HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Abiword2"
	DeleteRegKey HKLM SOFTWARE\Abisuite\AbiWord\v2
