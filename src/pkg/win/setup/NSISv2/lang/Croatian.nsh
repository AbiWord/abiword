...
${LSTR} DESC_ssection_core            "Osnovni (jezgreni) komplet komponenti potrebne za pravilan rad programa AbiWord."
...
${LSTR} DESC_ssection_fa_shellupdate  "Dodaje unose u registar koji omoguæuju ljuski Explorera da pomoæu programa AbiWord otvara razlièito oblikovane datoteke."
${LSTR} DESC_section_fa_abw           "Odreðuje da bi AbiWord trebao biti upotrebljavan za otvaranje datoteka u njihovom izvornom obliku.  (Preporuèeno)"
${LSTR} DESC_section_fa_awt           "Odreðuje da bi AbiWord trebao biti upotrebljavan za otvaranje predložaka u njihovom izvornom obliku.  (Preporuèeno)"
${LSTR} DESC_section_fa_zabw          "Odreðuje da bi AbiWord trebao biti upotrebljavan za otvaranje komprimiranih dokumenata u njihovom izvornom obliku.  (Preporuèeno)"
${LSTR} DESC_section_fa_doc           "Odreðuje da bi AbiWord trebao biti upotrebljavan za otvaranje Microsoft Word (R) izvorno oblikovanih dokumenata."
${LSTR} DESC_section_fa_rtf           "Odreðuje da bi AbiWord trebao biti upotrebljavan za otvaranje Rich Text datoteka, 'standardnog' oblika za ureðivaèe teksta."
...
${LSTR} DESC_section_clipart          "Instalira slike (isjeèke) koji se mogu umetati u dokumente."
