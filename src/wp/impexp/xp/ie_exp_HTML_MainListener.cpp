...
static const char * s_DTD_XHTML_AWML = DTD_XHTML_AWML;

static const char * s_DTD_XHTML = DTD_XHTML;

static const char * s_DTD_HTML4 = DTD_HTMl4;
...
IE_Exp_HTML_MainListener::~IE_Exp_HTML_MainListener()
{
    ...
    UT_DEBUGMSG(("DELETED Listener %p \n", this));
}
