...
#include "ap_MacDialog_Options.h"
...
class OptionsWin:public BWindow {
	public:
		...
		void SetDlg(AP_MacDialog_Options *dlg);
		virtual void DispatchMessage(BMessage *msg, BHandler *handler);
		virtual bool QuitRequested(void);
		
	private:
		AP_MacDialog_Options 	*m_DlgOptions;
...
void OptionsWin::SetDlg(AP_MacDialog_Options *dlg)
{
	m_DlgOptions = dlg;
...
XAP_Dialog * AP_MacDialog_Options::static_constructor(XAP_DialogFactory * pFactory,
                                                         XAP_Dialog_Id id)
{
    AP_MacDialog_Options * p = new AP_MacDialog_Options(pFactory,id);
    return p;
}

AP_MacDialog_Options::AP_MacDialog_Options(XAP_DialogFactory * pDlgFactory,
                                                 XAP_Dialog_Id id)
    : AP_Dialog_Options(pDlgFactory,id)
{
}

AP_MacDialog_Options::~AP_MacDialog_Options(void)
{
}
...
#if 0
GtkWidget *AP_MacDialog_Options::_lookupWidget ( tControl id )
{
	switch (id)
	{
...
void s_checkbutton_toggle( GtkWidget *w, AP_MacDialog_Options *dlg )
{ 
	UT_ASSERT(dlg); 
...
void AP_MacDialog_Options::runModal(XAP_Frame * pFrame)
{
#if 0
	m_pFrame = pFrame;
	BMessage msg;
...
UT_Dimension AP_MacDialog_Options::_gatherViewRulerUnits(void) 
{
#if 0
	int selID = 0;
...
void    AP_MacDialog_Options::_setViewRulerUnits(UT_Dimension dim) 
{
#if 0
	int n1;
...
int AP_MacDialog_Options::_gatherNotebookPageNum(void) 
{				
	return 0;
}			
