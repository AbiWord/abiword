...
#include "ap_MacDialog_ToggleCase.h"

/*****************************************************************/

XAP_Dialog * AP_MacDialog_ToggleCase::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_MacDialog_ToggleCase * p = new AP_MacDialog_ToggleCase(pFactory,id);
	return p;
}

AP_MacDialog_ToggleCase::AP_MacDialog_ToggleCase(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: AP_Dialog_ToggleCase(pDlgFactory,id)
{
}

AP_MacDialog_ToggleCase::~AP_MacDialog_ToggleCase(void)
{
}

void AP_MacDialog_ToggleCase::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
