...
XAP_Dialog * AP_MacDialog_Lists::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_MacDialog_Lists * p = new AP_MacDialog_Lists(pFactory,id);
	return p;
}

AP_MacDialog_Lists::AP_MacDialog_Lists(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: AP_Dialog_Lists(pDlgFactory,id)
{
}

AP_MacDialog_Lists::~AP_MacDialog_Lists(void)
{
}

void AP_MacDialog_Lists::Activate(XAP_Frame * pFrame)
{

// Standard Modeless Activate. Update dialog and raise it
}

void AP_MacDialog_Lists::Destroy(XAP_Frame * pFrame)
{
  // Standard Modeless destroy.
}

void AP_MacDialog_Lists::runModeless(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
