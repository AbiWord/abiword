...
XAP_Dialog * AP_MacDialog_InsertHyperlink::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_MacDialog_InsertHyperlink * p = new AP_MacDialog_InsertHyperlink(pFactory,id);
	return p;
}

AP_MacDialog_InsertHyperlink::AP_MacDialog_InsertHyperlink(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: AP_Dialog_InsertHyperlink(pDlgFactory,id)
{
}

AP_MacDialog_InsertHyperlink::~AP_MacDialog_InsertHyperlink(void)
{
}

void AP_MacDialog_InsertHyperlink::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
