...
#include "ap_MacDialog_New.h"

/*****************************************************************/

XAP_Dialog * AP_MacDialog_New::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_MacDialog_New * p = new AP_MacDialog_New(pFactory,id);
	return p;
}

AP_MacDialog_New::AP_MacDialog_New(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: AP_Dialog_New(pDlgFactory,id)
{
}

AP_MacDialog_New::~AP_MacDialog_New(void)
{
}

void AP_MacDialog_New::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
