...
XAP_Dialog * AP_MacDialog_ListRevisions::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_MacDialog_ListRevisions * p = new AP_MacDialog_ListRevisions(pFactory,id);
	return p;
}

AP_MacDialog_ListRevisions::AP_MacDialog_ListRevisions(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: AP_Dialog_ListRevisions(pDlgFactory,id)
{
}

AP_MacDialog_ListRevisions::~AP_MacDialog_ListRevisions(void)
{
}

void AP_MacDialog_ListRevisions::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
