...
AP_MacDialogFactory::AP_MacDialogFactory(AP_App * pApp)
	: AP_DialogFactory(pApp, NrElements(s_dlg_table), s_dlg_table)
{
}

AP_MacDialogFactory::AP_MacDialogFactory(XAP_Frame * pFrame)
	: AP_DialogFactory(pFrame, NrElements(s_dlg_table), s_dlg_table)
{
}

AP_MacDialogFactory::~AP_MacDialogFactory(void)
{
}
