...
#ifndef AP_MACDIALOG_STYLES_H
#define AP_MACDIALOG_STYLES_H
...
class AP_MacDialog_Styles: public AP_Dialog_Styles
{
public:
	AP_MacDialog_Styles(XAP_DialogFactory * pDlgFactory, XAP_Dialog_Id id);
	virtual ~AP_MacDialog_Styles(void);
