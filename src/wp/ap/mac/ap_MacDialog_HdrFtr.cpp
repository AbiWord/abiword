...
#include "ap_MacDialog_HdrFtr.h"

/*****************************************************************/

XAP_Dialog * AP_MacDialog_HdrFtr::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_MacDialog_HdrFtr * p = new AP_MacDialog_HdrFtr(pFactory,id);
	return p;
}

AP_MacDialog_HdrFtr::AP_MacDialog_HdrFtr(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: AP_Dialog_HdrFtr(pDlgFactory,id)
{
}

AP_MacDialog_HdrFtr::~AP_MacDialog_HdrFtr(void)
{
}

void AP_MacDialog_HdrFtr::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
