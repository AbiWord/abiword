...
#include "ap_MacDialog_Insert_Symbol.h"
...
XAP_Dialog * AP_MacDialog_Insert_Symbol::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_MacDialog_Insert_Symbol * p = new AP_MacDialog_Insert_Symbol(pFactory,id);
	return p;
}

AP_MacDialog_Insert_Symbol::AP_MacDialog_Insert_Symbol(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: AP_Dialog_Insert_Symbol(pDlgFactory,id)
{
}

AP_MacDialog_Insert_Symbol::~AP_MacDialog_Insert_Symbol(void)
{
}

void AP_MacDialog_Insert_Symbol::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
