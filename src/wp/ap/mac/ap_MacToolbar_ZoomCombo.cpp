...
/*****************************************************************/
EV_Toolbar_Control * AP_MacToolbar_ZoomCombo::static_constructor(EV_Toolbar * pToolbar,
														  XAP_Toolbar_Id id)
{
	AP_MacToolbar_ZoomCombo * p = new AP_MacToolbar_ZoomCombo(pToolbar,id);
	return p;
}

AP_MacToolbar_ZoomCombo::AP_MacToolbar_ZoomCombo(EV_Toolbar * pToolbar,
													 XAP_Toolbar_Id id)
...
AP_MacToolbar_ZoomCombo::~AP_MacToolbar_ZoomCombo(void)
{
