...
#include "ap_MacDialog_Background.h"

/*****************************************************************/

XAP_Dialog * AP_MacDialog_Background::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_MacDialog_Background * p = new AP_MacDialog_Background(pFactory,id);
	return p;
}

AP_MacDialog_Background::AP_MacDialog_Background(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: AP_Dialog_Background(pDlgFactory,id)
{
}

AP_MacDialog_Background::~AP_MacDialog_Background(void)
{
}

void AP_MacDialog_Background::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
