...
EV_Toolbar_Control * AP_MacToolbar_StyleCombo::static_constructor(EV_Toolbar * pToolbar,
														  XAP_Toolbar_Id id)
{
	AP_MacToolbar_StyleCombo * p = new AP_MacToolbar_StyleCombo(pToolbar,id);
	return p;
}

AP_MacToolbar_StyleCombo::AP_MacToolbar_StyleCombo(EV_Toolbar * pToolbar,
													 XAP_Toolbar_Id id)
...
AP_MacToolbar_StyleCombo::~AP_MacToolbar_StyleCombo(void)
{
...
UT_Bool AP_MacToolbar_StyleCombo::populate(void)
{
