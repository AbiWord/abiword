...
#include "ap_MacDialog_Stub.h"

/*****************************************************************/

XAP_Dialog * AP_MacDialog_Stub::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_MacDialog_Stub * p = new AP_MacDialog_Stub(pFactory,id);
	return p;
}

AP_MacDialog_Stub::AP_MacDialog_Stub(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: AP_Dialog_Stub(pDlgFactory,id)
{
}

AP_MacDialog_Stub::~AP_MacDialog_Stub(void)
{
}

void AP_MacDialog_Stub::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
