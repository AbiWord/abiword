...
#include "ap_MacDialog_MetaData.h"

/*****************************************************************/

XAP_Dialog * AP_MacDialog_MetaData::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_MacDialog_MetaData * p = new AP_MacDialog_MetaData(pFactory,id);
	return p;
}

AP_MacDialog_MetaData::AP_MacDialog_MetaData(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: AP_Dialog_MetaData(pDlgFactory,id)
{
}

AP_MacDialog_MetaData::~AP_MacDialog_MetaData(void)
{
}

void AP_MacDialog_MetaData::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
