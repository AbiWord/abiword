...
XAP_Dialog * AP_MacDialog_InsertBookmark::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_MacDialog_InsertBookmark * p = new AP_MacDialog_InsertBookmark(pFactory,id);
	return p;
}

AP_MacDialog_InsertBookmark::AP_MacDialog_InsertBookmark(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: AP_Dialog_InsertBookmark(pDlgFactory,id)
{
}

AP_MacDialog_InsertBookmark::~AP_MacDialog_InsertBookmark(void)
{
}

void AP_MacDialog_InsertBookmark::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
