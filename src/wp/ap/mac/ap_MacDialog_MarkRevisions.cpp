...
XAP_Dialog * AP_MacDialog_MarkRevisions::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_MacDialog_MarkRevisions * p = new AP_MacDialog_MarkRevisions(pFactory,id);
	return p;
}

AP_MacDialog_MarkRevisions::AP_MacDialog_MarkRevisions(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: AP_Dialog_MarkRevisions(pDlgFactory,id)
{
}

AP_MacDialog_MarkRevisions::~AP_MacDialog_MarkRevisions(void)
{
}

void AP_MacDialog_MarkRevisions::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
