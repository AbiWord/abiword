...
class AP_UnixDialog_Lists: public AP_Dialog_Lists
{
 ...
 private:
	...
	GtkWidget * m_oAlignList_adj; //changed GtkObject
	GtkWidget * m_wAlignListSpin;
	GtkWidget * m_oIndentAlign_adj; //changed GtkObject
	GtkWidget * m_wIndentAlignSpin;
	GtkWidget * m_oLevelSpin_adj; //changed GtkObject
	...
	GtkWidget * m_oStartSpin_adj; //changed GtkObject
