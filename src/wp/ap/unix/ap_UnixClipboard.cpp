										 ...
										 const char **pszFormatFound)
{
	if (getData(tFrom, rtfszFormatsAccepted, (void**)ppData, pLen, pszFormatFound))
		...
		return true;
	else if (getData(tFrom, vec_DynamicFormatsAccepted.data(), (void**)ppData, pLen, pszFormatFound))
		return true;  
...
bool AP_UnixClipboard::getDynamicData(T_AllowGet tFrom,
			  ...
			  const char **pszFormatFound)
{
  return getData ( tFrom, vec_DynamicFormatsAccepted.data(), (void**)ppData, pLen, pszFormatFound );
}
