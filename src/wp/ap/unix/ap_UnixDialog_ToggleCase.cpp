...
{
  ToggleCase tc = (ToggleCase) GPOINTER_TO_INT (gtk_object_get_user_data (G_OBJECT(radio)));
  dlg->setCase (tc);
}
...
void AP_UnixDialog_ToggleCase::_constructWindowContents (GtkWidget *vbox1)
{
  ...
  gtk_object_set_user_data (G_OBJECT(sentenceCase), GINT_TO_POINTER(CASE_SENTENCE));
  gtk_object_set_user_data (G_OBJECT(lowerCase), GINT_TO_POINTER(CASE_LOWER));
  gtk_object_set_user_data (G_OBJECT(upperCase), GINT_TO_POINTER(CASE_UPPER));
  gtk_object_set_user_data (G_OBJECT(firstUpperCase), GINT_TO_POINTER(CASE_FIRST_CAPITAL));
  gtk_object_set_user_data (G_OBJECT(toggleCase), GINT_TO_POINTER(CASE_TOGGLE));

  gtk_signal_connect (G_OBJECT(sentenceCase), "toggled",
		      GTK_SIGNAL_FUNC(s_toggled), (gpointer)this);
  gtk_signal_connect (G_OBJECT(lowerCase), "toggled",
		      GTK_SIGNAL_FUNC(s_toggled), (gpointer)this);
  gtk_signal_connect (G_OBJECT(upperCase), "toggled",
		      GTK_SIGNAL_FUNC(s_toggled), (gpointer)this);
  gtk_signal_connect (G_OBJECT(firstUpperCase), "toggled",
		      GTK_SIGNAL_FUNC(s_toggled), (gpointer)this);
  gtk_signal_connect (G_OBJECT(toggleCase), "toggled",
		      GTK_SIGNAL_FUNC(s_toggled), (gpointer)this);
}
