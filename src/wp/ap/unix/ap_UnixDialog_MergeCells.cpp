...
GtkWidget * AP_UnixDialog_MergeCells::_constructWindowContents(void)
{
	...
	frame1 = gtk_frame_new (pSS->getValueUTF8(AP_STRING_ID_DLG_MergeCells_Frame).utf8_str());
	...
	wlMergeLeft = gtk_label_new (pSS->getValueUTF8(AP_STRING_ID_DLG_MergeCells_Left).utf8_str());
	...
	wlMergeRight = gtk_label_new (pSS->getValueUTF8(AP_STRING_ID_DLG_MergeCells_Right).utf8_str());
	...
	wlMergeAbove = gtk_label_new (pSS->getValueUTF8(AP_STRING_ID_DLG_MergeCells_Above).utf8_str());
	...
	wlMergeBelow = gtk_label_new (pSS->getValueUTF8(AP_STRING_ID_DLG_MergeCells_Below).utf8_str());
