...
XAP_Dialog * AP_UnixDialog_Insert_Symbol::static_constructor(XAP_DialogFactory * pFactory,
															  XAP_Dialog_Id id)
{
	AP_UnixDialog_Insert_Symbol * p = new AP_UnixDialog_Insert_Symbol(pFactory,id);
	return p;
}

AP_UnixDialog_Insert_Symbol::AP_UnixDialog_Insert_Symbol(XAP_DialogFactory * pDlgFactory,
														   XAP_Dialog_Id id)
...
AP_UnixDialog_Insert_Symbol::~AP_UnixDialog_Insert_Symbol(void)
{
...
static void s_ok_clicked(GtkWidget * widget, AP_UnixDialog_Insert_Symbol * dlg)
{
	UT_ASSERT(widget && dlg);
	dlg->event_OK();
}
static void s_cancel_clicked(GtkWidget * widget, AP_UnixDialog_Insert_Symbol * dlg)
{
	UT_ASSERT(widget && dlg);
	dlg->event_Cancel();
}
...
static void s_sym_SymbolMap_exposed(GtkWidget * widget, GdkEvent * e, AP_UnixDialog_Insert_Symbol * dlg)
{
	UT_ASSERT( dlg);
...
static void s_Symbolarea_exposed(GtkWidget * widget, GdkEvent * e, AP_UnixDialog_Insert_Symbol * dlg)
{
	UT_ASSERT( dlg);
	dlg->Symbolarea_exposed();
}

static void s_SymbolMap_clicked(GtkWidget * widget, GdkEvent * e, AP_UnixDialog_Insert_Symbol * dlg)
{
	UT_ASSERT(widget && dlg);
	dlg->SymbolMap_clicked( e );
}

static void s_new_font(GtkWidget * widget, AP_UnixDialog_Insert_Symbol * dlg)
{
	UT_ASSERT(widget && dlg);
	dlg->New_Font();
}

static gboolean s_keypressed(GtkWidget * widget, GdkEventKey * e,  AP_UnixDialog_Insert_Symbol * dlg)
{
	dlg->Key_Pressed( e );
	return TRUE;
}
...
static void s_delete_clicked(GtkWidget * /* widget */,
							 gpointer /* data */,
							 AP_UnixDialog_Insert_Symbol * dlg)
{
	UT_ASSERT(dlg);
...
void AP_UnixDialog_Insert_Symbol::runModal(XAP_Frame * pFrame)
{
...
void AP_UnixDialog_Insert_Symbol::event_OK(void)
{
...
void AP_UnixDialog_Insert_Symbol::event_Cancel(void)
{
	if(m_Insert_Symbol_no_fonts > 0 )
	{ 
...
void AP_UnixDialog_Insert_Symbol::SymbolMap_exposed(void )
{
	XAP_Draw_Symbol * iDrawSymbol = _getCurrentSymbolMap();
	UT_ASSERT(iDrawSymbol);
	iDrawSymbol->draw();
...
void AP_UnixDialog_Insert_Symbol::Symbolarea_exposed(void )
{
	XAP_Draw_Symbol * iDrawSymbol = _getCurrentSymbolMap();
	UT_ASSERT(iDrawSymbol);
	iDrawSymbol->drawarea(m_CurrentSymbol, m_PreviousSymbol);
...
void AP_UnixDialog_Insert_Symbol::Key_Pressed(GdkEventKey * e)
{
	int move = 0;
...
void AP_UnixDialog_Insert_Symbol::SymbolMap_clicked( GdkEvent * event)
{
	UT_uint32 x, y;
...
void AP_UnixDialog_Insert_Symbol::New_Font(void )
{
	XAP_Draw_Symbol * iDrawSymbol = _getCurrentSymbolMap();
	UT_ASSERT(iDrawSymbol);
...
GtkWidget * AP_UnixDialog_Insert_Symbol::_constructWindow(void)
{
