...
XAP_Dialog * AP_UnixGnomeDialog_HdrFtr::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_UnixGnomeDialog_HdrFtr * p = new AP_UnixGnomeDialog_HdrFtr(pFactory,id);
	return p;
}

AP_UnixGnomeDialog_HdrFtr::AP_UnixGnomeDialog_HdrFtr(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: AP_UnixDialog_HdrFtr(pDlgFactory,id)
{
}

AP_UnixGnomeDialog_HdrFtr::~AP_UnixGnomeDialog_HdrFtr(void)
{
}

GtkWidget * AP_UnixGnomeDialog_HdrFtr::_constructWindow (void)
{
  GtkWidget * dlg;
  GtkWidget * k;
  GtkWidget * cancel;
  ...
  dlg = gnome_dialog_new (pSS->getValue(AP_STRING_ID_DLG_HdrFtr_Title),
