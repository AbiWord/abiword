...
#include "ap_UnixGnomeDialog_All.h"
...
AP_UnixGnomeDialogFactory::AP_UnixGnomeDialogFactory(XAP_App * pApp)
	: XAP_DialogFactory(pApp, NrElements(s_dlg_table), s_dlg_table)
{
}

AP_UnixGnomeDialogFactory::AP_UnixGnomeDialogFactory(XAP_Frame * pFrame, XAP_App * pApp)
	: XAP_DialogFactory(pFrame, pApp, NrElements(s_dlg_table), s_dlg_table)
{
}

AP_UnixGnomeDialogFactory::~AP_UnixGnomeDialogFactory(void)
{
}
