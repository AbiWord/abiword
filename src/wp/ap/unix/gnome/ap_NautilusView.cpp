 ...
 *
 * Authors: Maciej Stachowiak <mjs@eazel.com> and Martin Sevior.
...
{
	logfile = fopen("/home/msevior/abilogNaut","w");
	fprintf(logfile,"in create type \n");
	GtkType parent_type;
	static GtkType type;                                                           if (type == 0) 
	{	
	...
	fprintf(logfile,"in create type returning %d  \n",type);
	return type;
}
