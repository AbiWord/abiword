...
static AbiStockEntry stock_entries[] = { 
  { ABIWORD_FMTPAINTER,				AP_STRING_ID_TOOLBAR_LABEL_FMTPAINTER,				(const gchar **) tb_stock_paint_xpm },

  { ABIWORD_1COLUMN,				AP_STRING_ID_TOOLBAR_LABEL_1COLUMN,					(const gchar **) tb_1column_xpm },
  { ABIWORD_2COLUMN,				AP_STRING_ID_TOOLBAR_LABEL_2COLUMN,					(const gchar **) tb_2column_xpm },
  { ABIWORD_3COLUMN,				AP_STRING_ID_TOOLBAR_LABEL_3COLUMN,					(const gchar **) tb_3column_xpm },
  { ABIWORD_IMG,					AP_STRING_ID_TOOLBAR_LABEL_IMG,						(const gchar **) tb_insert_graphic_xpm },
  { ABIWORD_VIEW_SHOWPARA,			AP_STRING_ID_TOOLBAR_LABEL_VIEW_SHOWPARA,			(const gchar **) tb_view_showpara_xpm },

  { ABIWORD_LISTS_NUMBERS,			AP_STRING_ID_TOOLBAR_LABEL_LISTS_NUMBERS,			(const gchar **) tb_lists_numbers_xpm },
  { ABIWORD_LISTS_BULLETS,			AP_STRING_ID_TOOLBAR_LABEL_LISTS_BULLETS,			(const gchar **) tb_lists_bullets_xpm },

  { ABIWORD_COLOR_BACK,				AP_STRING_ID_TOOLBAR_LABEL_COLOR_BACK,				(const gchar **) tb_text_bgcolor_xpm },
  { ABIWORD_COLOR_FORE,				AP_STRING_ID_TOOLBAR_LABEL_COLOR_FORE,				(const gchar **) tb_text_fgcolor_xpm },

  { ABIWORD_INSERT_TABLE,			AP_STRING_ID_TOOLBAR_LABEL_INSERT_TABLE,			(const gchar **) tb_insert_table_xpm },
  { ABIWORD_ADD_ROW,				AP_STRING_ID_TOOLBAR_LABEL_ADD_ROW,					(const gchar **) tb_add_row_xpm }, 
  { ABIWORD_ADD_COLUMN,				AP_STRING_ID_TOOLBAR_LABEL_ADD_COLUMN,				(const gchar **) tb_add_column_xpm },
  { ABIWORD_DELETE_ROW,				AP_STRING_ID_TOOLBAR_LABEL_DELETE_ROW,				(const gchar **) tb_delete_row_xpm },
  { ABIWORD_DELETE_COLUMN,			AP_STRING_ID_TOOLBAR_LABEL_DELETE_COLUMN,			(const gchar **) tb_delete_column_xpm },
  { ABIWORD_MERGE_CELLS,			AP_STRING_ID_TOOLBAR_LABEL_MERGE_CELLS,				(const gchar **) tb_merge_cells_xpm },
  { ABIWORD_SPLIT_CELLS,			AP_STRING_ID_TOOLBAR_LABEL_SPLIT_CELLS,				(const gchar **) tb_split_cells_xpm },
  { ABIWORD_FMT_HYPERLINK,			AP_STRING_ID_TOOLBAR_LABEL_FMT_HYPERLINK,			(const gchar **) tb_hyperlink_xpm },
  { ABIWORD_FMT_BOOKMARK,			AP_STRING_ID_TOOLBAR_LABEL_FMT_BOOKMARK,			(const gchar **) tb_anchor },
  { ABIWORD_FMT_OVERLINE,			AP_STRING_ID_TOOLBAR_LABEL_FMT_OVERLINE,			(const gchar **) tb_text_overline_xpm },

  { ABIWORD_FMT_SUPERSCRIPT,		AP_STRING_ID_TOOLBAR_LABEL_FMT_SUPERSCRIPT,			(const gchar **) tb_text_superscript_xpm },
  { ABIWORD_FMT_SUBSCRIPT,			AP_STRING_ID_TOOLBAR_LABEL_FMT_SUBSCRIPT,			(const gchar **) tb_text_subscript_xpm },
  { ABIWORD_INSERT_SYMBOL,			AP_STRING_ID_TOOLBAR_LABEL_INSERT_SYMBOL,			(const gchar **) tb_symbol_xpm },

  { ABIWORD_PARA_0BEFORE,			AP_STRING_ID_TOOLBAR_LABEL_PARA_0BEFORE,			(const gchar **) tb_para_0before_xpm },
  { ABIWORD_PARA_12BEFORE,			AP_STRING_ID_TOOLBAR_LABEL_PARA_12BEFORE,			(const gchar **) tb_para_12before_xpm },
  { ABIWORD_SINGLE_SPACE,			AP_STRING_ID_TOOLBAR_LABEL_SINGLE_SPACE,			(const gchar **) tb_line_single_space_xpm },
  { ABIWORD_MIDDLE_SPACE,			AP_STRING_ID_TOOLBAR_LABEL_MIDDLE_SPACE,			(const gchar **) tb_line_middle_space_xpm },
  { ABIWORD_DOUBLE_SPACE,			AP_STRING_ID_TOOLBAR_LABEL_DOUBLE_SPACE,			(const gchar **) tb_line_double_space_xpm },
  { ABIWORD_FMT_DIR_OVERRIDE_LTR,	AP_STRING_ID_TOOLBAR_LABEL_FMT_DIR_OVERRIDE_LTR,	(const gchar **) tb_text_direction_ltr_xpm },
  { ABIWORD_FMT_DIR_OVERRIDE_RTL,	AP_STRING_ID_TOOLBAR_LABEL_FMT_DIR_OVERRIDE_RTL,	(const gchar **) tb_text_direction_rtl_xpm },
  { ABIWORD_FMT_DOM_DIRECTION,		AP_STRING_ID_TOOLBAR_LABEL_FMT_DOM_DIRECTION,		(const gchar **) tb_text_dom_direction_rtl_xpm },
  { ABIWORD_EDIT_HEADER,			AP_STRING_ID_TOOLBAR_LABEL_EDIT_HEADER,				(const gchar **) tb_edit_editheader_xpm },
  { ABIWORD_EDIT_FOOTER,			AP_STRING_ID_TOOLBAR_LABEL_EDIT_FOOTER,				(const gchar **) tb_edit_editfooter_xpm },
  { ABIWORD_EDIT_REMOVEHEADER,		AP_STRING_ID_TOOLBAR_LABEL_EDIT_REMOVEHEADER,		(const gchar **) tb_edit_removeheader_xpm },
  { ABIWORD_EDIT_REMOVEFOOTER,		AP_STRING_ID_TOOLBAR_LABEL_EDIT_REMOVEFOOTER,		(const gchar **) tb_edit_removefooter_xpm },
  { NULL,							0,												NULL }
};
...
bool AP_UnixApp::initialize(bool has_display)
{
	...
	if (has_display) {	   
		...
		i = 0;
		while (stock_entries[i].stock_id) {
			pixbuf = gdk_pixbuf_new_from_xpm_data (stock_entries[i].xpm_data);
			set = gtk_icon_set_new_from_pixbuf (pixbuf);
			gtk_icon_factory_add (factory, stock_entries[i].stock_id, set);
