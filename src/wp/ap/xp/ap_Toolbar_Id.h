...
enum _Ap_Toolbar_Id
{
	...
	AP_TOOLBAR_ID_EDIT_HEADER,
	AP_TOOLBAR_ID_EDIT_FOOTER,
	AP_TOOLBAR_ID_EDIT_REMOVEHEADER,
	AP_TOOLBAR_ID_EDIT_REMOVEFOOTER,
	...
	AP_TOOLBAR_ID_IMG,
	AP_TOOLBAR_ID_HELP,
	AP_TOOLBAR_ID_FMT_HYPERLINK,
	AP_TOOLBAR_ID_FMT_BOOKMARK,

	AP_TOOLBAR_ID_SCRIPT_PLAY,

	AP_TOOLBAR_ID_FMTPAINTER,
