...
dcl(FIELD_Numbers_TableSumCols,		"Sum Table Columns")
dcl(FIELD_Numbers_TableSumRows,		"Sum Table Rows")
...
dcl(MENU_LABEL_TOOLS_REVISIONS_MERGE_DOCUMENTS,"M&erge documents")
...
dcl(MENU_LABEL_TABLE_INSERT_SUMCOLS, "Sum of Columns")
dcl(MENU_LABEL_TABLE_INSERT_SUMROWS, "Sum of Rows")
...
dcl(MENU_STATUSLINE_TABLE_INSERT_SUMCOLS, "Insert the Sum of Columns")
dcl(MENU_STATUSLINE_TABLE_INSERT_SUMROWS, "Insert the Sum of Rows")
