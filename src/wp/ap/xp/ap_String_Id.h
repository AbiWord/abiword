...
dcl(MENU_LABEL_TABLE_INSERT_COLUMNS, "Insert Co&lumns")
dcl(MENU_LABEL_TABLE_INSERT_ROWS, "Insert &Rows")
...
dcl(MENU_STATUSLINE_TABLE_INSERT_COLUMNS, "Insert Columns")
dcl(MENU_STATUSLINE_TABLE_INSERT_ROWS, "Insert Rows")
