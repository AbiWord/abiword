...
dcl(DLG_EditStyle_Prop_P_KEEP_TOGETHER,		"Keep ")
dcl(DLG_EditStyle_Prop_P_KEEP_WITH_NEXT,	"Xxx")
dcl(DLG_EditStyle_Prop_P_ORPHANS,			"Xxx")
dcl(DLG_EditStyle_Prop_P_WIDOWS,			"Xxx")
dcl(DLG_EditStyle_Prop_P_DOM_DIR,			"Xxx")
dcl(DLG_EditStyle_Prop_P_LAST,				"Xxx")
dcl(DLG_EditStyle_Prop_C_BGCOLOR,			"Xxx")
dcl(DLG_EditStyle_Prop_C_COLOR,				"Xxx")
dcl(DLG_EditStyle_Prop_C_FONT_FAMILY,		"Xxx")
dcl(DLG_EditStyle_Prop_C_FONT_SIZE,			"Xxx")
dcl(DLG_EditStyle_Prop_C_FONT_STRETCH,		"Xxx")
dcl(DLG_EditStyle_Prop_C_FONT_STYLE,		"Xxx")
dcl(DLG_EditStyle_Prop_C_FONT_VARIANT,		"Xxx")
dcl(DLG_EditStyle_Prop_C_FONT_WEIGHT,		"Xxx")
dcl(DLG_EditStyle_Prop_C_TEXT_DECORATION,	"Xxx")
dcl(DLG_EditStyle_Prop_C_LANG,				"Xxx")
