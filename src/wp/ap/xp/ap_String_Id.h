...
dcl(DLG_Annotation_Subject_LBL, "Subject:")
dcl(DLG_Annotation_Author_LBL, "Author:")
dcl(DLG_Annotation_Publisher_LBL, "Publisher:")
dcl(DLG_Annotation_CoAuthor_LBL, "Contributor(s):")
dcl(DLG_Annotation_Category_LBL, "Category:")
dcl(DLG_Annotation_Keywords_LBL, "Keywords:")
dcl(DLG_Annotation_Languages_LBL, "Language(s):")
dcl(DLG_Annotation_Description_LBL, "Description:")
dcl(DLG_Annotation_Source_LBL, "Source:")
dcl(DLG_Annotation_Relation_LBL, "Relation:")
dcl(DLG_Annotation_Coverage_LBL, "Coverage:")
dcl(DLG_Annotation_Rights_LBL, "Rights:")
dcl(DLG_Annotation_TAB_Permission, "Permissions")
dcl(DLG_Annotation_TAB_Summary, "Summary")
dcl(DLG_Annotation_TAB_General,"General")
...
dcl(MENU_LABEL_TOOLS_ANNOTATIONS_INSERT,"&Annotation")
dcl(MENU_LABEL_TOOLS_ANNOTATIONS_INSERT_FROMSEL,"Annotation from &selection")
dcl(MENU_LABEL_TOOLS_ANNOTATIONS_TOGGLE_DRAWER,"&Toggle annotations' drawer")
...
dcl(MENU_STATUSLINE_TOOLS_ANNOTATIONS_INSERT_FROMSEL,"Insert an annotation from selection")
dcl(MENU_STATUSLINE_TOOLS_ANNOTATIONS_TOGGLE_DRAWER,"Toggle on/off the annotations drawer")
