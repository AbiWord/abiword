...
dcl(DLG_RDF_SemanticStylesheets_Explanation,"Set the current stylesheet for semantic objects in this document. New RDF objects will use this stylesheet automatically. The buttons allow you to set the stylesheet for all existing semantic objects to the new stylesheet as well.")
