...
dcl(MENU_LABEL_INSERT_ANNOTATION,"&Annotation")
dcl(MENU_LABEL_INSERT_ANNOTATION_FROMSEL,"Annotation from &selection")
dcl(MENU_LABEL_TOGGLE_ANNOTATIONS_DRAWER,"&Toggle annotations' drawer")
...
dcl(MENU_STATUSLINE_INSERT_ANNOTATION,"Insert an annotation")
dcl(MENU_STATUSLINE_INSERT_ANNOTATION_FROMSEL,"Insert an annotation from selection")
dcl(MENU_STATUSLINE_TOGGLE_ANNOTATIONS_DRAWER,"Toggle on/off the annotations drawer")
