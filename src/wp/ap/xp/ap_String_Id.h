...
dcl(MENU_LABEL_RDF_SEMITEM_STYLESHEET_CONTACT_NAME_PHONE,          "Name, Nick")
...
dcl(MENU_LABEL_RDF_SEMITEM_STYLESHEET_EVENT_SUMMARY_LOCATION,      "Location")
dcl(MENU_LABEL_RDF_SEMITEM_STYLESHEET_EVENT_SUMMARY_LOCATION_TIMES,"Location, Start and End Times")
dcl(MENU_LABEL_RDF_SEMITEM_STYLESHEET_EVENT_SUMMARY_TIMES,         "Start and End Times")
dcl(MENU_LABEL_RDF_SEMITEM_STYLESHEET_LOCATION,                    "Apply Location")
dcl(MENU_LABEL_RDF_SEMITEM_STYLESHEET_LOCATION_NAME,               "Name")
dcl(MENU_LABEL_RDF_SEMITEM_STYLESHEET_LOCATION_LATLONG,            "Lat & Long")
...
dcl(MENU_STATUSLINE_RDF_SEMITEM_STYLESHEET_CONTACT_NAME_PHONE,          "Name, Nick")
...
dcl(MENU_STATUSLINE_RDF_SEMITEM_STYLESHEET_LOCATION_LATLONG,            "Lat & Long")    
