...
dcl(DLG_EditStyle_Prop_P_MARGIN_RIGHT,		"Right Margin")
dcl(DLG_EditStyle_Prop_P_MARGIN_TOP,		"Top Margin")
dcl(DLG_EditStyle_Prop_P_MARGIN_BOTTOM,		"Bottom Margin")
dcl(DLG_EditStyle_Prop_P_LINE_HEIGHT,		"Line Height")
dcl(DLG_EditStyle_Prop_P_TABSTOPS,			"Tab Stops")
dcl(DLG_EditStyle_Prop_P_START_VALUE,		"List Start Value")
dcl(DLG_EditStyle_Prop_P_LIST_DELIM,		"List Delimiter")
dcl(DLG_EditStyle_Prop_P_LIST_STYLE,		"List Style")
dcl(DLG_EditStyle_Prop_P_LIST_DECIMAL,		"List Decimal Style")
dcl(DLG_EditStyle_Prop_P_FIELD_FONT,		"Field Font")
dcl(DLG_EditStyle_Prop_P_FIELD_COLOR,		"Field Color")
dcl(DLG_EditStyle_Prop_P_KEEP_TOGETHER,		"Keep Lines Together")
dcl(DLG_EditStyle_Prop_P_KEEP_WITH_NEXT,	"Keep With Next")
dcl(DLG_EditStyle_Prop_P_ORPHANS,			"Orphans")
dcl(DLG_EditStyle_Prop_P_WIDOWS,			"Widows")
dcl(DLG_EditStyle_Prop_P_DOM_DIR,			"Dominant Direction")
dcl(DLG_EditStyle_Prop_P_LAST,				"Last (Dummy) Paragraph Property")
dcl(DLG_EditStyle_Prop_C_BGCOLOR,			"Background Color")
dcl(DLG_EditStyle_Prop_C_COLOR,				"Color")
dcl(DLG_EditStyle_Prop_C_FONT_FAMILY,		"Font Family")
dcl(DLG_EditStyle_Prop_C_FONT_SIZE,			"Font Size")
dcl(DLG_EditStyle_Prop_C_FONT_STRETCH,		"Font Stretch")
dcl(DLG_EditStyle_Prop_C_FONT_STYLE,		"Font Style")
dcl(DLG_EditStyle_Prop_C_FONT_VARIANT,		"Font Variant")
