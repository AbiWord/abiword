...
dcl(MENU_LABEL_VIEW_TB_TABLE, "&Table")
...
dcl(MENU_LABEL_INSERT_FOOTNOTE,"&Footnote")
...
dcl(MENU_STATUSLINE_VIEW_TB_TABLE,"Show or hide the table toolbar")
...
dcl(MENU_STATUSLINE_INSERT_FOOTNOTE,"Insert an Footnote")
