...
dcl(MENU_LABEL_FILE_REVERT,"&Revert")
...
dcl(MENU_LABEL_VIEW_SHOWPARA,"Show Para&graphs")
...
dcl(MENU_LABEL_VIEW_ZOOM_WIDTH,"Zoom to &Page Width")
dcl(MENU_LABEL_VIEW_ZOOM_WHOLE,"Zoom to &Whole Page")
...
dcl(MENU_LABEL_INSERT_BOOKMARK,"&Bookmark")
...
dcl(MENU_LABEL_HELP_INDEX,"Help &Index")
...
dcl(MENU_LABEL_FMT_IMAGE, "Format &Image")
