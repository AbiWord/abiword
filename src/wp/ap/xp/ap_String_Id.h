...
dcl(MENU_LABEL_EDIT_PASTE_SPECIAL,"P&aste Unformatted")
...
dcl(MENU_LABEL_TABLE, "Table")
dcl(MENU_LABEL_TABLE_INSERT, "Insert")
dcl(MENU_LABEL_TABLE_INSERT_TABLE, "Insert Table")
dcl(MENU_LABEL_TABLE_INSERT_COLUMNS_LEFT, "Insert Columns Left")
dcl(MENU_LABEL_TABLE_INSERT_COLUMNS_RIGHT, "Insert Columns Right")
dcl(MENU_LABEL_TABLE_INSERT_ROWS_ABOVE, "Insert Rows Above")
dcl(MENU_LABEL_TABLE_INSERT_ROWS_BELOW, "Insert Rows Below")
...
dcl(MENU_LABEL_TABLE_DELETE_COLUMNS, "Delete Columns")
...
dcl(MENU_LABEL_TABLE_SELECT_COLUMN, "Select Column")
...
dcl(MENU_LABEL_TABLE_SPLIT_CELLS, "Split Cells")
dcl(MENU_LABEL_TABLE_SPLIT_TABLE, "Split Table")
...
dcl(MENU_LABEL_TABLE_SORT, "Sort Table")
...
dcl(MENU_LABEL_WEB,"We&b")
dcl(MENU_LABEL_WEB_SAVEASWEB,"Save as &web")
dcl(MENU_LABEL_WEB_WEBPREVIEW,"Pre&view web page")
...
dcl(MENU_STATUSLINE_TABLE_INSERT_COLUMNS_LEFT, "Insert Columns Left")
dcl(MENU_STATUSLINE_TABLE_INSERT_COLUMNS_RIGHT, "Insert Columns Right")
dcl(MENU_STATUSLINE_TABLE_INSERT_ROWS_ABOVE, "Insert Rows Above")
dcl(MENU_STATUSLINE_TABLE_INSERT_ROWS_BELOW, "Insert Rows Below")
...
dcl(MENU_STATUSLINE_WEB," ")
dcl(MENU_STATUSLINE_WEB_SAVEASWEB,"Save the document as a web page")
