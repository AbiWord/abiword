...
dcl(MENU_LABEL_INSERT_INSERTHEADER,"Insert Header")
dcl(MENU_LABEL_INSERT_INSERTFOOTER,"Insert Footer")
...
dcl(MENU_LABEL_FMT_BACKGROUND,"Page C&olor")
dcl(MENU_LABEL_FMT_STYLE,"St&yle")
dcl(MENU_LABEL_FMT_STYLE_DEFINE, "&Create and Modify")
dcl(MENU_LABEL_FMT_IMPORTSTYLES,"&Import Styles")
...
dcl(MENU_STATUSLINE_INSERT_INSERTHEADER,"Insert a Header")
dcl(MENU_STATUSLINE_INSERT_INSERTFOOTER,"Insert a Footer")
...
dcl(MENU_STATUSLINE_FMT_BACKGROUND,"Change your document's page color")
...
dcl(MENU_STATUSLINE_FMT_IMPORTSTYLES,"Import style definitions from a document")
