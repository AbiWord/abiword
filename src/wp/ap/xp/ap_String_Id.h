...
dcl(MENU_LABEL_TABLE_TEXTTOTABLE_ALL, "Split on SPACE \",\" TAB")
dcl(MENU_LABEL_TABLE_TEXTTOTABLE_NOSPACES, "Split on \",\" TAB")
...
dcl(MENU_STATUSLINE_TABLE_TEXTTOTABLE_ALL, "Split on all word delimeters including spaces")
dcl(MENU_STATUSLINE_TABLE_TEXTTOTABLE_NOSPACES, "Split on all delimeters except spaces")
