...
dcl(DLG_FormatFootnotes_Footnotes,         "Format Footnote")
...
dcl(MENU_LABEL_TABLE_INSERT_COLUMNS_BEFORE, "Co&lumns Before")
dcl(MENU_LABEL_TABLE_INSERT_COLUMNS_AFTER, "Columns &After")
dcl(MENU_LABEL_TABLE_INSERT_ROWS_BEFORE, "&Rows Before")
dcl(MENU_LABEL_TABLE_INSERT_ROWS_AFTER, "R&ows After")
dcl(MENU_LABEL_TABLE_INSERT_CELLS, "&Cells")
dcl(MENU_LABEL_TABLE_DELETE, "&Delete")
dcl(MENU_LABEL_TABLE_DELETE_TABLE, "&Table")
dcl(MENU_LABEL_TABLE_DELETE_COLUMNS, "Co&lumns")
dcl(MENU_LABEL_TABLE_DELETE_ROWS, "&Rows")
