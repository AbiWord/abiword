...
dcl(MENU_LABEL_TABLE_INSERT_COLUMNS_BEFORE, "Column &Left")
dcl(MENU_LABEL_TABLE_INSERT_COLUMNS_AFTER, "Column &Right")
dcl(MENU_LABEL_TABLE_INSERTCOLUMN, "Insert &Column")
dcl(MENU_LABEL_TABLE_INSERT_ROWS_BEFORE, "Row &Above")
dcl(MENU_LABEL_TABLE_INSERT_ROWS_AFTER, "Row &Below")
dcl(MENU_LABEL_TABLE_INSERTROW, "Insert &Row")
