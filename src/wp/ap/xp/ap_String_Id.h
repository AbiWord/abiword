...
dcl(DLG_RDF_SemanticStylesheets_Explanation,"Set the default stylesheet for Semantic objects in this document. New RDF objects will use this stylesheet automatically. The buttons allow you to set the stylesheet for all existing semantic objects to the new default stylesheet as well.")
...
dcl(MENU_LABEL_RDFANCHOR_SHOW_TRIPLES,"&Show RDF")
dcl(MENU_LABEL_RDFANCHOR_SPARQL,"SPARQL &Query")
dcl(MENU_LABEL_RDFANCHOR_EDITSEMITEM,"&Edit Semantic Items")
...
dcl(MENU_STATUSLINE_RDFANCHOR_SHOW_TRIPLES,"Show RDF Triples associated with location")
dcl(MENU_STATUSLINE_RDFANCHOR_SPARQL,"Execute SPARQL Query for location")
...
dcl(MENU_LABEL_RDF_QUERY_XMLIDS,    "Show RDF for cursor position")
...
dcl(MENU_LABEL_RDF_SEMITEM_STYLESHEET_REAPPLY,                     "Reapply Current")
dcl(MENU_LABEL_RDF_SEMITEM_STYLESHEET_DISASSOCIATE,                "Disassociate")
dcl(MENU_LABEL_RDF_SEMITEM_STYLESHEET_SETTINGS,                    "Stylesheet Settings")
...
dcl(MENU_STATUSLINE_RDF_QUERY_XMLIDS,    "Show the RDF associated with the cursor position...")
...
dcl(MENU_STATUSLINE_RDF_SEMITEM_STYLESHEET_REAPPLY,                     "Reapply Current")
dcl(MENU_STATUSLINE_RDF_SEMITEM_STYLESHEET_DISASSOCIATE,                "Disassociate")
dcl(MENU_STATUSLINE_RDF_SEMITEM_STYLESHEET_SETTINGS,                    "Stylesheet Settings")
...
dcl(TOOLBAR_LABEL_SEMITEM_STYLESHEET_REFLOW,"Reapply stylesheet this Semantic Item")
...
dcl(TOOLBAR_STATUSLINE_SEMITEM_STYLESHEET_REFLOW,"Reapply stylesheet this Semantic Item")
...
dcl(TOOLBAR_TOOLTIP_SEMITEM_STYLESHEET_REFLOW,"Reapply stylesheet this Semantic Item")
