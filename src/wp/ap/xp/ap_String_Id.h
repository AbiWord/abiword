...
dcl(MENU_LABEL_VIEW_REVEALCODES,"Reveal &Codes")
...
dcl(MENU_LABEL_INSERT_MATHML,"Equation")
...
dcl(MENU_STATUSLINE_VIEW_REVEALCODES,"Reveal all markup codes")
...
dcl(MENU_STATUSLINE_INSERT_MATHML,"Insert some Maths from a MathML file")
