...
AP_Dialog_Latex_Advanced::AP_Dialog_Latex_Advanced(XAP_DialogFactory * pDlgFactory, XAP_Dialog_Id id)
	: XAP_Dialog_Modeless(pDlgFactory,id)
{
	m_answer = a_OK;
}

AP_Dialog_Latex_Advanced::~AP_Dialog_Latex_Advanced(void)
{
}

AP_Dialog_Latex_Advanced::tAnswer AP_Dialog_Latex_Advanced::getAnswer(void) const
{
	return m_answer;
}
 ...
 */
bool AP_Dialog_Latex_Advanced::convertLatexToMathML(void)
{
	UT_ByteBuf From,To;
...
void AP_Dialog_Latex_Advanced::ConstructWindowName(void)
{
...
void    AP_Dialog_Latex_Advanced::setActiveFrame(XAP_Frame * /*pFrame*/)
{
...
void AP_Dialog_Latex_Advanced::insertIntoDoc(void)
{
	XAP_Frame * pFrame = getActiveFrame();
	FV_View * pView = static_cast<FV_View *>(pFrame->getCurrentView());
