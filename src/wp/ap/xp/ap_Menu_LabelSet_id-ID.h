...
BeginSet(id,ID,true)
	...
	MenuLabel(AP_MENU_ID_FILE_PAGESETUP,		"Aturan &Halaman",		"Mengganti aturan halaman")
	MenuLabel(AP_MENU_ID_FILE_PRINT,		"&Cetak",			"Mencetak seluruh atau sebagian dokumen")
	MenuLabel(AP_MENU_ID_FILE_PRINT_DIRECTLY,	"Cetak langsung",		"Mencetak dengan gunakan postscript langsung")
        MenuLabel(AP_MENU_ID_FILE_PRINT_PREVIEW,        "Tunjukkan Cetakan",            "Tunjukkan dulu bentuk cetakan dokumen ini")
	...
	MenuLabel(AP_MENU_ID_VIEW_HEADFOOT,		"&Kepala surat dan catatan kaki",		"Ganti kata-kata yang di atas atau bawah di seluruh halaman")
        MenuLabel(AP_MENU_ID_VIEW_FULLSCREEN,           "Tampilan Penuh",                 "Tampilkan dokumen yg penuh")
	...
	MenuLabel(AP_MENU_ID_FMT_BULLETS,		"Tanda &Bulat dan Penomoron",	"Menambahkan atau mengganti tanda bulat atau penomoron untuk paragraf diseleksi")
        MenuLabel(AP_MENU_ID_FMT_DOCUMENT,              "&Dokumen",                     "Aturkan halaman dokumen ini")
	...
	MenuLabel(AP_MENU_ID_TOOLS,				"&Alat-alat",			NULL)
        MenuLabel(AP_MENU_ID_TOOLS_SPELLING, "&Ejaan", NULL)
	MenuLabel(AP_MENU_ID_TOOLS_SPELL,		"&Ejaan",			"Memeriksa ejaan")
        MenuLabel(AP_MENU_ID_TOOLS_AUTOSPELL,           "&Cek otomatis",                "Memeriksa ejaan secara otomatis")
