...
BeginSetEnc(it,IT,true,"iso-8859-1")
	...
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_HEADER,	 	"Modifica intestazione",	tb_edit_editheader_xpm,		NULL, "Modifica intestazione")
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_FOOTER,	 	"Modifica piè di pagina",	tb_edit_editfooter_xpm,		NULL, "Modifica piè di pagina")
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_REMOVEHEADER, 	"Elimina intestazione",		tb_edit_removeheader_xpm,	NULL, "Elimina intestazione")
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_REMOVEFOOTER, 	"Elimina piè di pagina",	tb_edit_removefooter_xpm,	NULL, "Elimina piè di pagina")
	...
	ToolbarLabel(AP_TOOLBAR_ID_FMT_TOPLINE,		"Linea sopra",		tb_text_topline_it_IT_xpm,	NULL, "Linea sopra")
	ToolbarLabel(AP_TOOLBAR_ID_FMT_BOTTOMLINE,		"Linea sotto",		tb_text_bottomline_it_IT_xpm,	NULL, "Linea sotto")
