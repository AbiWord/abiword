...
BeginSet(fi,FI,UT_TRUE)
	...
	MenuLabel(AP_MENU_ID_VIEW_TB_FORMAT,	"&Muotoilu",		"N‰yt‰ tai piilota muotoiluvalikot")
        MenuLabel(AP_MENU_ID_VIEW_TB_EXTRA,             "&Extra",                       "N‰yt‰ tai piilota extra tyˆkalut")
	...
	MenuLabel(AP_MENU_ID_WINDOW_MORE,		"&Lis‰‰ ikkunoita",	"Koko lista ikkunoista")

	MenuLabel(AP_MENU_ID_HELP,				"&Ohje",			NULL)
	MenuLabel(AP_MENU_ID_HELP_CONTENTS,		"Ohje &hakemisto",	"Ohjeen hakemiston")
        MenuLabel(AP_MENU_ID_HELP_INDEX,                "Ohjeen &indeksi",          "Ohjeen indeksi")
        MenuLabel(AP_MENU_ID_HELP_CHECKVER,             "Tarkista &Versio",       "Ohjelman versio numero")
        MenuLabel(AP_MENU_ID_HELP_SEARCH,               "&Etsi ohjeesta",       "Etsii hakusanalla ohjeesta")
	MenuLabel(AP_MENU_ID_HELP_ABOUT,		"&Tietoja %s",		"Kertoo lis‰tietoja ohjelmasta, sen versiosta ja kopiointi oikeuksista")
        MenuLabel(AP_MENU_ID_HELP_ABOUTOS,              "Tietoja &Open Source",   "Tietoja Open Sourcesta")
