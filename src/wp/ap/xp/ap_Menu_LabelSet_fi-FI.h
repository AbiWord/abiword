...
BeginSet(FiFI)
	...
	MenuLabel(AP_MENU_ID_FILE_SAVEAS,		"Tallenna &Nimella", 		"Tallenna k‰sitelt‰v‰ asiakirja eri nimelle")
	...
	MenuLabel(AP_MENU_ID_INSERT_PAGENO,		"Sivu N&umerot",	"Lis‰‰ p‰ivittyv‰ sivunumerointi")
	...
	MenuLabel(AP_MENU_ID_ALIGN_CENTER,		"K&eskit‰",			"Keskita kappale")
