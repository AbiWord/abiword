...
BeginSet(es,ES,true)
	...
	ToolbarLabel(AP_TOOLBAR_ID_COLOR_FORE,      "Color principal",	NoIcon,			NULL, "Cambiar el color con el que se escribe")
	ToolbarLabel(AP_TOOLBAR_ID_COLOR_BACK,		"Color de fondo",	NoIcon,			NULL, "Cambiar el color de fondo")
	ToolbarLabel(AP_TOOLBAR_ID_INDENT,          "Indentar párrafo", tb_text_indent_xpm, NULL, "Aumentar la indentación del párrafo")
