...
BeginSetEnc(fr,FR,true,"iso-8859-1")
	...
	ToolbarLabel(AP_TOOLBAR_ID_FMT_HYPERLINK,	"Insérer un hyperlien", tb_hyperlink,	NULL, "Insérer un hyperlien dans un document")
	ToolbarLabel(AP_TOOLBAR_ID_FMT_BOOKMARK,	"Insérer un signet",	tb_anchor,		NULL, "Insérer un signet dans un document")
