...
BeginSet(fr,FR,true)
	...
	ToolbarLabel(AP_TOOLBAR_ID_COLOR_FORE,		"Trame de fond",		tb_text_fgcolor_xpm,						NULL, "Change Foreground Color")
	ToolbarLabel(AP_TOOLBAR_ID_COLOR_BACK,		"Arrière plan",			tb_text_bgcolor_xpm,						NULL, "Change Background Color")
