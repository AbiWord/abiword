...
BeginSetEnc(lt,LT,true,"iso-8859-13")
	...
	MenuLabel(AP_MENU_ID_FILE_IMPORT,       "I&mportas",			"Importuoti dokumentà")
	MenuLabel(AP_MENU_ID_FILE_EXPORT,       "&Exportas",			"Iðsaugoti dokumentà nepakeièiant pavadinimo")
	...
	MenuLabel(AP_MENU_ID_EDIT_PASTE_SPECIAL, "Ádëti ne&formatuotà",  "Ádëti neformatuotà tekstiná krepðio turiná")
	...
	MenuLabel(AP_MENU_ID_EDIT_EDITHEADER,		"Keisti antraðtæ",	"Keisti esamo puslapio antraðtæ")
	MenuLabel(AP_MENU_ID_EDIT_EDITFOOTER,		"Keisti paraðtæ",	"Keisti esamo puslapio paraðtæ")
	...
	MenuLabel(AP_MENU_ID_VIEW_HEADFOOT,		"Antraðtë ir poraðtë",	"Keisti antraðtæ ir paraðtæ")
	...
	MenuLabel(AP_MENU_ID_INSERT_BREAK,		"&Skyriklá...",		"Áterpti puslapio, skyriaus ar skilties skyriklá")
	...
	MenuLabel(AP_MENU_ID_INSERT_ENDNOTE,	"Pa&aiðkinimà",			"Áterpti paaiðkinimà teksto pabaigoje")
	MenuLabel(AP_MENU_ID_INSERT_PICTURE, 	"&Paveikslëlá", 		"Áterpti paveikslëlá")
	MenuLabel(AP_MENU_ID_INSERT_CLIPART, 	"Pieðiniø &galerija", 		"Áterpti paveikslëlá ið pieðiniø galerijos")
	MenuLabel(AP_MENU_ID_INSERT_GRAPHIC,		"Ið &bylos",		"Áterpti paveikslëlá ið kitos bylos")

	MenuLabel(AP_MENU_ID_FORMAT,			"F&ormatas",		NULL)
	MenuLabel(AP_MENU_ID_FMT_LANGUAGE,		"&Kalba",		"Keisti paþymëto teksto kalbà")
	...
	MenuLabel(AP_MENU_ID_FMT_TOGGLECASE,   	"Raidþiø d&ydis", "Keisti maþàsias raides didþiosiomis ir atvirkðèiai paþymëtame tekste")
	MenuLabel(AP_MENU_ID_FMT_BACKGROUND,   	"&Fonas", "Keisti esamo dokumento fono spalvà")
	...
	MenuLabel(AP_MENU_ID_FMT_TOPLINE,		"Topline",			"Line above paþymëtà tekstà (perjungti)")
	MenuLabel(AP_MENU_ID_FMT_BOTTOMLINE,	"Bottomline",		"Line below paþymëtà tekstà (perjungti)")
	...
	MenuLabel(AP_MENU_ID_TOOLS_SPELLING, "Raðy&ba", NULL)
	MenuLabel(AP_MENU_ID_TOOLS_SPELL,		"&Raðybos tikrinimas",		"Patikrinti dokumento raðybos teisingumà")
	MenuLabel(AP_MENU_ID_TOOLS_AUTOSPELL, "&Automatinis tikrinimas", "Automatiðkai tikrinti dokumento raðybos teisingumà")
	...
	MenuLabel(AP_MENU_ID_TOOLS_LANGUAGE,	"&Kalba",	"Keisti paþymëto teksto kalbà")
	...
	MenuLabel(AP_MENU_ID_WEB_SAVEASWEB,    "Iðsaugoti kaip &tinklalapá",		"Iðsaugoti esamà dokumentà HTML formatu")
	MenuLabel(AP_MENU_ID_WEB_WEBPREVIEW,   "&Perþiûrëti narðyklëje", "Perþiûrëti esamà dokumentà interneto narðyklëje")
	...
	MenuLabel(AP_MENU_ID_HELP_ABOUTOS,		"Apie &Open Source",	"Parodyti informacijà apie atviro kodo judëjimà")
