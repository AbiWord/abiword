...
BeginSet(lt,LT,true)
	...
	MenuLabel(AP_MENU_ID_EDIT_CUT,			"&Iðkirpti",		"Parinkimà iðkirpti ir padëti á krepðá")
	MenuLabel(AP_MENU_ID_EDIT_COPY,			"&Kopijuoti",		"Parinkimà kopijuoti á krepðá")
	MenuLabel(AP_MENU_ID_EDIT_PASTE,		"Á&dëti",		"Ádëti krepðio turiná")
	MenuLabel(AP_MENU_ID_EDIT_CLEAR,		"Ið&trinti",		"Iðtrinti parinkimà")
	MenuLabel(AP_MENU_ID_EDIT_SELECTALL,		"Parinkti &viskà",	"Parinkti visà tekstà")
	MenuLabel(AP_MENU_ID_EDIT_FIND,			"R&asti",		"Ieðkoti dokumente eilutës")
	MenuLabel(AP_MENU_ID_EDIT_REPLACE,		"Pak&eisti",		"Pakeisti rastà eilutæ kita eilute")
	MenuLabel(AP_MENU_ID_EDIT_GOTO,			"Eiti &á",		"Perkelti þymeklá á nurodytà vietà")
	
	MenuLabel(AP_MENU_ID_VIEW,			"Þiûrë&ti",		NULL)
	...
	MenuLabel(AP_MENU_ID_VIEW_TB_FORMAT,		"&Tvarkymo",		"Rodyti/slëpti teksto tvarkymo árankiø juostà")
	...
	MenuLabel(AP_MENU_ID_VIEW_ZOOM,			"&Zoom",		"Sumaþinti ar padidinti rodomà vaizdà")

	MenuLabel(AP_MENU_ID_INSERT,			"&Áterpti",		NULL)
	MenuLabel(AP_MENU_ID_INSERT_BREAK,		"&Skyriklá...",		"Iterpti puslapio, skyriaus ar stulpelio skyriklá")
	...
	MenuLabel(AP_MENU_ID_FMT_BULLETS,		"Punktai ir &Numeriai",	"Pridëti ar pakeisti punktus ir numerius esamoje pastraipoje")
	...
	MenuLabel(AP_MENU_ID_ALIGN_JUSTIFY,		"&Justify",		"Lygiuoti pastraipà pagal abu kraðtus")
	...
	MenuLabel(AP_MENU_ID_HELP_ABOUTOS,		"Apie &Open Source",	"Pardodyti informacijà apie Open Source")
