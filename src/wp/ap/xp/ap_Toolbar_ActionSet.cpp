...
#define _s(id,type,szMethodName,maskOfInterest,pfnGetState)		\
	...
	_s(AP_TOOLBAR_ID_FMT_HYPERLINK, EV_TBIT_PushButton, "insertHyperlink", AV_CHG_ALL, ap_ToolbarGetState_Selection);
	_s(AP_TOOLBAR_ID_FMT_BOOKMARK, EV_TBIT_PushButton, "insertBookmark", AV_CHG_NONE, NULL);
	...
	_s(AP_TOOLBAR_ID_INSERT_TABLE, EV_TBIT_PushButton, "insertTable", AV_CHG_ALL, ap_ToolbarGetState_SectionFmt);
	...
	_s(AP_TOOLBAR_ID_SPLIT_CELLS, EV_TBIT_PushButton, "splitCells", AV_CHG_ALL, ap_ToolbarGetState_TableMerged); // ap_ToolbarGetState_AlwaysDisabled is a hack to disable the menu item before the 1.1.1 release
