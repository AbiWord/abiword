...
BeginSet(NlNL)
	...
	ToolbarLabel(AP_TOOLBAR_ID_FMT_SIZE,		"Letter Grootte", NoIcon,		NULL, "Font Size")
	...
	ToolbarLabel(AP_TOOLBAR_ID_ALIGN_CENTER,	"Centreer",	tb_text_center_xpm,	NULL, "Centreer kantlijn")
	ToolbarLabel(AP_TOOLBAR_ID_ALIGN_RIGHT,		"Rechts",	tb_text_align_right_xpm,	NULL, "Rechter kantlijn")
	ToolbarLabel(AP_TOOLBAR_ID_ALIGN_JUSTIFY,	"Rechtvaardigen",	tb_text_justify_xpm,	NULL, "Rechtvaardig paragraaf")

	ToolbarLabel(AP_TOOLBAR_ID_PARA_0BEFORE,	"Niets voor",		tb_para_0before_xpm,	NULL, "Spatie voor: Geen")
	ToolbarLabel(AP_TOOLBAR_ID_PARA_12BEFORE,	"12 pt voor",		tb_para_12before_xpm,	NULL, "Spatie voor: 12 pt")

	ToolbarLabel(AP_TOOLBAR_ID_SINGLE_SPACE,	"Enkel Spacing",	tb_line_single_space_xpm,	NULL, "Enkele spacing")
	ToolbarLabel(AP_TOOLBAR_ID_MIDDLE_SPACE,	"1.5 Spacing",		tb_line_middle_space_xpm,	NULL, "1.5 spacing")
	ToolbarLabel(AP_TOOLBAR_ID_DOUBLE_SPACE,	"Dubbel Spacing",	tb_line_double_space_xpm,	NULL, "Dubbele spacing")

	ToolbarLabel(AP_TOOLBAR_ID_1COLUMN,			"1 Kolom",			tb_1column_xpm,			NULL, "1 Kolommen")
	ToolbarLabel(AP_TOOLBAR_ID_2COLUMN,			"2 Kolom",		tb_2column_xpm,			NULL, "2 Kolommen")
	ToolbarLabel(AP_TOOLBAR_ID_3COLUMN,			"3 Kolom",		tb_3column_xpm,			NULL, "3 Kolommen")
