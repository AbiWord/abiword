...
static bool s_restoreVersion(AD_Document * pDoc, UT_uint32 iVersion)
{
...
static bool s_doHistory(XAP_Frame * pFrame, AD_Document * pDoc, FV_View * pView)
{
	...
	if (bShow)
	{
		...
		if(iVersion)
		{
			switch(pDoc->verifyHistoryState(iVersion))
			{
						...
						if(iVersion)
						{
														  ...
														  XAP_Dialog_MessageBox::a_YES))
							{
								case XAP_Dialog_MessageBox::a_NO:
									bRet = s_restoreVersion(pDoc, iOrigVersion);
									break;
									
								case XAP_Dialog_MessageBox::a_YES:
									bRet = s_restoreVersion(pDoc, iVersion);
									break;
