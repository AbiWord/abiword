...
BeginSetEnc(hu,HU,true,"iso-8859-2")
  ...
  ToolbarLabel(AP_TOOLBAR_ID_FILE_PRINT_PREVIEW,	"Nyomtatási kép",	tb_print_preview_xpm, NULL, "A dokumentum megtekintése nyomtatás elõtt")
	...
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_HEADER,	 "Fejléc szerkesztése",		tb_edit_editheader_xpm,			NULL, "Fejléc szerkesztése")
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_FOOTER,	 "Lábléc szerkesztése",		tb_edit_editfooter_xpm,			NULL, "Lábléc szerkesztése")
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_REMOVEHEADER, "Fejléc törlése",		tb_edit_removeheader_xpm,			NULL, "Fejléc törlése")
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_REMOVEFOOTER, "Lábléc törlése",		tb_edit_removefooter_xpm,			NULL, "Lábléc törlése")
	...
	ToolbarLabel(AP_TOOLBAR_ID_FMT_HYPERLINK, "Kereszthivatkozás", tb_hyperlink, NULL, "Kereszthivatkozás beszúrása a dokumentumba")
	ToolbarLabel(AP_TOOLBAR_ID_FMT_BOOKMARK, "Könyvjelzõ", tb_anchor, NULL, "Könyvjelzõ beszúrása a dokumentumba")
