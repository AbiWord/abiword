...
BeginSetEnc(hu,HU,true,"iso-8859-2")
	...
	MenuLabel(AP_MENU_ID_FILE_IMPORT,       "&Import",			"Dokumentum importálása")
	MenuLabel(AP_MENU_ID_FILE_EXPORT,       "&Export",			"A dokumentum elmentése a nevének megváltoztatása nélkül")
