...
BeginSetEnc(hu,HU,true,"iso-8859-2")
	...
	MenuLabel(AP_MENU_ID_FILE_IMPORT,       "Másolat nyitása",			"Dokumentum importálása")
	MenuLabel(AP_MENU_ID_FILE_EXPORT,       "Másolat mentése",			"A dokumentum elmentése a nevének megváltoztatása nélkül")
	...
	MenuLabel(AP_MENU_ID_FILE_PRINT_DIRECTLY,		"Közvetlen nyomtatás",			"Nyomtatás a beépített PS nyomtatómeghajtóval")
	MenuLabel(AP_MENU_ID_FILE_PRINT_PREVIEW, "Nyomtatási kép", "A dokumentum megtekintése nyomtatás elõtt")
	...
	MenuLabel(AP_MENU_ID_FILE_REVERT, "&Visszaállítás", "Visszatérés a dokumentum legutóbb tárolt állapotára")
	...
	MenuLabel(AP_MENU_ID_EDIT_PASTE_SPECIAL, "Be&illesztés (csak szöveg)",  "A vágólap tartalmát szövegformázás nélkül szúrja be")
	...
	MenuLabel(AP_MENU_ID_EDIT_EDITHEADER,			"Fejléc",			"Az aktuális oldal fejlécének szerkesztése")
	MenuLabel(AP_MENU_ID_EDIT_EDITFOOTER,			"Lábléc",			"Az aktuális oldal láblécének szerkesztése")
	MenuLabel(AP_MENU_ID_EDIT_REMOVEHEADER,			"Fejléc Törlése",			"Fejléc eltávolítása a dokumentum ezen oldaláról")
	MenuLabel(AP_MENU_ID_EDIT_REMOVEFOOTER,			"Lábléc Törlése",			"Lábléc eltávolítása a dokumentum ezen oldaláról")
	
	MenuLabel(AP_MENU_ID_VIEW,				"&Nézet",			NULL)
	MenuLabel(AP_MENU_ID_VIEW_NORMAL, "&Normál", "Normál nézet")
	MenuLabel(AP_MENU_ID_VIEW_WEB, "&Web elrendezés", "Web elrendezés")
	MenuLabel(AP_MENU_ID_VIEW_PRINT, "Nyomtatási &elrendezés", "Nyomtatási elrendezés")
	...
	MenuLabel(AP_MENU_ID_VIEW_FULLSCREEN, "&Teljes képernyõ", "A dokumentum nézete a teljes képernyõn")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM_MENU, "&Nagyítás", "A dokumentum nézet nagyítása vagy kicsinyítése")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM,			"&Nagyítás",			"A dokumentum nézet nagyítása vagy kicsinyítése")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM_200, "&200%", "Nagyítás 200%-ra")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM_100, "&100%", "Nagyítás 100%-ra")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM_75, "&75%", "Nagyítás 75%-ra")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM_50, "&50%", "Nagyítás 50%-ra")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM_WIDTH, "&Oldalszélesség", "Nagyítás teljes oldalszélességre")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM_WHOLE, "&Teljes oldal", "Nagyítás teljes oldalméretre")
	...
	MenuLabel(AP_MENU_ID_INSERT_FILE, "Fájl beszúrás", "Egy másik fájl tartalmának beszúrása")
	MenuLabel(AP_MENU_ID_INSERT_SYMBOL,		"&Szimbólum",			"Szimbólum vagy speciális karakter beszúrása")
	MenuLabel(AP_MENU_ID_INSERT_ENDNOTE,	"&Lábjegyzet",			"Lábjegyzet beszúrása")
	MenuLabel(AP_MENU_ID_INSERT_PICTURE, "Ké&p", "Kép beszúrása")
	MenuLabel(AP_MENU_ID_INSERT_CLIPART, 	"Kép&tár", 		"Beszúrás a képtárból")
#ifdef HAVE_GNOME
	MenuLabel(AP_MENU_ID_INSERT_GRAPHIC,	"&Fájlból",		"Meglévõ kép beszúrása fájlból")
#else
	MenuLabel(AP_MENU_ID_INSERT_GRAPHIC,	"Ké&p",		"Kép beszúrása")
#endif
	MenuLabel(AP_MENU_ID_INSERT_BOOKMARK,	"&Könyvjelzõ",		"Könyvjelzõ beszúrása")
	MenuLabel(AP_MENU_ID_INSERT_HYPERLINK,	"Kereszthivatkozás",		"Kereszthivatkozás beszúrása")
	MenuLabel(AP_MENU_ID_INSERT_DELETE_HYPERLINK,	"Kereszthivatkozás Törlése",		"Kereszthivatkozás Törlése")
	MenuLabel(AP_MENU_ID_FORMAT,			"F&ormátum",			NULL)
	MenuLabel(AP_MENU_ID_FMT_LANGUAGE,		"&Nyelv",		"A kijelölt szöveg nyelvének megváltoztatása")
	...
	MenuLabel(AP_MENU_ID_FMT_DOCUMENT,              "&Dokumentum",             "A dokumentum jellemzõinek (pl. oldalméret, margóvastagság) beallítása")
	MenuLabel(AP_MENU_ID_FMT_BORDERS,		"Sze&gély és árnyék",		"Szegély és árnyék hozzárendelése a kijelölt részhez")
	MenuLabel(AP_MENU_ID_FMT_HDRFTR,		"Fej- és lábléc formázás",   "A fej- és láblécek típusának beállítása")
	MenuLabel(AP_MENU_ID_FMT_COLUMNS,		"&Hasábok",			"A hasábok számának megváltoztatása")
	MenuLabel(AP_MENU_ID_FMT_TOGGLECASE, "&Kis- és nagybetûk", "Kis- és nagybetûk módosítása a kijelölt szövegben")
	MenuLabel(AP_MENU_ID_FMT_BACKGROUND, "Háttér", "A dokumentum háttérszínének megváltoztatása")
	...
	MenuLabel(AP_MENU_ID_FMT_TOPLINE,		"Felsõ vonal",			"Vonal a kijelölt rész fölött (megfordítás)")
	MenuLabel(AP_MENU_ID_FMT_BOTTOMLINE,	"Alsó vonal",		"Vonal a kijelölt rész alatt (megfordítás)")
	...
	MenuLabel(AP_MENU_ID_TOOLS_SPELLING, "&Helyesírás", NULL)
	MenuLabel(AP_MENU_ID_TOOLS_SPELL,		"&Ellenõrzés",		"A dokumentum helyesírásának ellenõrzése")
	MenuLabel(AP_MENU_ID_TOOLS_AUTOSPELL, "&Automatikus", "A dokumentum helyesírásának automatikus ellenõrzése")
	MenuLabel(AP_MENU_ID_TOOLS_SPELLPREFS, "Helyesírás Opciók", "A helyesírás ellenõrzés beállításai")
	...
	MenuLabel(AP_MENU_ID_TOOLS_LANGUAGE,		"&Nyelv",		"A kijelölt szöveg nyelvének megváltoztatása")
	MenuLabel(AP_MENU_ID_TOOLS_PLUGINS, "Mo&dulok", "Modulok karbantartása")
	MenuLabel(AP_MENU_ID_TOOLS_SCRIPTS, "&Makrók", "Segéd makrók futtatása")
	...
	MenuLabel(AP_MENU_ID_WEB_SAVEASWEB,               "Mentés &web oldalként", "Dokumentum mentése web oldalként")
	MenuLabel(AP_MENU_ID_WEB_WEBPREVIEW,              "Web oldal elõnezet", "Dokumentum elõnézete web oldalként")
	...
	MenuLabel(AP_MENU_ID_HELP_CREDITS, "&Szerzõk", "Az AbiWord szerzõinek listája")
	...
	MenuLabel(AP_MENU_ID_HELP_SEARCH,		"Súgó &Keresése",	"Keresés a súgóban...")
	...
	MenuLabel(AP_MENU_ID_HELP_ABOUT_GNU, "A &GNU Szabad Szoftverrõl", "A &GNU projektrõl")
	MenuLabel(AP_MENU_ID_HELP_ABOUT_GNOMEOFFICE, "A G&NOME Office-rról", "A GNOME Office projektrõl")
