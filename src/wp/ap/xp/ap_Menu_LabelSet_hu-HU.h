...
BeginSet(hu,HU,true)
	...
	MenuLabel(AP_MENU_ID_FILE_SAVEASWEB,               "Mentés &web oldalként", "Dokumentum mentése web oldalként")
	MenuLabel(AP_MENU_ID_FILE_WEBPREVIEW,              "Web oldal elõnezet", "Dokumentum elõnézete web oldalként")
