...
BeginSetEnc(pt,PT,true,"iso-8859-1")
    ...
    MenuLabel(AP_MENU_ID_FILE_EXPORT,		"&Exportar",		"Gravar uma cópia do documento com outro nome")
    ...
    MenuLabel(AP_MENU_ID_EDIT_CUT,		"Co&rtar",		"Cortar a selecção")
    MenuLabel(AP_MENU_ID_EDIT_COPY,		"&Copiar",		"Copiar a selecção")
    MenuLabel(AP_MENU_ID_EDIT_PASTE,		"Co&lar",		"Colar a selecção")
    MenuLabel(AP_MENU_ID_EDIT_PASTE_SPECIAL,	"Colar &Especial",	"Colar um objecto não formatado")
    ...
    MenuLabel(AP_MENU_ID_EDIT_EDITHEADER,	"Editar &Cabeçalho",	"Editar o cabeçalho da página")
    MenuLabel(AP_MENU_ID_EDIT_EDITFOOTER,	"Editar &Rodapé",	"Editar o rodapé da página")
    ...
    MenuLabel(AP_MENU_ID_VIEW_RULER,		"&Réguas",		"Ver/Omitir as réguas")
    ...
    MenuLabel(AP_MENU_ID_HELP_CONTENTS,		"&Tópicos da Ajuda",	"Mostrar tópicos da ajuda")
    ...
    MenuLabel(AP_MENU_ID_HELP_ABOUT_GNU,	"Acerca do Software Livre &GNU", "Saiba mais sobre o projecto GNU")
