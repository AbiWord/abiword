...
BeginSetEnc(pt,PT,true,"iso-8859-1")
    ...
    MenuLabel(AP_MENU_ID_EDIT_EDITHEADER,	"Editar &Cabeçalho",	"Editar Cabeçalho da página")
    MenuLabel(AP_MENU_ID_EDIT_EDITFOOTER,	"Editar &Rodapé",	"Editar Rodapé da página")
