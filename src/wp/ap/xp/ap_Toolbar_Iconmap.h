...
toolbariconmap(FILE_NEW_16,menu_new_xpm)
toolbariconmap(FILE_OPEN_16,menu_open_xpm)
toolbariconmap(FILE_SAVE_16,menu_save_xpm)
toolbariconmap(FILE_SAVEAS_16,menu_save_as_xpm)
toolbariconmap(FILE_PRINT_16,menu_print_xpm)
toolbariconmap(FILE_PRINT_PREVIEW_16,menu_print_preview_xpm)
toolbariconmap(FILE_EXIT_16,menu_exit_xpm)
toolbariconmap(EDIT_UNDO_16,menu_undo_xpm)
toolbariconmap(EDIT_REDO_16,menu_redo_xpm)
toolbariconmap(EDIT_CUT_16,menu_cut_xpm)
toolbariconmap(EDIT_COPY_16,menu_copy_xpm)
toolbariconmap(EDIT_PASTE_16,menu_paste_xpm)
toolbariconmap(IMG_16,menu_insert_graphic_xpm)
toolbariconmap(INSERT_TABLE_16,menu_insert_table_xpm)
toolbariconmap(FMT_HYPERLINK_16,menu_hyperlink_xpm)
toolbariconmap(FMT_BOOKMARK_16,menu_insert_bookmark_xpm)
toolbariconmap(HELP_16,menu_help_xpm)
toolbariconmap(FMT_BOLD_16,menu_text_bold_xpm)
toolbariconmap(FMT_ITALIC_16,menu_text_italic_xpm)
toolbariconmap(FMT_UNDERLINE_16,menu_text_underline_xpm)
toolbariconmap(FMT_OVERLINE_16,menu_text_overline_xpm)
toolbariconmap(FMT_STRIKE_16,menu_text_strikethrough_xpm)
toolbariconmap(FMT_TOPLINE_16,menu_text_topline_xpm)
toolbariconmap(FMT_BOTTOMLINE_16,menu_text_bottomline_xpm)
toolbariconmap(FMT_SUPERSCRIPT_16,menu_superscript_xpm)
toolbariconmap(FMT_SUBSCRIPT_16,menu_subscript_xpm)
toolbariconmap(ALIGN_LEFT_16,menu_text_left_xpm)
toolbariconmap(ALIGN_CENTER_16,menu_text_center_xpm)
toolbariconmap(ALIGN_RIGHT_16,menu_text_right_xpm)
toolbariconmap(ALIGN_JUSTIFY_16,menu_text_justify_xpm)
toolbariconmap(SPELLCHECK_16,menu_spellcheck_xpm)
toolbariconmap(TB_ADD_ROW_16, menu_add_row_xpm)
toolbariconmap(TB_ADD_COLUMN_16, menu_add_column_xpm)
toolbariconmap(TB_DELETE_ROW_16, menu_delete_row_xpm)
toolbariconmap(TB_DELETE_COLUMN_16, menu_delete_column_xpm)
toolbariconmap(TB_MERGE_CELLS_16, menu_merge_cells_xpm)
toolbariconmap(TB_SPLIT_CELLS_16, menu_split_cells_xpm)
toolbariconmap(INSERT_SYMBOL_16,menu_insert_symbol_xpm)
