...
toolbariconmap(SEMITEM_NEXT, tb_semitem_select_next)
toolbariconmap(SEMITEM_PREV, tb_semitem_select_prev)
toolbariconmap(SEMITEM_STYLESHEET_REFLOW, tb_semitem_stylesheet_reflow_xpm)
toolbariconmap(SEMITEM_THIS, tb_semitem_select_this_xpm)
