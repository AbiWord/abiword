...
BeginSetEnc(pt,PT,true,"iso-8859-1")
	...
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_HEADER,		"Editar Cabeçalho", tb_edit_editheader_xpm, NULL, "Editar o Cabeçalho")
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_FOOTER,		"Editar Rodapé", tb_edit_editfooter_xpm, NULL,	"Editar o Rodapé")
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_REMOVEHEADER,	"Remover Cabeçalho", tb_edit_removeheader_xpm, NULL, "Remover o Cabeçalho")
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_REMOVEFOOTER,	"Remover Rodapé", tb_edit_removefooter_xpm, NULL, "Remover o Rodapé")
