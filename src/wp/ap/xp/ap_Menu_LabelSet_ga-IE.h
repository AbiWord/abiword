...
// Alan Horkan was here  || Bhí Alan Horkan anseo
...
BeginSet(ga,IE,true)
	...
	MenuLabel(AP_MENU_ID_FILE,				"Comhad",			NULL)
	MenuLabel(AP_MENU_ID_FILE_NEW,			"&Nua", 			"Déan comhad nua")	
	MenuLabel(AP_MENU_ID_FILE_OPEN,			"&Oscail",			"Oscail comhad")
	MenuLabel(AP_MENU_ID_FILE_CLOSE,		"Dún", 			"Dún an comhad")
	MenuLabel(AP_MENU_ID_FILE_SAVE,			"&Sábhál", 			"Sábhál an comhad")
	MenuLabel(AP_MENU_ID_FILE_SAVEAS,		"Sábhál Mar", 		"Sábhál an comhad faoi ainm eile")
	MenuLabel(AP_MENU_ID_FILE_IMPORT,       "&Import",			"Import the document")  // allmhairiú/impórtáil
	...
	MenuLabel(AP_MENU_ID_FILE_PRINT,		"Cló",			"Print all or part of the document")
	...
	MenuLabel(AP_MENU_ID_FILE_RECENT_1,		"&1 %s",			"Oscail an comhad seo")
	MenuLabel(AP_MENU_ID_FILE_RECENT_2,		"&2 %s",			"Oscail an comhad seo")
	MenuLabel(AP_MENU_ID_FILE_RECENT_3,		"&3 %s",			"Oscail an comhad seo")
	MenuLabel(AP_MENU_ID_FILE_RECENT_4,		"&4 %s",			"Oscail an comhad seo")
	MenuLabel(AP_MENU_ID_FILE_RECENT_5,		"&5 %s",			"Oscail an comhad seo")
	MenuLabel(AP_MENU_ID_FILE_RECENT_6,		"&6 %s",			"Oscail an comhad seo")
	MenuLabel(AP_MENU_ID_FILE_RECENT_7,		"&7 %s",			"Oscail an comhad seo")
	MenuLabel(AP_MENU_ID_FILE_RECENT_8,		"&8 %s",			"Oscail an comhad seo")
	MenuLabel(AP_MENU_ID_FILE_RECENT_9,		"&9 %s",			"Oscail an comhad seo")
	MenuLabel(AP_MENU_ID_FILE_EXIT,			"Imigh", 			"Dún gach fuinneog agus imigh")

	MenuLabel(AP_MENU_ID_EDIT,				"&Edit",			NULL)
	MenuLabel(AP_MENU_ID_EDIT_UNDO,			"Fo-dhean",			"Undo editing")
	MenuLabel(AP_MENU_ID_EDIT_REDO,			"Fo-dhean",			"Redo previously undone editing")
	MenuLabel(AP_MENU_ID_EDIT_CUT,			"Gearr",				"Cut the selection and put it on the Clipboard")
	MenuLabel(AP_MENU_ID_EDIT_COPY,			"&Cóip",			"Copy the selection and put it on the Clipboard")
	MenuLabel(AP_MENU_ID_EDIT_PASTE,		"Greamaigh",			"Insert Clipboard contents")
	MenuLabel(AP_MENU_ID_EDIT_PASTE_SPECIAL, "Greamaigh Speisílta",  "Insert unformatted clipboard contents")
	...
	MenuLabel(AP_MENU_ID_EDIT_FIND,			"&Faigh",			"Find the specified text")
	MenuLabel(AP_MENU_ID_EDIT_REPLACE,		"Cur in ionad",			"Replace the specified text with different text")
	...
	MenuLabel(AP_MENU_ID_VIEW_FULLSCREEN, "Lánscáileán", "View the document in full screen mode")
	...
	MenuLabel(AP_MENU_ID_INSERT_SYMBOL,		"Sio&mbal",			"Insert a symbol or other special character")
	MenuLabel(AP_MENU_ID_INSERT_ENDNOTE,	"&Endnote",			"Insert an endnote")
	MenuLabel(AP_MENU_ID_INSERT_PICTURE, 	"&Pictúir", 		"Insert a picture")
	...
	MenuLabel(AP_MENU_ID_FMT_LANGUAGE,		"Teanga",		"Change the language of the selected text")
	MenuLabel(AP_MENU_ID_FMT_FONT,			"&Font",			"Change the font of the selected text")
	MenuLabel(AP_MENU_ID_FMT_PARAGRAPH,		"&Paragraf",		"Change the format of the selected paragraph")
	MenuLabel(AP_MENU_ID_FMT_BULLETS,		"Bullets and &Numbering",	"Add or modify bullets and numbering for selected paragraphs")
	MenuLabel(AP_MENU_ID_FMT_DOCUMENT,		"Comhad",             "Setup your document's page properties such as page size and margins")
	MenuLabel(AP_MENU_ID_FMT_BORDERS,		"Borders and Shading",		"Add borders and shading to the selection")
	MenuLabel(AP_MENU_ID_FMT_COLUMNS,		"&Colún",			"Change the number of columns")
	MenuLabel(AP_MENU_ID_FMT_TOGGLECASE,   	"C&hange Case", "Change the case of the selected text")
	MenuLabel(AP_MENU_ID_FMT_BACKGROUND,   	"Cúlra", "Athraigh dath an cúlra don chomad")
	MenuLabel(AP_MENU_ID_FMT_STYLE,			"Stíl",			"Define or apply style for the selection")
	MenuLabel(AP_MENU_ID_FMT_TABS,			"&Tabs",			"Set tab stops")
	MenuLabel(AP_MENU_ID_FMT_BOLD,			"Dubh",			"Make the selection bold (toggle)")
	MenuLabel(AP_MENU_ID_FMT_ITALIC,		"&Iodáileach",			"Make the selection italic (toggle)")
	...
	MenuLabel(AP_MENU_ID_TOOLS_SPELLING, "Litríocht", NULL)
	MenuLabel(AP_MENU_ID_TOOLS_SPELL,		"Litríocht",		"Check the document for incorrect spelling")
	...
	MenuLabel(AP_MENU_ID_TOOLS_OPTIONS,		"Roghanna",		"Set preferences") // Preferences/Options
	MenuLabel(AP_MENU_ID_TOOLS_LANGUAGE, "Teanga", "Change the language of the selected text")
	...
	MenuLabel(AP_MENU_ID_ALIGN_LEFT,		"Clé",			"Left-justify the paragraph")
	...
	MenuLabel(AP_MENU_ID_WEB_SAVEASWEB,    "Sabháil don Idirlín",		"Save the document as a web page")
	MenuLabel(AP_MENU_ID_WEB_WEBPREVIEW,   "Taispeán mar Leathanach Idirlín", "Preview the document as a web page")

	MenuLabel(AP_MENU_ID_WINDOW,			"&Window",			NULL)
	MenuLabel(AP_MENU_ID_WINDOW_NEW,		"&New Window",		"Open another window for the document")
	MenuLabel(AP_MENU_ID_WINDOW_1,			"&1 %s",			"Bog an fhuinneog seo chun tosaigh")
	MenuLabel(AP_MENU_ID_WINDOW_2,			"&2 %s",			"Bog an fhuinneog seo chun tosaigh")
	MenuLabel(AP_MENU_ID_WINDOW_3,			"&3 %s",			"Bog an fhuinneog seo chun tosaigh")
	MenuLabel(AP_MENU_ID_WINDOW_4,			"&4 %s",			"Bog an fhuinneog seo chun tosaigh")
	MenuLabel(AP_MENU_ID_WINDOW_5,			"&5 %s",			"Bog an fhuinneog seo chun tosaigh")
	MenuLabel(AP_MENU_ID_WINDOW_6,			"&6 %s",			"Bog an fhuinneog seo chun tosaigh")
	MenuLabel(AP_MENU_ID_WINDOW_7,			"&7 %s",			"Bog an fhuinneog seo chun tosaigh")
	MenuLabel(AP_MENU_ID_WINDOW_8,			"&8 %s",			"Bog an fhuinneog seo chun tosaigh")
	MenuLabel(AP_MENU_ID_WINDOW_9,			"&9 %s",			"Bog an fhuinneog seo chun tosaigh")
	MenuLabel(AP_MENU_ID_WINDOW_MORE,		"&More Windows",	"Show full list of windows")

	MenuLabel(AP_MENU_ID_HELP,			"Cabhair",		NULL)
	...
	MenuLabel(AP_MENU_ID_HELP_ABOUT,		"Faoi %s",		"Display program information, version number, and copyright") 
	MenuLabel(AP_MENU_ID_HELP_ABOUTOS,		"Faoi Foinse Oscailte",	"Taispeán eolas faoi Foinse Oscailte")  // Foinse Oscailte = Open Source

	MenuLabel(AP_MENU_ID_SPELL_SUGGEST_1,	"%s",				"Athraigh chuig an litríocht seo") // literally: change to this spelling
	MenuLabel(AP_MENU_ID_SPELL_SUGGEST_2,	"%s",				"Athraigh chuig an litríocht seo")
	MenuLabel(AP_MENU_ID_SPELL_SUGGEST_3,	"%s",				"Athraigh chuig an litríocht seo")
	MenuLabel(AP_MENU_ID_SPELL_SUGGEST_4,	"%s",				"Athraigh chuig an litríocht seo")
	MenuLabel(AP_MENU_ID_SPELL_SUGGEST_5,	"%s",				"Athraigh chuig an litríocht seo")
	MenuLabel(AP_MENU_ID_SPELL_SUGGEST_6,	"%s",				"Athraigh chuig an litríocht seo")
	MenuLabel(AP_MENU_ID_SPELL_SUGGEST_7,	"%s",				"Athraigh chuig an litríocht seo")
	MenuLabel(AP_MENU_ID_SPELL_SUGGEST_8,	"%s",				"Athraigh chuig an litríocht seo")
	MenuLabel(AP_MENU_ID_SPELL_SUGGEST_9,	"%s",				"Athraigh chuig an litríocht seo")
	MenuLabel(AP_MENU_ID_SPELL_IGNOREALL,	"&Ignore All", 		"Ignore all occurrences of this word in the document")
	MenuLabel(AP_MENU_ID_SPELL_ADD,			"&Add", 			"Chuir an focail seo i do Foclóir Pearsanta")
	...
	MenuLabel(AP_MENU_ID_AUTOTEXT_CLOSING_1, "%s", "Mise Le Meas")
	...
	MenuLabel(AP_MENU_ID_AUTOTEXT_SALUTATION_1, "%s", "A Chara") // masculine
	MenuLabel(AP_MENU_ID_AUTOTEXT_SALUTATION_2, "%s", "A Cara") // feminine
	...
	// ... add others here ... // ... agus lipéad eile anseo ...
