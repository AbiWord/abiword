...
BeginSet(en,IE,false)
	...
	MenuLabel(AP_MENU_ID_FILE_IMPORT,       "&Import",			"Import the document")
	MenuLabel(AP_MENU_ID_FILE_EXPORT,       "&Export",			"Save the document without changing the current name")
	...
	MenuLabel(AP_MENU_ID_FMT_BACKGROUND,   	"Back&ground", "Change your document's background colour")
