...
BeginSetEnc(nn,NO,true,"iso-8859-1")
	...
	MenuLabel(AP_MENU_ID_FILE_IMPORT,       "O&pn kopi ",			"Opnar eit dokument under eit nytt namn")
	MenuLabel(AP_MENU_ID_FILE_EXPORT,       "Lag&r kopi ",			"Lagrar dokumentet utan å endra gjeldande namn")
	...
	MenuLabel(AP_MENU_ID_EDIT_PASTE_SPECIAL, "Lim inn u&formatert",  "Sett inn uformatert innhald frå utklippstavla")
	...
	MenuLabel(AP_MENU_ID_EDIT_REMOVEHEADER,			"Fjern to&pptekst",			"Fjernar toppteksten på denne sida frå dokumentet")
	MenuLabel(AP_MENU_ID_EDIT_REMOVEFOOTER,			"Fjern bot&ntekst",			"Fjernar botnteksten på denne sida frå dokumentet")
	
	MenuLabel(AP_MENU_ID_VIEW,				"&Vis",			NULL)
        MenuLabel(AP_MENU_ID_VIEW_NORMAL, "&Normaloppsett", "Normalvising")
	...
	MenuLabel(AP_MENU_ID_VIEW_RULER,		"Vis &Linjal",			"Viser eller skjuler linjalar")
	MenuLabel(AP_MENU_ID_VIEW_STATUSBAR,	"Vis &Statuslinje",		"Viser eller skjuler statuslinja")
	...
	MenuLabel(AP_MENU_ID_VIEW_HEADFOOT,		"&Topptekst og botntekst",	"Viser tekst på toppen eller botnen av kvar side")
     ...
     MenuLabel(AP_MENU_ID_VIEW_ZOOM_MENU, "&Forstørring ",			"Endrar visingsstorleiken på skjermen")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM,			"&Forstørring",			"Endrar visingsstorleiken på skjermen")
     MenuLabel(AP_MENU_ID_VIEW_ZOOM_200, "Forstørr til &200 %", "Forstørr til 200 %")
     MenuLabel(AP_MENU_ID_VIEW_ZOOM_100, "Forstørr til &100 %", "Forstørr til 100 %")
     MenuLabel(AP_MENU_ID_VIEW_ZOOM_75, "Forstørr til &75 %", "Forstørr til 75 %")
     MenuLabel(AP_MENU_ID_VIEW_ZOOM_50, "Forstørr til &50 %", "Forstørr til 50 %")
     MenuLabel(AP_MENU_ID_VIEW_ZOOM_WIDTH, "Forstørr til &sidebreidd", "Forstørr til sidebreidd")
     MenuLabel(AP_MENU_ID_VIEW_ZOOM_WHOLE, "Forstørr til &heile sida", "Forstørr til heile sida")
	...
	MenuLabel(AP_MENU_ID_INSERT_GRAPHIC,	"&Frå fil ",			"Sett inn eit bilde frå ei grafikkfil")

	MenuLabel(AP_MENU_ID_FORMAT,			"F&ormat",			NULL)
	MenuLabel(AP_MENU_ID_FMT_LANGUAGE,		"Vel s&pråk",		"Endrar språket til merkt tekst")
	...
	MenuLabel(AP_MENU_ID_FMT_TOPLINE,		"&Topplinje",			"Aktiver/deaktiver linje over det merkte området")
	MenuLabel(AP_MENU_ID_FMT_BOTTOMLINE,	"&Botnlinje",		"Aktiver/deaktiver linje under det merkte området")
	...
	MenuLabel(AP_MENU_ID_TOOLS_SPELL,		"&Stavekontroll ",		"Stavekontrollerer dokumentet")
     ...
     MenuLabel(AP_MENU_ID_TOOLS_SPELLPREFS, "Stavekontroll&innstillingar", "Endrar stavekontrollinnstillingar")
	...
	MenuLabel(AP_MENU_ID_HELP,			"&Hjelp",			NULL)
     MenuLabel(AP_MENU_ID_HELP_CREDITS, "&Bidragsytarar", "Informasjon om utviklarane av AbiWord")
	...
	MenuLabel(AP_MENU_ID_HELP_ABOUTOS,		"Om o&pen kjeldekode ",	"Viser informasjon om open kjeldekode-prinsippet")
     MenuLabel(AP_MENU_ID_HELP_ABOUT_GNU, "Om &GNU Free Software ", "Viser informasjon om GNU-prosjektet")
     MenuLabel(AP_MENU_ID_HELP_ABOUT_GNOMEOFFICE, "Om G&NOME Office ", "Viser informasjon om GNOME Office-prosjektet")
