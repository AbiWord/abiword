...
BeginSetEnc(nn,NO,true,"iso-8859-1")
	...
	MenuLabel(AP_MENU_ID_FILE_EXPORT,       "&Eksporter ",			"Lagrar dokumentet utan å endra gjeldande namn")
	...
	MenuLabel(AP_MENU_ID_VIEW_ZOOM,			"&Forstørring",			"Endrar visingsstorleiken på skjermen")
     ...
     MenuLabel(AP_MENU_ID_VIEW_ZOOM_WIDTH, "Forstørr til &heile sida", "Forstørr til heile sida")
     MenuLabel(AP_MENU_ID_VIEW_ZOOM_WHOLE, "Forstørr til &sidebreidd", "Forstørr til sidebreidd")
