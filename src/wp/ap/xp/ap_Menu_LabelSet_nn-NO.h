...
BeginSet(nn,NO,true)
	...
	MenuLabel(AP_MENU_ID_FILE_EXPORT,       "&Eksporter",			"Lagrar dokumentet utan å endra namn")
	...
	MenuLabel(AP_MENU_ID_EDIT_PASTE_SPECIAL, "Lim inn &uformatert",  "Sett inn uformatert innhald frå utklippstavla")
	...
	MenuLabel(AP_MENU_ID_WEB, "N&ettsideb", NULL)
        MenuLabel(AP_MENU_ID_WEB_SAVEASWEB,               "Lagr som n&ettside", "Lagrar dokumentet som ei nettside")
        MenuLabel(AP_MENU_ID_WEB_WEBPREVIEW,              "Førehands&vis som nettside", "Førehandsviser dokumentet som ei nettside")
