...
BeginSetEnc(nl,NL,true,"iso-8859-1")

	ToolbarLabel(AP_TOOLBAR_ID__BOGUS1__,		NULL,		NoIcon,			NULL,NULL)

	//          (id, 		                    szLabel,	IconName,     	szToolTip,      szStatusMsg)

	ToolbarLabel(AP_TOOLBAR_ID_FILE_NEW,		"Nieuw", 		tb_new_xpm,			NULL, "Nieuw leeg document")	
	ToolbarLabel(AP_TOOLBAR_ID_FILE_OPEN,		"Openen",		tb_open_xpm,			NULL, "Document openen")
	ToolbarLabel(AP_TOOLBAR_ID_FILE_SAVE,		"Opslaan", 		tb_save_xpm,			NULL, "Document opslaan")
	...
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_COPY,		"Kopieëren",		tb_copy_xpm,			NULL, "Kopieëren")
	...
	ToolbarLabel(AP_TOOLBAR_ID_IMG,			"Afbeelding invoegen",	tb_insert_graphic_xpm,		NULL, "Plaats een afbeelding in het document")
	ToolbarLabel(AP_TOOLBAR_ID_VIEW_SHOWPARA,	"Alles weergeven",	tb_view_showpara_xpm,		NULL, "Toon/verberg ¶")

	ToolbarLabel(AP_TOOLBAR_ID_ALIGN_LEFT,		"Links",		tb_text_align_left_xpm,		NULL, "Linker kantlijn")
	ToolbarLabel(AP_TOOLBAR_ID_ALIGN_CENTER,	"Centreren",		tb_text_center_xpm,		NULL, "Centreren")
