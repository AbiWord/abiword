...
BeginSet(NoNO,UT_TRUE)
	...
	ToolbarLabel(AP_TOOLBAR_ID_FILE_SAVEAS,		"Lagre som", 	tb_save_as_xpm,	NULL, "Lagre dokumentet under et nytt navn")
	ToolbarLabel(AP_TOOLBAR_ID_FILE_PRINT,		"Skriv ut",	tb_print_xpm,	NULL, "Skriv ut dokumentet")

	ToolbarLabel(AP_TOOLBAR_ID_EDIT_UNDO,		"Omgjøre",	tb_undo_xpm,	NULL, "Omgjøre")
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_REDO,		"Genta",	tb_redo_xpm,	NULL, "Genta")
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_CUT,		"Klipp",		tb_cut_xpm,	NULL, "Klipp")
	...
	ToolbarLabel(AP_TOOLBAR_ID_ALIGN_CENTER,	"Sentreret",	tb_text_center_xpm,	NULL, "Sentreret")
	ToolbarLabel(AP_TOOLBAR_ID_ALIGN_RIGHT,		"Høyre",	tb_text_align_right_xpm,NULL, "Høyrestillet")
