...
BeginSetEnc(de,DE,true,"iso-8859-1")
	...
	ToolbarLabel(AP_TOOLBAR_ID_LISTS_NUMBERS,		"Nummerierte Liste",		tb_lists_numbers_xpm,		NULL,		"Start/Stop Nummerierungsliste")
     ...
     ToolbarLabel(AP_TOOLBAR_ID_COLOR_FORE,		"Vordergrund",	tb_text_fgcolor_xpm,						NULL, "Vordergrund")
     ToolbarLabel(AP_TOOLBAR_ID_COLOR_BACK,		"Hintergrund",	tb_text_bgcolor_xpm,						NULL, "Hintergrund")
