...
BeginSet(CsCZ,UT_TRUE)
	...
	MenuLabel(AP_MENU_ID_VIEW_SHOWPARA,		"Zobrazovat Para&graphs",	"Zobrazovat netisknutelné znaky")
	...
	MenuLabel(AP_MENU_ID_INSERT_BREAK,		"&Konec",			"Vlo¾it konec stránky, sloupce nebo odstavce")
	...
	MenuLabel(AP_MENU_ID_INSERT_GRAPHIC,		"&Obrázek",			"Vlo¾it obrázek ze souboru")
	...
	MenuLabel(AP_MENU_ID_FMT_TABS,			"&Tabulátory",			"Nastavení tabulátorù")
