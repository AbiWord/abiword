...
//	_s(AP_MENU_ID_VIEW_HEADFOOT,	0,0,1,	"viewHeadFoot",		ap_GetState_View,		NULL);
    ...
    _s(AP_MENU_ID_TABLE_INSERT_COLUMNS_LEFT,0,0,0, NULL, ap_GetState_InTable, NULL);
    _s(AP_MENU_ID_TABLE_INSERT_COLUMNS_RIGHT,0,0,0, NULL, ap_GetState_InTable, NULL);
    _s(AP_MENU_ID_TABLE_INSERT_ROWS_ABOVE,0,0,0, NULL, ap_GetState_InTable, NULL);
    _s(AP_MENU_ID_TABLE_INSERT_ROWS_BELOW,0,0,0, NULL, ap_GetState_InTable, NULL);
    ...
    _s(AP_MENU_ID_TABLE_DELETE_COLUMNS,0,0,0, NULL, ap_GetState_InTable, NULL);
    _s(AP_MENU_ID_TABLE_DELETE_ROWS,0,0,0, NULL, ap_GetState_InTable, NULL);
    _s(AP_MENU_ID_TABLE_DELETE_CELLS,0,0,0, NULL, ap_GetState_InTable, NULL);
    ...
    _s(AP_MENU_ID_TABLE_MERGE_CELLS,0,0,0, NULL, ap_GetState_InTable, NULL);
    ...
    _s(AP_MENU_ID_TABLE_FORMAT,0,0,0, NULL, ap_GetState_InTable, NULL);
