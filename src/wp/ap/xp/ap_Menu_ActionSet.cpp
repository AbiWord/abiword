...
#define _s(id,bHoldsSubMenu,bRaisesDialog,bCheckable,bRadio,szMethodName,pfnGetState,pfnGetLabel)	\
	...
	_s(AP_MENU_ID_TOOLS_ANNOTATIONS_INSERT_FROMSEL,	0,0,0,0,	"insAnnotation",	ap_GetState_Selection,					NULL);
	_s(AP_MENU_ID_TOOLS_ANNOTATIONS_TOGGLE_DRAWER,	0,1,0,0,	"dlgInsertAnnotation"/*for dlg testing only*/,	NULL,					NULL);
