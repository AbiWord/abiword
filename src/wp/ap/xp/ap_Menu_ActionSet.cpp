...
//	_s(AP_MENU_ID_VIEW_HEADFOOT,	0,0,1,	"viewHeadFoot",		ap_GetState_View,		NULL);
	...
	_s(AP_MENU_ID_INSERT_FOOTNOTE,	0,0,0,	"insFootnote",		NULL,					NULL);
	...
	_s(AP_MENU_ID_FMT_FOOTNOTES,     0,1,0, "formatFootnotes", NULL, NULL);
	...
	_s(AP_MENU_ID_TOOLS_SCRIPTS,	0,1,0,	"scriptPlay", ap_GetState_ScriptsActive, NULL);
	_s(AP_MENU_ID_TOOLS_MAILMERGE,	0,1,0,	"mailMerge", NULL, NULL);
	...
	_s(AP_MENU_ID_WEB_WEBPREVIEW, 0,0,0, "filePreviewWeb", NULL, NULL);
