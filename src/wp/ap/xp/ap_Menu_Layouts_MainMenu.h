...
//		MenuItem(AP_MENU_ID_VIEW_HEADFOOT)
	...
	BeginSubMenu(AP_MENU_ID_TABLE)
    	BeginSubMenu(AP_MENU_ID_TABLE_INSERT)
	        ...
	        MenuItem(AP_MENU_ID_TABLE_INSERT_COLUMNS_LEFT)
	        MenuItem(AP_MENU_ID_TABLE_INSERT_COLUMNS_RIGHT)
	        MenuItem(AP_MENU_ID_TABLE_INSERT_ROWS_ABOVE)
	        MenuItem(AP_MENU_ID_TABLE_INSERT_ROWS_BELOW)
