...
BeginSetEnc(sl,SI,true,"iso-8859-2")
	...
	MenuLabel(AP_MENU_ID_FMT_STYLE,			"&Slog",			"Doloèi ali uveljavi slog na izbiri")
	...
	MenuLabel(AP_MENU_ID_FMT_UNDERLINE,		"Podè&rtano",		"Naredi izbiro podèrtano (preklopi)")
	...
	MenuLabel(AP_MENU_ID_ALIGN_CENTER,		"&Sredi¹èna",			"Poravnaj odstavek na sredini")
