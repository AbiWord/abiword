...
BeginSetEnc(pl,PL,true,"iso-8859-2")
	...
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_REDO,		"Anuluj cofniêcie",		tb_redo_xpm,	NULL, "Anuluj cofniêcie ostatniej czynno¶ci")
   ...
   ToolbarLabel(AP_TOOLBAR_ID_FMT_BOOKMARK, "Zak³adka", tb_anchor, NULL, "Wstaw zak³adkê do dokumentu")
	ToolbarLabel(AP_TOOLBAR_ID_FMT_SIZE,		"Wielko¶æ czcionki", NoIcon,		NULL, "Wielko¶æ czcionki")
