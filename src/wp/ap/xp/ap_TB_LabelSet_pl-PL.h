...
BeginSetEnc(pl,PL,true,"iso-8859-2")
	...
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_UNDO,		"Cofnij",		tb_undo_xpm,	NULL, "Cofa ostatni± czynno¶æ")
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_REDO,		"Anuluj cofniêcie",		tb_redo_xpm,	NULL, "Anuluje cofniêcie ostatniej czynno¶ci")
	...
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_REMOVEHEADER, "Usuñ nag³ówek",		tb_edit_removeheader_xpm,			NULL, "Usuwa nag³ówek")
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_REMOVEFOOTER, "Usuñ stopkê",		tb_edit_removefooter_xpm,			NULL, "Usuwa stopkê")
	ToolbarLabel(AP_TOOLBAR_ID_SPELLCHECK,		"Pisownia",	tb_spellcheck_xpm,		NULL, "Sprawdza pisowniê")
	ToolbarLabel(AP_TOOLBAR_ID_IMG,				"Rycina",	tb_insert_graphic_xpm,	NULL, "Wstawia rycinê")
   ...
   ToolbarLabel(AP_TOOLBAR_ID_FMT_BOOKMARK, "Zak³adka", tb_anchor, NULL, "Wstawia zak³adkê")
	...
	ToolbarLabel(AP_TOOLBAR_ID_MIDDLE_SPACE,	"Interlinia 1.5",		tb_line_middle_space_xpm,	NULL, "Interlinia pó³tora wiersza")
	...
	ToolbarLabel(AP_TOOLBAR_ID_VIEW_SHOWPARA,	"Kody steruj±ce",			tb_view_showpara_xpm,		NULL, "Prze³±cza widoczno¶æ kodów steruj±cych")
	...
	ToolbarLabel(AP_TOOLBAR_ID_INDENT,			"Wiêksze wciêcie",	tb_text_indent_xpm, 	NULL, "Zwiêksza wciêcie akapitu")
	ToolbarLabel(AP_TOOLBAR_ID_UNINDENT,		"Mniejsze wciêcie",	tb_text_unindent_xpm,	NULL, "Zmniejsza wciêcie akapitu")
