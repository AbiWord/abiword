...
BeginSetEnc(ca,ES,true,"iso-8859-1")
	...
	MenuLabel(AP_MENU_ID_FILE_IMPORT,		"I&mporta",			"Importa un document")
	MenuLabel(AP_MENU_ID_FILE_EXPORT,		"E&xporta",			"Exporta un document")
	...
	MenuLabel(AP_MENU_ID_FILE_PRINT_DIRECTLY,	"Imprimeix &directament",	"Imprimeix internament en PostScript")
	MenuLabel(AP_MENU_ID_FILE_PRINT_PREVIEW, 	"Pre&visulitza la impressió",   "Mostra el resultat de la impressió")
	...
	MenuLabel(AP_MENU_ID_EDIT_PASTE_SPECIAL,	"Enganxa &sense format",	"Insereix el contingut del porta-retalls sense format")
	...
	MenuLabel(AP_MENU_ID_EDIT_EDITHEADER,		"Ca&pçalera",			"Edita la capçalera")
    	MenuLabel(AP_MENU_ID_EDIT_EDITFOOTER,		"&Peu de pàgina",		"Edita el peu de pàgina")
    	MenuLabel(AP_MENU_ID_EDIT_REMOVEHEADER,		"Eli&mina capçalera",		"Elimina la capçalera")
	MenuLabel(AP_MENU_ID_EDIT_REMOVEFOOTER,		"Elimi&na peu de pàgina",	"Elimina el peu de pàgina")

	MenuLabel(AP_MENU_ID_VIEW,			"&Visualitza",			NULL)
	MenuLabel(AP_MENU_ID_VIEW_NORMAL,		"&Normal",			"Visualització normal")
   	MenuLabel(AP_MENU_ID_VIEW_WEB,			"&Web",				"Disposició per a la web")
	MenuLabel(AP_MENU_ID_VIEW_PRINT,		"&Impresió",			"Disposició per imprimir")
	...
	MenuLabel(AP_MENU_ID_VIEW_ZOOM_MENU, 		"&Zoom", 			"Reducció o ampliació en la visualització del document")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM,			"&Zoom",			"Redueix o amplia la visualització del document")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM_200, 		"Zoom al &200%", 		"Zoom al 200%")
        MenuLabel(AP_MENU_ID_VIEW_ZOOM_100, 		"Zoom al &100%", 		"Zoom al 100%")
        MenuLabel(AP_MENU_ID_VIEW_ZOOM_75, 		"Zoom al &75%", 		"Zoom al 75%")
        MenuLabel(AP_MENU_ID_VIEW_ZOOM_50, 		"Zoom al &50%", 		"Zoom al 50%")
        MenuLabel(AP_MENU_ID_VIEW_ZOOM_WIDTH, 		"Zoom a tota la &pàgina", 	"Zoom de pantalla sencera")
        MenuLabel(AP_MENU_ID_VIEW_ZOOM_WHOLE, 		"Zoom al &llarg de la  pàgina", "Zoom a la llargada de la pàgina")

	MenuLabel(AP_MENU_ID_INSERT,			"&Inserta",			NULL)
	MenuLabel(AP_MENU_ID_INSERT_BREAK,		"&Salt",			"Inserta un salt de pàgina, columna o secció")
	MenuLabel(AP_MENU_ID_INSERT_PAGENO,		"N&úmeros de pàgina",		"Inserta automàticament el número de pàgina")
	MenuLabel(AP_MENU_ID_INSERT_DATETIME,		"Da&ta i hora",			"Inserta la data i/o hora")
	MenuLabel(AP_MENU_ID_INSERT_FIELD,		"&Camp",			"Inserta un camp calculat")
	MenuLabel(AP_MENU_ID_INSERT_SYMBOL,		"&Símbol",			"Inserta un símbol o aun altre caràcter especial")
	MenuLabel(AP_MENU_ID_INSERT_ENDNOTE,		"&Nota final",			"Inserta una nota al final del document")
	MenuLabel(AP_MENU_ID_INSERT_PICTURE, 		"&Gràfics", 			"Inserta un gràfic")
	MenuLabel(AP_MENU_ID_INSERT_CLIPART,		"&Clip Art",			"Inserta un gràfic clip art")
	MenuLabel(AP_MENU_ID_INSERT_GRAPHIC,		"&Del fitxer",			"Inserua una imatge existent d'un altre fitxer")

	MenuLabel(AP_MENU_ID_FORMAT,			"F&ormat",			NULL)
	MenuLabel(AP_MENU_ID_FMT_LANGUAGE,		"&Idioma",			"Canvia l'idioma del text seleccionat")
	...
	MenuLabel(AP_MENU_ID_FMT_BACKGROUND,		"&Fons",			"Canvia el color de fons del document")
	...
	MenuLabel(AP_MENU_ID_FMT_TOPLINE,		"Línia superior",		"Línia a sobre la selecció (commuta)")
	MenuLabel(AP_MENU_ID_FMT_BOTTOMLINE,		"Línia inferior",		"Línia a sota la selecció (commuta)")
	...
	MenuLabel(AP_MENU_ID_TOOLS_SPELLPREFS, 		"&Opcions del corrector", 	"Estableix les preferències del corrector ortogràfic")
	...
	MenuLabel(AP_MENU_ID_TOOLS_PLUGINS,		"&Extensions",			"Gestiona les extensions")
	MenuLabel(AP_MENU_ID_TOOLS_SCRIPTS,		"S&cript",			"Executa un script")
	...
	MenuLabel(AP_MENU_ID_HELP_CREDITS, 		"C&rèdits", 			"Reconeixaments i agraïments")
	MenuLabel(AP_MENU_ID_HELP_INDEX,		"Í&ndex",			"Mostra l'índex de l'ajuda")
	...
	MenuLabel(AP_MENU_ID_HELP_ABOUT_GNU,		"Quant a la &GNU",		"Mostra informació sobre la GNU")
	MenuLabel(AP_MENU_ID_HELP_ABOUT_GNOMEOFFICE,	"Quant al GNOME &OFFICE",	"Mostra informació sobre la GNOMEOFFICE")
