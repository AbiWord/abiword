...
BeginSetEnc(en,US,true,"iso-8859-1")
	...
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_HEADER,	 "Edit Header",		tb_edit_editheader_xpm,			NULL, "Edit Header")
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_FOOTER,	 "Edit Footer",		tb_edit_editfooter_xpm,			NULL, "Edit Footer")
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_REMOVEHEADER, "Remove Header",		tb_edit_removeheader_xpm,			NULL, "Remove Header")
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_REMOVEFOOTER, "Remove Footer",		tb_edit_removefooter_xpm,			NULL, "Remove Footer")
