...
BeginSet(de,DE,true)
	...
	MenuLabel(AP_MENU_ID_FILE_SAVEASWEB,               "Speichern als &Webseite", "Speichere das Dokument als eine Webseite")
	MenuLabel(AP_MENU_ID_FILE_WEBPREVIEW,              "&Vorschau als Webseite", "Zeige das Dokument in dem Browser an")	
