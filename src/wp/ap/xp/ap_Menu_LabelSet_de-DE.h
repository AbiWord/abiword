...
BeginSetEnc(de,DE,true,"iso-8859-1")
	...
	MenuLabel(AP_MENU_ID_FILE_PRINT_DIRECTLY,		"Drucke &direkt",			"Drucke über den internen PS Treiber")	
	...
	MenuLabel(AP_MENU_ID_EDIT_EDITHEADER,			"Kopfzeile",			"Bearbeite die Kopfzeile")
	MenuLabel(AP_MENU_ID_EDIT_EDITFOOTER,			"Fußzeile",			"Bearbeite die Fußzeile")

	
	MenuLabel(AP_MENU_ID_VIEW,				"&Ansicht",			NULL)
	MenuLabel(AP_MENU_ID_VIEW_NORMAL,	"&Normal", 	"Normale Ansicht")
	MenuLabel(AP_MENU_ID_VIEW_WEB,	"&Web-Ansicht",	"Web-Ansicht")
	MenuLabel(AP_MENU_ID_VIEW_PRINT, "&Druckansicht", "Druckansicht")
	...
	MenuLabel(AP_MENU_ID_VIEW_HEADFOOT,		"&Kopf- und Fußzeilen",	"Kopf- und Fußzeilen editieren")
        MenuLabel(AP_MENU_ID_VIEW_FULLSCREEN, "Vollbild", "Zeige das Dokument als Vollbild")
        MenuLabel(AP_MENU_ID_VIEW_ZOOM_MENU, "&Zoom", "Ansichtsgröße des Dokuments festlegen")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM,			"&Zoom",			"Ansichtsgröße des Dokuments festlegen")
        MenuLabel(AP_MENU_ID_VIEW_ZOOM_200, "Zoome auf &200%", "Zoome auf 200%")
        MenuLabel(AP_MENU_ID_VIEW_ZOOM_100, "Zoome auf &100%", "Zoome auf 100%")
        MenuLabel(AP_MENU_ID_VIEW_ZOOM_75, "Zoome auf &75%", "Zoome auf 75%")
        MenuLabel(AP_MENU_ID_VIEW_ZOOM_50, "Zoome auf &50%", "Zoome auf 50%")
        MenuLabel(AP_MENU_ID_VIEW_ZOOM_WIDTH, "Zoome auf &Seitenbreite", "Zoome auf Seitenbreite")
        MenuLabel(AP_MENU_ID_VIEW_ZOOM_WHOLE, "Zoome auf &Ganze Seite", "Zoome auf Ganze Seite")
	...
	MenuLabel(AP_MENU_ID_INSERT_SYMBOL,		"So&nderzeichen",	"Symbol oder Sonderzeichen einfügen")
        MenuLabel(AP_MENU_ID_INSERT_PICTURE, "&Grafik", "Bild einfügen")	
	MenuLabel(AP_MENU_ID_INSERT_GRAPHIC,	"&Aus Datei",			"Grafik aus Datei einfügen")

	MenuLabel(AP_MENU_ID_FORMAT,			"Forma&t",			NULL)
	MenuLabel(AP_MENU_ID_FMT_LANGUAGE,		"&Sprache",		"Ändere die Sprache des aktuellen Textes")	
	...
	MenuLabel(AP_MENU_ID_FMT_COLUMNS,		"&Spalten",			"Spaltenzahl der Markierung ändern")
        MenuLabel(AP_MENU_ID_FMT_TOGGLECASE,		"&Gross/Kleinschreibung", "Verändere die Gross/Kleinschreibung")
        MenuLabel(AP_MENU_ID_FMT_BACKGROUND,		"&Hintergrund",		"Hintergrundfarbe verändern")
	...
	MenuLabel(AP_MENU_ID_TOOLS_OPTIONS,		"&Optionen",		"Einstellungen für das Programm ändern")
        MenuLabel(AP_MENU_ID_TOOLS_LANGUAGE, "&Sprache", "Verändere die Spracheinstellung des markierten Textes")
	...
	MenuLabel(AP_MENU_ID_ALIGN_JUSTIFY,		"&Blocksatz",		"Absatz ausrichten")

	MenuLabel(AP_MENU_ID_WEB_SAVEASWEB,               "Speichern als &Webseite", "Speichere das Dokument als eine Webseite")
	MenuLabel(AP_MENU_ID_WEB_WEBPREVIEW,              "&Vorschau als Webseite", "Zeige das Dokument in dem Browser an")	
	...
	MenuLabel(AP_MENU_ID_AUTOTEXT_ATTN, "Achtung:", "")
	MenuLabel(AP_MENU_ID_AUTOTEXT_CLOSING, "Abschied:", "") 
	MenuLabel(AP_MENU_ID_AUTOTEXT_MAIL, "Brief:", "")
	MenuLabel(AP_MENU_ID_AUTOTEXT_REFERENCE, "Referenz:", "")
	MenuLabel(AP_MENU_ID_AUTOTEXT_SALUTATION, "Begrüßung:", "")
	MenuLabel(AP_MENU_ID_AUTOTEXT_SUBJECT, "Betreff:", "")
