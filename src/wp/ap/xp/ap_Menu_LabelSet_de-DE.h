...
BeginSet(DeDE)
	...
	MenuLabel(AP_MENU_ID_FILE_SAVEAS,		"Speichern &unter", 		"Aktuelles Dokument unter einem anderen Namen speichern")
        MenuLabel(AP_MENU_ID_FILE_PAGESETUP,            "Seite ein&richten",		"TODO: insert description")
	...
	MenuLabel(AP_MENU_ID_EDIT_UNDO,			"&Rückgängig",			"Letzte Aktion rückgängig machen")
	MenuLabel(AP_MENU_ID_EDIT_REDO,			"&Wiederholen",			"Rückgängig gemachte Aktion wiederholen")
	...
	MenuLabel(AP_MENU_ID_EDIT_GOTO,			"&Gehe zu",			"TODO: insert description")
	MenuLabel(AP_MENU_ID_EDIT_OPTIONS,		"Einstellungen",		"Set options")
	...
	MenuLabel(AP_MENU_ID_VIEW_TB_FORMAT,	        "Formatierung",	        	"Symbolleiste <Formatierung> anzeigen oder verbergen")
	...
	MenuLabel(AP_MENU_ID_VIEW_SHOWPARA,		"Para&graphs",            	"Paragraphen anzeigen oder verbergen")
	MenuLabel(AP_MENU_ID_VIEW_HEADFOOT,		"&Kopf- und Fußzeilen",  	"Kopf- und Fußzeilen editieren")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM,			"&Zoom",			"TODO: insert description")
	...
	MenuLabel(AP_MENU_ID_FMT_PARAGRAPH,		"Paragraph",    		"TODO: insert description")
	MenuLabel(AP_MENU_ID_FMT_BULLETS,		"Aufzählungen",         	"TODO: insert description")
	MenuLabel(AP_MENU_ID_FMT_BORDERS,		"&Rahmen und Schattierung",	"Rahmen und Schattierung der Markierung bearbeiten")
	MenuLabel(AP_MENU_ID_FMT_COLUMNS,		"&Spalten",			"TODO: insert description")
	MenuLabel(AP_MENU_ID_FMT_STYLE,			"St&yle",			"TODO: insert description")
	...
	MenuLabel(AP_MENU_ID_ALIGN,			"&Ausrichtung",			NULL)
	...
	MenuLabel(AP_MENU_ID_ALIGN_JUSTIFY,		"&Justify",			"TODO: insert description")

	MenuLabel(AP_MENU_ID_WINDOW,			"&Fenster",			NULL)
	MenuLabel(AP_MENU_ID_WINDOW_NEW,		"&Neues Fenster",		"Feues Fenster für ein Dokument öffnen")
