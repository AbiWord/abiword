...
BeginSet(DaDK)
	...
	ToolbarLabel(AP_TOOLBAR_ID_FILE_SAVEAS,		"Gem som", 	tb_save_as_xpm,	NULL, "Gem dokumentet under et andet navn")
	ToolbarLabel(AP_TOOLBAR_ID_FILE_PRINT,		"Udskriv",	tb_print_xpm,	NULL, "Udskriv hele dokumentet")
	...
	ToolbarLabel(AP_TOOLBAR_ID_EDIT_PASTE,		"Sæt ind",	tb_paste_xpm,	NULL, "Sæt ind")
	...
	ToolbarLabel(AP_TOOLBAR_ID_FMT_BOLD,		"Fed",		tb_text_bold_xpm,	NULL, "Fed")
	...
	ToolbarLabel(AP_TOOLBAR_ID_FMT_STRIKE,		"Gennemstreget",tb_text_strikeout_xpm,	NULL, "Gennemstreget")

	ToolbarLabel(AP_TOOLBAR_ID_ALIGN_LEFT,		"Venstre",	tb_text_align_left_xpm,	NULL, "Venstrejusteret")
	ToolbarLabel(AP_TOOLBAR_ID_ALIGN_CENTER,	"Centreret",	tb_text_center_xpm,	NULL, "Centreret")
	ToolbarLabel(AP_TOOLBAR_ID_ALIGN_RIGHT,		"Højre",	tb_text_align_right_xpm,NULL, "Højrejusteret")
