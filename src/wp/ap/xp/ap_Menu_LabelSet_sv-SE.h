...
BeginSet(sv,SE,UT_TRUE)
	...
	MenuLabel(AP_MENU_ID_INSERT_FIELD,		"F&ält",			"Infogar ett automatiskt fält")
	MenuLabel(AP_MENU_ID_INSERT_SYMBOL,		"S&ymbol",			"Infogar en symbol eller annat specialtecken")
	MenuLabel(AP_MENU_ID_INSERT_GRAPHIC,	"&Bi&ldobjekt",		"Infogar en ny bild från en annan fil")
	...
	MenuLabel(AP_MENU_ID_TOOLS_WORDCOUNT,	"&Ord statistik",	"Räkna antal ord, rader, paragrafer, osv i dokumentet")
