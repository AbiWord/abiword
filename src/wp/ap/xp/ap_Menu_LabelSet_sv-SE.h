...
BeginSet(sv,SE,true)
	...
	MenuLabel(AP_MENU_ID_FILE_SAVEAS,		"Spara so&m", 		"Sparar dokumentet med ett nytt namn")
        MenuLabel(AP_MENU_ID_WEB_SAVEASWEB,               "Spara som &websida",   "Spara dokumentet som websida")
        MenuLabel(AP_MENU_ID_WEB_WEBPREVIEW,              "&Visa som websida",    "Visa dokumentet som websida")
