...
BeginSetEnc(sv,SE,true,"iso-8859-1")
	...
	MenuLabel(AP_MENU_ID_FILE_EXPORT,       "&Exportera",			"Spara dokumentet utan att ändra namn")
	...
	MenuLabel(AP_MENU_ID_FMT_LANGUAGE,		"&Språk",		"Ändra språk på den markerade texten")
	...
	MenuLabel(AP_MENU_ID_FMT_DOCUMENT,		"&Dokument",             "Ändrar inställningar för dokumentet så som pappersstorlek och marginaler")
	MenuLabel(AP_MENU_ID_FMT_STYLE,			"Format&mall", "Definiera och använda formatmallar")
	MenuLabel(AP_MENU_ID_FMT_TOGGLECASE,   	"&Ändra skiftläge", "Ändrar skiftläget på den markerade texten")
	MenuLabel(AP_MENU_ID_FMT_BACKGROUND,   	"Bak&grund", "Ändrar dokumentets bakgrundsfärg")
	...
	MenuLabel(AP_MENU_ID_FMT_TOPLINE,		"Övre kantlinje",			"Linje ovanför markeringen (växlande)")
	MenuLabel(AP_MENU_ID_FMT_BOTTOMLINE,	"Undre kantlinje",		"Linje under markeringen (växlande)")
	...
	MenuLabel(AP_MENU_ID_WEB, "&Webb", NULL)
        ...
        MenuLabel(AP_MENU_ID_WEB_WEBPREVIEW,              "&Förhandsgranska som webbsida",    "Förhandsgranska dokumentet som webbsida")
	...
	MenuLabel(AP_MENU_ID_SPELL_ADD,			"&Lägg till", 		"Lägg till detta ord till den egna ordlistan")
     ...
     MenuLabel(AP_MENU_ID_AUTOTEXT_REFERENCE, "Angående:", "")
     MenuLabel(AP_MENU_ID_AUTOTEXT_SALUTATION, "Hälsningsfraser:", "")
     MenuLabel(AP_MENU_ID_AUTOTEXT_SUBJECT, "Ärende:", "")
