...
#ifndef AP_DIALOG_LATEX_ADVANCED_H
#define AP_DIALOG_LATEX_ADVANCED_H
...
class ABI_EXPORT AP_Dialog_Latex_Advanced : public XAP_Dialog_Modeless
{
public:
	AP_Dialog_Latex_Advanced(XAP_DialogFactory * pDlgFactory, XAP_Dialog_Id id);
	virtual ~AP_Dialog_Latex_Advanced(void);

	typedef enum { a_OK, a_CANCEL } tAnswer;

	AP_Dialog_Latex_Advanced::tAnswer		getAnswer(void) const;
...
protected:
	...
	AP_Dialog_Latex_Advanced::tAnswer  m_answer;
