...
BeginSet(EsES,UT_TRUE)
	...
	MenuLabel(AP_MENU_ID_EDIT_CUT,			"Cor&tar",			"Cortar la selección ponerla en el portapapeles")
	...
	MenuLabel(AP_MENU_ID_VIEW_SHOWPARA,		"Mostrar Párra&fos","Mostrar los caracteres no imprimibles")
	...
	MenuLabel(AP_MENU_ID_INSERT_SYMBOL,		"&Simbolo",			"Insertar un simbolo o otro carácter especial")
	...
	MenuLabel(AP_MENU_ID_FMT_BULLETS,		"Puntos y &numeración",	"Añadir o modifica puntos y numeración en los párrafos seleccionados")
