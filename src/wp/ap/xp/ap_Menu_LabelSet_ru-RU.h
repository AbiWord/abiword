...
MenuLabel(AP_MENU_ID_FILE,		"&Файл",		NULL)
 ...
 MenuLabel(AP_MENU_ID_FILE_PRINT_DIRECTLY,		"Печатать напр&ямую",			"Печатать документ не используя gnome-print")
 MenuLabel(AP_MENU_ID_FILE_PRINT_PREVIEW,	"П&редварительный просмотр",		"Посмотреть, как будет выгдядеть напечатанный документ") 
...
MenuLabel(AP_MENU_ID_VIEW,		"&Вид",			NULL)
 ...
 MenuLabel(AP_MENU_ID_VIEW_FULLSCREEN,	"Полно&экранный режим",		"Убрать все элементы пользовательского интерфейса кроме меню")
...
MenuLabel(AP_MENU_ID_FORMAT,		"Ф&орматирование",	NULL)
 ...
 MenuLabel( AP_MENU_ID_FMT_DOCUMENT,	"Параметры страни&цы",	"Изменить параметры печати")
...
MenuLabel(AP_MENU_ID_TOOLS,		"&Сервис",		NULL)   
 MenuLabel(AP_MENU_ID_TOOLS_SPELL,	"&Проверить правописание",	"Проверить документ на правописание")
 MenuLabel(AP_MENU_ID_TOOLS_SPELLING,	"&Правописание",	"Проверить документ на правописание") 
 MenuLabel(AP_MENU_ID_TOOLS_AUTOSPELL,	"Проверять &автоматически","Проверять правописание автоматически") 
