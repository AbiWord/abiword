...
BeginSetEnc(it,IT,true,"iso-8859-1")
	...
	MenuLabel(AP_MENU_ID_FILE_IMPORT,       	"&Apri copia",			"Importa il documento")
	MenuLabel(AP_MENU_ID_FILE_EXPORT,       	"&Salva copia",			"Salva il documento senza cambiarne il nome")
	...
	MenuLabel(AP_MENU_ID_EDIT_EDITFOOTER,		"Modifica pie' di pagina",	"Modifica pie' di pagina")
	MenuLabel(AP_MENU_ID_EDIT_REMOVEHEADER,		"Elimina intestazione",		"Toglie l'intestazione da questa pagina del documento")
	MenuLabel(AP_MENU_ID_EDIT_REMOVEFOOTER,		"Elimina pie' di pagina",	"Toglie il pie' di pagina da questa pagina del documento")
	...
	MenuLabel(AP_MENU_ID_VIEW_ZOOM_MENU, 		"&Zoom", "Riduzione o ingrandimento della visualizzazione di un documento")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM,			"&Zoom",				"Riduce o ingrandisce il documento visualizzato")
        ...
        MenuLabel(AP_MENU_ID_VIEW_ZOOM_WIDTH, 		"Zoom a &pagina intera ", "Zoom a pagina intera")
        MenuLabel(AP_MENU_ID_VIEW_ZOOM_WHOLE, 		"Zoom alla larghezza della &pagina", "Zoom alla larghezza della pagina")
	...
	MenuLabel(AP_MENU_ID_INSERT_ENDNOTE,		"&Nota di chiusura",			"Inserisci una nota di chiusura")
	...
	MenuLabel(AP_MENU_ID_TOOLS_SPELL,		"&Controllo ortografico",	"Controlla l'ortografia del documento")
        ...
        MenuLabel(AP_MENU_ID_TOOLS_SPELLPREFS, 		"&Opzioni controllo ortografico", "Setta le tue preferenze per il controllo ortografico")
	...
	MenuLabel(AP_MENU_ID_HELP_ABOUT_GNU, 		"Sul software libero &GNU", "Informazioni sul progetto GNU")
	MenuLabel(AP_MENU_ID_HELP_ABOUT_GNOMEOFFICE, 	"Su G&NOME Office", 	"Informazioni sul progetto GNOME Office")
