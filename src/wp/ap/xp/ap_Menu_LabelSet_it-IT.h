...
BeginSet(it,IT,true)
	...
	MenuLabel(AP_MENU_ID_INSERT_GRAPHIC,	"&Immagine",				"Inserisce un'immagine esistente, da un altro file")
	...
	MenuLabel(AP_MENU_ID_TOOLS_SPELL,		"&Controllo ortografico",	"Controlla l'ortografia del documento")
 	...
 	MenuLabel(AP_MENU_ID_TOOLS_WORDCOUNT,	"&Conta le parole",			"Conta il numero delle parole nel documento")
	...
	MenuLabel(AP_MENU_ID_HELP_INDEX,		"&Indice dell'Aiuto",		"Mostra l'indice dell'Aiuto")
