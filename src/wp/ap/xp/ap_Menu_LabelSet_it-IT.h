...
BeginSet(it,IT,true)
	...
	MenuLabel(AP_MENU_ID_FILE_SAVEASWEB,		"Salva come &web", "Salva il documento come pagina web")
	MenuLabel(AP_MENU_ID_FILE_WEBPREVIEW,		"Ant&eprima pagina web", "Anteprima del documento come pagina web")
