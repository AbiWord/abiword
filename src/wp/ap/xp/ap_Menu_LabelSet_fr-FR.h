...
BeginSetEnc(fr,FR,true,"iso-8859-1")
    ...
    MenuLabel(AP_MENU_ID_FILE_REVERT,			"&Version précédente",		"Revient à la version précédente du document")
    ...
    MenuLabel(AP_MENU_ID_EDIT_REPLACE,      	"R&emplacer",       		"Recherche et remplace le texte spécifié par un différent")
	...
	MenuLabel(AP_MENU_ID_EDIT_REMOVEHEADER,		"Enlever l'en-tête",		"Enlever l'en-tête de cette page du document")
    ...
    MenuLabel(AP_MENU_ID_VIEW_HEADFOOT,     	"&En-têtes et pieds de page","Edite le texte de l'en-tête et du pied de page")
    MenuLabel(AP_MENU_ID_VIEW_FULLSCREEN, 		"Plein é&cran", 			"Affiche le document en mode plein écran")
    MenuLabel(AP_MENU_ID_VIEW_ZOOM,         	"&Zoom",            		"Règle le facteur d'agrandissement")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM,				"&Zoom",					"Règle le facteur d'agrandissement")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM_200,			"&200%",					"Règle le facteur d'agrandissement à 200%")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM_100,			"&100%",					"Règle le facteur d'agrandissement à 100%")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM_75,			"&75%",						"Règle le facteur d'agrandissement à 75%")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM_50,			"&50%",						"Règle le facteur d'agrandissement à 50%")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM_WIDTH,		"&Largeur de page",			"Règle le facteur d'agrandissement à la largeur de page")
	MenuLabel(AP_MENU_ID_VIEW_ZOOM_WHOLE,		"&Toute la page",			"Règle le facteur d'agrandissement à la page entière")
    ...
    MenuLabel(AP_MENU_ID_INSERT_FILE,			"&Fichier",					"Insère le contenu d'un autre fichier")
    MenuLabel(AP_MENU_ID_INSERT_SYMBOL,     	"Caractères s&péciaux",    	"Insère un symbole ou un caractère spécial")
	MenuLabel(AP_MENU_ID_INSERT_ENDNOTE,		"&Note",					"Insère une note à la fin du document")
	...
	MenuLabel(AP_MENU_ID_FMT_HDRFTR,			"En-tête et pied de page",	"Définit les types d'en-tête et de pied de page")
	...
	MenuLabel(AP_MENU_ID_TOOLS_SPELLPREFS,		"&Options",					"Configure les options de vérification orthographique")
	...
	MenuLabel(AP_MENU_ID_HELP_CREDITS,			"&Crédits et remerciements","Affiche la mention des contributions")
