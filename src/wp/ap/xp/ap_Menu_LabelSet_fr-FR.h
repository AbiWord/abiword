...
BeginSetEnc(fr,FR,true,"iso-8859-1")
    ...
    MenuLabel(AP_MENU_ID_EDIT_EDITHEADER,		"Entête",					"Edite l'entête de la page")
    MenuLabel(AP_MENU_ID_EDIT_EDITFOOTER,		"Pied de page",				"Edite le pied de la page")
	MenuLabel(AP_MENU_ID_EDIT_REMOVEHEADER,		"Enlever l'entête",			"Enlever l'entête de cette page du document")
