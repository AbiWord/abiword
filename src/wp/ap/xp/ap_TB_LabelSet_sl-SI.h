...
// Slovenian translation provided by Andraz Tori <andraz.tori1@guest.arnes.si>
...
BeginSetEnc(sl,SI,true,"iso-8859-2")
	...
	ToolbarLabel(AP_TOOLBAR_ID_LISTS_NUMBERS,	"O¹tevilèenje",			tb_lists_numbers_xpm,		NULL, "O¹tevilèenje strani")
