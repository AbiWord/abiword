...
#include "ap_QNXDialog_MailMerge.h"
#include "ut_qnxHelper.h"


/*****************************************************************/

XAP_Dialog * AP_QNXDialog_MailMerge::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_QNXDialog_MailMerge * p = new AP_QNXDialog_MailMerge(pFactory,id);
	return p;
}

AP_QNXDialog_MailMerge::AP_QNXDialog_MailMerge(XAP_DialogFactory * pDlgFactory,
											   XAP_Dialog_Id id)
	: AP_Dialog_MailMerge(pDlgFactory,id)
{
}

AP_QNXDialog_MailMerge::~AP_QNXDialog_MailMerge(void)
{
}
