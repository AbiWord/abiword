...
#ifndef AP_QNXDIALOG_FORMATFRAME_H
#define AP_QNXDIALOG_FORMATFRAME_H
...
class AP_QNXDialog_FormatFrame: public AP_Dialog_FormatFrame
{
public:
	AP_QNXDialog_FormatFrame(XAP_DialogFactory * pDlgFactory, XAP_Dialog_Id id);
	virtual ~AP_QNXDialog_FormatFrame(void);
...
#endif /* AP_QNXDIALOG_FORMATFRAME_H */
