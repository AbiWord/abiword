...
/*****************************************************************/
EV_Toolbar_Control * AP_QNXToolbar_SizeCombo::static_constructor(EV_Toolbar * pToolbar,
														  XAP_Toolbar_Id id)
{
	AP_QNXToolbar_SizeCombo * p = new AP_QNXToolbar_SizeCombo(pToolbar,id);
	return p;
}

AP_QNXToolbar_SizeCombo::AP_QNXToolbar_SizeCombo(EV_Toolbar * pToolbar,
													 XAP_Toolbar_Id id)
...
AP_QNXToolbar_SizeCombo::~AP_QNXToolbar_SizeCombo(void)
{
