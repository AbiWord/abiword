...
#ifndef AP_QNXDIALOG_DOWNLOAD_FILE_H
#define AP_QNXDIALOG_DOWNLOAD_FILE_H
...
class ABI_EXPORT AP_QNXDialog_Download_File : public AP_Dialog_Download_File
{
public:
	AP_QNXDialog_Download_File(XAP_DialogFactory * pDlgFactory, XAP_Dialog_Id id);
	virtual ~AP_QNXDialog_Download_File(void);
