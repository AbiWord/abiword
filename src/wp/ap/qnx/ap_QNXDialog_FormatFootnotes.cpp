...
XAP_Dialog * AP_QNXDialog_FormatFootnotes::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_QNXDialog_FormatFootnotes * p = new AP_QNXDialog_FormatFootnotes(pFactory,id);
	return p;
}

AP_QNXDialog_FormatFootnotes::AP_QNXDialog_FormatFootnotes(XAP_DialogFactory * pDlgFactory,
											   XAP_Dialog_Id id)
	: AP_Dialog_FormatFootnotes(pDlgFactory,id)
{
}

AP_QNXDialog_FormatFootnotes::~AP_QNXDialog_FormatFootnotes(void)
{
}

void AP_QNXDialog_FormatFootnotes::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
