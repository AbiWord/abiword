...
#include "xap_QNXResources.rc2"

/*****************************************************************/

XAP_Dialog * AP_QNXDialog_Insert_Symbol::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_QNXDialog_Insert_Symbol * p = new AP_QNXDialog_Insert_Symbol(pFactory,id);
	return p;
}

AP_QNXDialog_Insert_Symbol::AP_QNXDialog_Insert_Symbol(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: XAP_Dialog_Insert_Symbol(pDlgFactory,id)
{
}

AP_QNXDialog_Insert_Symbol::~AP_QNXDialog_Insert_Symbol(void)
{
}

void AP_QNXDialog_Insert_Symbol::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
