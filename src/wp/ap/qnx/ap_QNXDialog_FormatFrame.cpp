...
PtWidget_t* AP_QNXDialog_FormatFrame::_constructWindow()
{
	...
	m_mainWindow = abiCreatePhabDialog("ap_QNXDialog_FormatFrame",m_WindowName); 
	...
	PtSetResource(abiPhabLocateWidget(m_mainWindow,"grpBorder"),Pt_ARG_TITLE,_(AP,DLG_FormatFrame_Borders),0);

	PtSetResource(abiPhabLocateWidget(m_mainWindow,"lblBorderColor"),Pt_ARG_TEXT_STRING,_(AP,DLG_FormatFrame_Border_Color),0);
	...
	PtSetResource(abiPhabLocateWidget(m_mainWindow,"grpBackground"),Pt_ARG_TITLE,_(AP,DLG_FormatFrame_Background),0);
	PtSetResource(abiPhabLocateWidget(m_mainWindow,"lblBackgroundColor"),Pt_ARG_TEXT_STRING,_(AP,DLG_FormatFrame_Background_Color),0);
	...
	PtSetResource(abiPhabLocateWidget(m_mainWindow,"grpPreview"),Pt_ARG_TITLE,_(AP,DLG_FormatFrame_Preview),0);
