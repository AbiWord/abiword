...
XAP_Dialog * AP_CocoaDialog_Columns::static_constructor(XAP_DialogFactory * pFactory,
													   XAP_Dialog_Id id)
{
	AP_CocoaDialog_Columns * p = new AP_CocoaDialog_Columns(pFactory,id);
	return p;
}
...
static void s_ok_clicked(GtkWidget * widget, AP_CocoaDialog_Columns * dlg)
{
...
static void s_one_clicked(GtkWidget * widget, AP_CocoaDialog_Columns * dlg)
{
	UT_ASSERT(widget && dlg);
	dlg->event_Toggle(1);
}
...
static void s_two_clicked(GtkWidget * widget, AP_CocoaDialog_Columns * dlg)
{
	UT_ASSERT(widget && dlg);
	dlg->event_Toggle(2);
}
...
static void s_three_clicked(GtkWidget * widget, AP_CocoaDialog_Columns * dlg)
{
	UT_ASSERT(widget && dlg);
	dlg->event_Toggle(3);
}

static void s_spin_changed(GtkWidget * widget, AP_CocoaDialog_Columns *dlg)
{
	UT_ASSERT(widget && dlg);
	dlg->readSpin();
}
...
static void s_HeightSpin_changed(GtkWidget * widget, AP_CocoaDialog_Columns *dlg)
{
	UT_ASSERT(widget && dlg);
	dlg->doHeightSpin();
}
...
static void s_SpaceAfterSpin_changed(GtkWidget * widget, AP_CocoaDialog_Columns *dlg)
{
	UT_ASSERT(widget && dlg);
...
static void s_SpaceAfterEntry_changed(GtkWidget * widget, AP_CocoaDialog_Columns *dlg)
{
	UT_ASSERT(widget && dlg);
...
static void s_MaxHeightEntry_changed(GtkWidget * widget, AP_CocoaDialog_Columns *dlg)
{
	UT_ASSERT(widget && dlg);
...
static void s_line_clicked(GtkWidget * widget, AP_CocoaDialog_Columns * dlg)
{
	UT_ASSERT(widget && dlg);
	dlg->checkLineBetween();
}

static void s_cancel_clicked(GtkWidget * widget, AP_CocoaDialog_Columns * dlg)
{
	UT_ASSERT(widget && dlg);
	dlg->event_Cancel();
}

static gboolean s_preview_exposed(GtkWidget * widget, gpointer /* data */, AP_CocoaDialog_Columns * dlg)
{
	UT_ASSERT(widget && dlg);
...
static gboolean s_window_exposed(GtkWidget * widget, gpointer /* data */, AP_CocoaDialog_Columns * dlg)
{
	UT_ASSERT(widget && dlg);
	dlg->event_previewExposed();
	return FALSE;
...
void AP_CocoaDialog_Columns::doHeightSpin(void)
{
...
void AP_CocoaDialog_Columns::doMaxHeightEntry(void)
{
...
void AP_CocoaDialog_Columns::event_WindowDelete(void)
{
	m_answer = AP_Dialog_Columns::a_CANCEL;
	gtk_main_quit();
}

void AP_CocoaDialog_Columns::event_previewExposed(void)
{
...
GtkWidget * AP_CocoaDialog_Columns::_constructWindow(void)
{
...
void AP_CocoaDialog_Columns::_constructWindowContents(GtkWidget * windowColumns)
{
	GtkWidget *frame2;
	GtkWidget *vbox1;
	GtkWidget *hbox1;
...
void AP_CocoaDialog_Columns::_connectsignals(void)
{
...
void AP_CocoaDialog_Columns::_populateWindowData(void)
{
	// We're a pretty stateless dialog, so we just set up
	// the defaults from our members.
}

void AP_CocoaDialog_Columns::_storeWindowData(void)
{
}
