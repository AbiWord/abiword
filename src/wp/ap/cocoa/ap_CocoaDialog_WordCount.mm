...
XAP_Dialog * AP_CocoaDialog_WordCount::static_constructor(XAP_DialogFactory * pFactory, XAP_Dialog_Id id)
{
	AP_CocoaDialog_WordCount * p = new AP_CocoaDialog_WordCount(pFactory,id);
	return p;
}
...
static void s_ok_clicked(GtkWidget * widget, AP_CocoaDialog_WordCount * dlg)
{
...
static void s_update_clicked(GtkWidget * widget, AP_CocoaDialog_WordCount * dlg)
{
	UT_ASSERT(widget && dlg);
	dlg->event_Update();
}

static void s_autocheck_clicked(GtkWidget * widget, AP_CocoaDialog_WordCount * dlg)
{
	UT_ASSERT(widget && dlg);
	dlg->event_Checkbox();
}
...
void AP_CocoaDialog_WordCount::event_OK(void)
{
...
void  AP_CocoaDialog_WordCount::set_sensitivity(void)
{
	if(m_bAutoWC == true)
	{
...
void AP_CocoaDialog_WordCount::event_Checkbox(void)
{
...
void AP_CocoaDialog_WordCount::event_WindowDelete(void)
{
...
GtkWidget * AP_CocoaDialog_WordCount::_constructWindow(void)
{
	GtkWidget * vbox;
...
GtkWidget * AP_CocoaDialog_WordCount::_constructWindowContents(void)
{
	GtkWidget * tophbox;
