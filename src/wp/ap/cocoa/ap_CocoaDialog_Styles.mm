...
XAP_Dialog * AP_CocoaDialog_Styles::static_constructor(XAP_DialogFactory * pFactory,
													   XAP_Dialog_Id id)
{
	AP_CocoaDialog_Styles * p = new AP_CocoaDialog_Styles(pFactory,id);
	return p;
}

AP_CocoaDialog_Styles::AP_CocoaDialog_Styles(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
  : AP_Dialog_Styles(pDlgFactory,id), m_whichRow(0), m_whichCol(0), m_whichType(AP_CocoaDialog_Styles::USED_STYLES)
{
	m_windowMain = NULL;
...
{
	AP_CocoaDialog_Styles * dlg = static_cast <AP_CocoaDialog_Styles *>(d);
...
static void s_remove_property(GtkWidget * widget, AP_CocoaDialog_Styles * me)
{
	UT_ASSERT(widget && me);
	me->event_RemoveProperty();
}

static void s_style_name(GtkWidget * widget, AP_CocoaDialog_Styles * me)
{
	UT_ASSERT(widget && me);
	me->new_styleName();
}
...
static void s_basedon(GtkWidget * widget, AP_CocoaDialog_Styles * me)
{
	UT_ASSERT(widget && me);
...
static void s_followedby(GtkWidget * widget, AP_CocoaDialog_Styles * me)
{
	UT_ASSERT(widget && me);
	if(me->isModifySignalBlocked())
		return;
...
static void s_styletype(GtkWidget * widget, AP_CocoaDialog_Styles * me)
{
	UT_ASSERT(widget && me);
	if(me->isModifySignalBlocked())
		return;
...
static void s_apply_clicked(GtkWidget * widget, AP_CocoaDialog_Styles * me)
{
	UT_ASSERT(widget && me);
	me->event_Apply();
}

static void s_close_clicked(GtkWidget * widget, AP_CocoaDialog_Styles * me)
{
	UT_ASSERT(widget && me);
	me->event_Close();
}
...
static void s_modify_ok_clicked(GtkWidget * widget, AP_CocoaDialog_Styles * me)
{
	UT_ASSERT(widget && me);
	me->event_Modify_OK();
}

static void s_modify_cancel_clicked(GtkWidget * widget, AP_CocoaDialog_Styles * me)
{
	UT_ASSERT(widget && me);
	me->event_Modify_Cancel();
}

static gboolean s_paraPreview_exposed(GtkWidget * widget, gpointer /* data */, AP_CocoaDialog_Styles * me)
{
	UT_ASSERT(widget && me);
...
static gboolean s_charPreview_exposed(GtkWidget * widget, gpointer /* data */, AP_CocoaDialog_Styles * me)
{
	UT_ASSERT(widget && me);
	me->event_paraPreviewExposed();
	return FALSE;
...
static gboolean s_modifyPreview_exposed(GtkWidget * widget, gpointer /* data */, AP_CocoaDialog_Styles * me)
{
	UT_ASSERT(widget && me);
...
static gboolean s_modify_window_exposed(GtkWidget * widget, gpointer /* data */, AP_CocoaDialog_Styles * me)
{
	UT_ASSERT(widget && me);
	me->event_ModifyPreviewExposed();
	return FALSE;
...
static gboolean s_window_exposed(GtkWidget * widget, gpointer /* data */, AP_CocoaDialog_Styles * me)
{
	UT_ASSERT(widget && me);
	me->event_paraPreviewExposed();
...
//
	...
	// make a new Cocoa GC
	DELETEP (m_pParaPreviewWidget);
	m_pParaPreviewWidget = new GR_CocoaGraphics(m_wParaPreviewArea->window, unixapp->getFontManager(), m_pApp);
	...
	// make a new Cocoa GC
	DELETEP (m_pCharPreviewWidget);
	m_pCharPreviewWidget = new GR_CocoaGraphics(m_wCharPreviewArea->window, unixapp->getFontManager(), m_pApp);
...
void AP_CocoaDialog_Styles::event_WindowDelete(void)
{
	m_answer = AP_Dialog_Styles::a_CANCEL;
	gtk_main_quit();
}
...
void AP_CocoaDialog_Styles::event_DeleteClicked(void)
{
	if (m_whichRow != -1)
    {
        gchar * style = NULL;
...
void AP_CocoaDialog_Styles::event_ClistClicked(gint row, gint col)
{
	m_whichRow = row;
	m_whichCol = col;
...
void AP_CocoaDialog_Styles::event_ListClicked(const char * which)
{
	const XAP_StringSet * pSS = m_pApp->getStringSet();
...
GtkWidget * AP_CocoaDialog_Styles::_constructWindow(void)
{
...
GtkWidget* AP_CocoaDialog_Styles::_constructWindowContents(
									GtkWidget * windowStyles)
{
	GtkWidget * vboxContents;
...
void AP_CocoaDialog_Styles::_connectsignals(void) const
{
...
void AP_CocoaDialog_Styles::_populateCList(void) const
{
...
GtkWidget *  AP_CocoaDialog_Styles::_constructModifyDialog(void)
{
...
void  AP_CocoaDialog_Styles::_constructModifyDialogContents(GtkWidget * container)
{
...
void   AP_CocoaDialog_Styles::_constructGnomeModifyButtons( GtkWidget * dialog_action_area)
{
...
void  AP_CocoaDialog_Styles::_constructFormatList(GtkWidget * FormatMenu)
{
...
void AP_CocoaDialog_Styles::event_ModifyDelete(void)
{
	m_answer = AP_Dialog_Styles::a_CANCEL;
	gtk_main_quit();
}
...
//
	...
	DELETEP (m_pAbiPreviewWidget);
	m_pAbiPreviewWidget = new GR_CocoaGraphics(m_wModifyDrawingArea->window, unixapp->getFontManager(), m_pApp);
...
bool  AP_CocoaDialog_Styles::isModifySignalBlocked(void) const
{
	return m_bBlockModifySignal;
}

void  AP_CocoaDialog_Styles::setModifySignalBlocked( bool val)
{
