...
EV_Toolbar_Control * AP_CocoaToolbar_ZoomCombo::static_constructor(EV_Toolbar * pToolbar,
														  XAP_Toolbar_Id id)
{
	AP_CocoaToolbar_ZoomCombo * p = new AP_CocoaToolbar_ZoomCombo(pToolbar,id);
	return p;
}
...
AP_CocoaToolbar_ZoomCombo::~AP_CocoaToolbar_ZoomCombo(void)
{
...
bool AP_CocoaToolbar_ZoomCombo::populate(void)
{
