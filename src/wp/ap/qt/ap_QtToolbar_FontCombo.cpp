...
EV_Toolbar_Control * AP_QtToolbar_FontCombo::static_constructor(EV_Toolbar * pToolbar,
														  XAP_Toolbar_Id id)
{
	AP_QtToolbar_FontCombo * p = new AP_QtToolbar_FontCombo(pToolbar,id);
	return p;
}

AP_QtToolbar_FontCombo::AP_QtToolbar_FontCombo(EV_Toolbar * pToolbar,
												   XAP_Toolbar_Id id)
...
AP_QtToolbar_FontCombo::~AP_QtToolbar_FontCombo(void)
{
	// nothing to purge.  contents are static strings
}

bool AP_QtToolbar_FontCombo::populate(void)
{
