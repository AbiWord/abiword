...
AP_Win32Dialog_Stub::AP_Win32Dialog_Stub(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: AP_Dialog_Stub(pDlgFactory,id)
{
}

AP_Win32Dialog_Stub::~AP_Win32Dialog_Stub(void)
{
}

void AP_Win32Dialog_Stub::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
