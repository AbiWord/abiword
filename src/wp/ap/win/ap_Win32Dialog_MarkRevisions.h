...
#ifndef AP_WIN32DIALOG_MARKREVISIONS_H
...
class ABI_EXPORT AP_Win32Dialog_MarkRevisions: public AP_Dialog_MarkRevisions, XAP_Win32DialogBase
{
public:
	AP_Win32Dialog_MarkRevisions(XAP_DialogFactory * pDlgFactory, XAP_Dialog_Id id);
	virtual ~AP_Win32Dialog_MarkRevisions(void);
