...
#define GWL(hwnd)		(AP_Win32Dialog_Paragraph*)GetWindowLongW((hwnd), DWL_USER)
#define SWL(hwnd, d)	(AP_Win32Dialog_Paragraph*)SetWindowLongW((hwnd), DWL_USER,(LONG)(d))
...
#define _COMBO(c,i)				\
	case AP_RID_DIALOG_##c:		\
		...
		{						\
			case CBN_SELCHANGE:	\
				_setMenuItemValue(i,SendMessageW(hWndCtrl,CB_GETCURSEL,0,0));	\
				return 1;	\
							\
			default:		\
				return 0;	\
