...
#ifndef AP_Win32Dialog_Insert_Symbol_H
#define AP_Win32Dialog_Insert_Symbol_H
...
class AP_Win32Dialog_Insert_Symbol: public AP_Dialog_Insert_Symbol
{
public:
	AP_Win32Dialog_Insert_Symbol(XAP_DialogFactory * pDlgFactory, XAP_Dialog_Id id);
	virtual ~AP_Win32Dialog_Insert_Symbol(void);
...
#endif /* AP_Win32Dialog_Insert_Symbol_H */
