...
XAP_Dialog * AP_BeOSDialog_New::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_BeOSDialog_New * p = new AP_BeOSDialog_New(pFactory,id);
	return p;
}

AP_BeOSDialog_New::AP_BeOSDialog_New(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: AP_Dialog_New(pDlgFactory,id)
{
}

AP_BeOSDialog_New::~AP_BeOSDialog_New(void)
{
}

void AP_BeOSDialog_New::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
