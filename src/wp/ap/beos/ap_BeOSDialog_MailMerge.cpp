...
#include "ap_BeOSDialog_MailMerge.h"

#include "ut_Rehydrate.h"

/*****************************************************************/

XAP_Dialog * AP_BeOSDialog_MailMerge::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_BeOSDialog_MailMerge * p = new AP_BeOSDialog_MailMerge(pFactory,id);
	return p;
}

AP_BeOSDialog_MailMerge::AP_BeOSDialog_MailMerge(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: AP_Dialog_MailMerge(pDlgFactory,id)
{
}

AP_BeOSDialog_MailMerge::~AP_BeOSDialog_MailMerge(void)
{
}
