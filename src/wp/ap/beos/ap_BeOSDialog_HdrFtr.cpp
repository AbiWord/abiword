...
XAP_Dialog * AP_BeOSDialog_HdrFtr::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_BeOSDialog_HdrFtr * p = new AP_BeOSDialog_HdrFtr(pFactory,id);
	return p;
}

AP_BeOSDialog_HdrFtr::AP_BeOSDialog_HdrFtr(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: AP_Dialog_HdrFtr(pDlgFactory,id)
{
}

AP_BeOSDialog_HdrFtr::~AP_BeOSDialog_HdrFtr(void)
{
}

void AP_BeOSDialog_HdrFtr::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
