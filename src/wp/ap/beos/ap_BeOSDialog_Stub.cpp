...
#include "ap_BeOSDialog_Stub.h"

#include "ut_Rehydrate.h"

/*****************************************************************/

XAP_Dialog * AP_BeOSDialog_Stub::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_BeOSDialog_Stub * p = new AP_BeOSDialog_Stub(pFactory,id);
	return p;
}

AP_BeOSDialog_Stub::AP_BeOSDialog_Stub(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: AP_Dialog_Stub(pDlgFactory,id)
{
}

AP_BeOSDialog_Stub::~AP_BeOSDialog_Stub(void)
{
}

void AP_BeOSDialog_Stub::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
