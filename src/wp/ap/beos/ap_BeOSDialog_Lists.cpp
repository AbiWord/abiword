...
XAP_Dialog * AP_BeOSDialog_Lists::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_BeOSDialog_Lists * p = new AP_BeOSDialog_Lists(pFactory,id);
	return p;
}

AP_BeOSDialog_Lists::AP_BeOSDialog_Lists(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: AP_Dialog_Lists(pDlgFactory,id)
{
}

AP_BeOSDialog_Lists::~AP_BeOSDialog_Lists(void)
{
}
...
void AP_BeOSDialog_Lists::runModeless(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
