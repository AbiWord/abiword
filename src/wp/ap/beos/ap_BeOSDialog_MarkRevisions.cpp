...
XAP_Dialog * AP_BeOSDialog_MarkRevisions::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_BeOSDialog_MarkRevisions * p = new AP_BeOSDialog_MarkRevisions(pFactory,id);
	return p;
}

AP_BeOSDialog_MarkRevisions::AP_BeOSDialog_MarkRevisions(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: AP_Dialog_MarkRevisions(pDlgFactory,id)
{
}

AP_BeOSDialog_MarkRevisions::~AP_BeOSDialog_MarkRevisions(void)
{
}

void AP_BeOSDialog_MarkRevisions::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
...
/*
	...
	2.  Do a case sensitive global replace on the words MarkRevisions and STUB
		in both files.
