...
#ifndef AP_BEOSDIALOG_LISTS_H
#define AP_BEOSDIALOG_LISTS_H
...
class AP_BeOSDialog_Lists: public AP_Dialog_Lists
{
public:
	AP_BeOSDialog_Lists(XAP_DialogFactory * pDlgFactory, XAP_Dialog_Id id);
	virtual ~AP_BeOSDialog_Lists(void);
