...
XAP_Dialog * AP_BeOSDialog_Styles::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_BeOSDialog_Styles * p = new AP_BeOSDialog_Styles(pFactory,id);
	return p;
}

AP_BeOSDialog_Styles::AP_BeOSDialog_Styles(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: AP_Dialog_Styles(pDlgFactory,id)
{
}

AP_BeOSDialog_Styles::~AP_BeOSDialog_Styles(void)
{
}

void AP_BeOSDialog_Styles::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
