...
#include "ap_BeOSDialog_ToggleCase.h"

#include "ut_Rehydrate.h"

/*****************************************************************/

XAP_Dialog * AP_BeOSDialog_ToggleCase::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_BeOSDialog_ToggleCase * p = new AP_BeOSDialog_ToggleCase(pFactory,id);
	return p;
}

AP_BeOSDialog_ToggleCase::AP_BeOSDialog_ToggleCase(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: AP_Dialog_ToggleCase(pDlgFactory,id)
{
}

AP_BeOSDialog_ToggleCase::~AP_BeOSDialog_ToggleCase(void)
{
}

void AP_BeOSDialog_ToggleCase::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
