...
#include "ap_BeOSDialog_Stylist.h"


/*****************************************************************/

XAP_Dialog * AP_BeOSDialog_Stylist::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_BeOSDialog_Stylist * p = new AP_BeOSDialog_Stylist(pFactory,id);
	return p;
}

void AP_BeOSDialog_Stylist::destroy()
{

}

void AP_BeOSDialog_Stylist::setStyleInGUI(void)
{
	UT_ASSERT(0);
}
void AP_BeOSDialog_Stylist::activate()
{

}

AP_BeOSDialog_Stylist::AP_BeOSDialog_Stylist(XAP_DialogFactory * pDlgFactory,
											   XAP_Dialog_Id id)
	: AP_Dialog_Stylist(pDlgFactory,id)
{
}

AP_BeOSDialog_Stylist::~AP_BeOSDialog_Stylist(void)
{
}

void AP_BeOSDialog_Stylist::runModeless(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
