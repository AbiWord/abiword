...
#include "ap_BeOSDialog_MetaData.h"

#include "ut_Rehydrate.h"

/*****************************************************************/

XAP_Dialog * AP_BeOSDialog_MetaData::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	AP_BeOSDialog_MetaData * p = new AP_BeOSDialog_MetaData(pFactory,id);
	return p;
}

AP_BeOSDialog_MetaData::AP_BeOSDialog_MetaData(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: AP_Dialog_MetaData(pDlgFactory,id)
{
}

AP_BeOSDialog_MetaData::~AP_BeOSDialog_MetaData(void)
{
}

void AP_BeOSDialog_MetaData::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
