...
public:
	...
	{		
		...
		abi_text_indent,
		abi_text_position,
	    abi_toc_dest_style_1,
	    abi_toc_dest_style_2,
	    abi_toc_dest_style_3,
	    abi_toc_dest_style_4,
        abi_toc_id,
	    abi_toc_has_heading,
		abi_toc_heading,
		abi_toc_has_label1,
		...
		abi_toc_page_type3,
		abi_toc_page_type4,
	    abi_toc_source_style_1,
	    abi_toc_source_style_2,
	    abi_toc_source_style_3,
	    abi_toc_source_style_4,
		abi_top_color,
		abi_top_style,
		abi_top_thickness,
		abi_widows,
