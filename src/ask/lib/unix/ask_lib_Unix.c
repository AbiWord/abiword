...
GtkWidget* create_window1 ()
{
  ...
  g_object_set_data (G_OBJECT (window1), "vbox1", vbox1);
  ...
  g_object_set_data (G_OBJECT (window1), "hseparator1", hseparator1);
  gtk_widget_show (hseparator1);
  gtk_box_pack_start (GTK_BOX (vbox1), hseparator1, FALSE, TRUE, 0);

  hbuttonbox1 = gtk_hbutton_box_new ();
  g_object_set_data (G_OBJECT (window1), "hbuttonbox1", hbuttonbox1);
  ...
  g_object_set_data (G_OBJECT (window1), "button_cancel", button_cancel);
  gtk_widget_show (button_cancel);
  gtk_container_add (GTK_CONTAINER (hbuttonbox1), button_cancel);
  g_signal_connect (G_OBJECT (button_cancel), "clicked",
					  G_CALLBACK (cb_button_cancel_clicked), NULL);
...
int ASK_DoScreen_choosedir(char* pszFileSetName, char* pszDefaultPath, char** ppszPath)
{
	...
	g_object_set_data (G_OBJECT (g_window), "label2", label2);
	{
		GtkStyle* style;
...

	{
		...
		g_object_set_data (G_OBJECT (g_window), "label3", label3);
	...
	g_object_set_data (G_OBJECT (g_window), "label4", label4);
	...
	g_signal_connect (G_OBJECT (button_browse), "clicked",
						G_CALLBACK (cb_button_browse_clicked), NULL);
...
int ASK_YesNo(char* pszTitle, char* pszMessage)
{
	...
	g_object_set_data (G_OBJECT (dialog1), "label1", label1);
	...
	hbuttonbox1 = gtk_hbutton_box_new ();
	g_object_set_data (G_OBJECT (dialog1), "hbuttonbox1", hbuttonbox1);
	gtk_widget_show (hbuttonbox1);
	gtk_box_pack_start (GTK_BOX (dialog_action_area1), hbuttonbox1, TRUE, TRUE, 0);

	button2 = gtk_button_new_with_label ("Yes");
	g_object_set_data (G_OBJECT (dialog1), "button2", button2);
	gtk_widget_show (button2);
	gtk_container_add (GTK_CONTAINER (hbuttonbox1), button2);
	g_signal_connect (G_OBJECT (button2), "clicked",
						G_CALLBACK (cb_button_yes_clicked), NULL);

	button3 = gtk_button_new_with_label ("No");
	g_object_set_data (G_OBJECT (dialog1), "button3", button3);
	gtk_widget_show (button3);
	gtk_container_add (GTK_CONTAINER (hbuttonbox1), button3);
	g_signal_connect (G_OBJECT (button3), "clicked",
						G_CALLBACK (cb_button_no_clicked), NULL);
