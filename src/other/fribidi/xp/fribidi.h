...
extern "C"
{
  ...
  fbd_boolean fribidi_log2vis (	/* input */
  ...
  fbd_boolean fribidi_log2vis_get_embedding_levels (	/* input */
						 FriBidiChar *str,
						 FriBidiStrIndex len,
 ...
 *----------------------------------------------------------------------*/
  fbd_boolean fribidi_get_mirror_char (	/* Input */
				    FriBidiChar ch,
				    /* Output */
 ...
 *----------------------------------------------------------------------*/
  fbd_boolean fribidi_is_char_rtl (FriBidiLevel *embedding_level_list,
 ...
 *----------------------------------------------------------------------*/
  void fribidi_xpos_resolve (int x_pos, int x_offset,
			     ...
			     fbd_boolean *res_cursor_dir_is_rtl,
			     fbd_boolean *res_attach_before);
