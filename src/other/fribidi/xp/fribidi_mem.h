...
{
#endif
/* The INT32 define screws win32, so I just got rid of it ...
#define INT8 char
#define INT16 short
#define INT32 long
*/
	
/* had to rename this to fbd_boolean, as there is boolean defined on
   windows which is incompatible with this one. */
  typedef int fbd_boolean;

/* Got rid of the macros define above in the following typedef's */
