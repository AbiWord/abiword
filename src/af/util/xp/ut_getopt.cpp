...
char* UT_getOpt::nextchar = 0;
int UT_getOpt::first_nonopt = 0;
int UT_getOpt::last_nonopt = 0;

UT_getOpt::UT_getOpt (int argc, char **argv, const char *optstring)
