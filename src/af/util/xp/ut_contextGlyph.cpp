...
static LigatureData s_ligature[] =
{
	...
	*/
	...
	// Arabic
//	{0x0626, 0x0627, 1, 1, /*0xFBEB*/1, /*0xFBEA*/1},
//	{0x0626, 0x062c, /*0xFC97*/1, 1, 1, /*0xFC00*/1},
//	{0x0626, 0x062d, /*0xFC98*/1, 1, 1, /*0xFC01*/1},
//	{0x0626, 0x062e, /*0xFC99*/1, 1, 1, 1},
//	{0x0626, 0x0631, 1, 1, /*0xFC64*/1, 1},
//	{0x0626, 0x0632, 1, 1, /*0xFC65*/1, 1},
//	{0x0626, 0x0645, /*0xFC9A*/1, /*0xFCDF*/1, /*0xFC66*/1, /*0xFC02*/1},
//	{0x0626, 0x0646, 1, 1, /*0xFC67*/1, 1},
// 	{0x0626, 0x0647, /*0xFC9b*/1, /*0xFCE0*/1, 1, 1},
//	{0x0626, 0x0648, 1, 1, /*0xFBEF*/1, /*0xFBEE*/1},
//	{0x0626, 0x0649, 1, 1, /*0xFC68*/1, /*0xFC03*/1},
//	{0x0626, 0x064a, 1, 1, /*0xFC69*/1, /*0xFC04*/1},
//	{0x0626, 0x06c7, 1, 1, /*0xFBF1*/1, /*0xFBF0*/1},
//	{0x0626, 0x06c6, 1, 1, /*0xFBF3*/1, /*0xFBF2*/1},
//	{0x0626, 0x06c8, 1, 1, /*0xFBF5*/1, /*0xFBF4*/1},
//	{0x0626, 0x06d0, 1, 1, /*0xFBF7*/1, /*0xFBF6*/1},
//	{0x0626, 0x06d5, 1, 1, /*0xFBED*/1, /*0xFBEC*/1},

// 	{0x0627, 0x064B, 1, 1, /*0xFD3C*/1, /*0xFD3D*/1},
	
//	{0x0628, 0x062c, /*0xFC9c*/1, 1, 1, /*0xFC05*/1},
//	{0x0628, 0x062d, /*0xFC9d*/1, 1, 1, /*0xFC06*/1},
//	{0x0628, 0x062e, /*0xFC9e*/1, 1, 1, /*0xFC07*/1},
//	{0x0628, 0x0631, 1, 1, /*0xFC6a*/1, 1},
//	{0x0628, 0x0632, 1, 1, /*0xFC6b*/1, 1},
// 	{0x0628, 0x0645, /*0xFC9f*/1, /*0xFCE1*/1, /*0xFC6c*/1, /*0xFC08*/1},
//	{0x0628, 0x0646, 1, 1, /*0xFC6d*/1, 1},
// 	{0x0628, 0x0647, /*0xFCa0*/1, /*0xFCE2*/1, 1, 1},
//	{0x0628, 0x0649, 1, 1, /*0xFC6e*/1, /*0xFC09*/1},
//	{0x0628, 0x064a, 1, 1, /*0xFC6f*/1, /*0xFC0A*/1},

// 	{0x062a, 0x062c, /*0xFCa1*/1, 1, 1, /*0xFC0B*/1},
// 	{0x062a, 0x062d, /*0xFCa2*/1, 1, 1, /*0xFC0C*/1},
// 	{0x062a, 0x062e, /*0xFCa3*/1, 1, 1, /*0xFC0D*/1},
//	{0x062a, 0x0631, 1, 1, /*0xFC70*/1, 1},
//	{0x062a, 0x0632, 1, 1, /*0xFC71*/1, 1},
//	{0x062a, 0x0645, /*0xFCa4*/1, /*0xFCE3*/1, /*0xFC72*/1, /*0xFC0E*/1},
//	{0x062a, 0x0646, 1, 1, /*0xFC73*/1, 1},
// 	{0x062a, 0x0647, /*0xFCa5*/1, /*0xFCE4*/1, 1, 1},
//	{0x062a, 0x0649, 1, 1, /*0xFC74*/1, /*0xFC0F*/1},
//	{0x062a, 0x064a, 1, 1, /*0xFC75*/1, /*0xFC10*/1},

// 	{0x062b, 0x062c, 1, 1, 1, /*0xFC11*/1},
//	{0x062b, 0x0631, 1, 1, /*0xFC76*/1, 1},
//	{0x062b, 0x0632, 1, 1, /*0xFC77*/1, 1},
// 	{0x062b, 0x0645, /*0xFCA6*/1, /*0xFCE5*/1, /*0xFC78*/1, /*0xFC12*/1},
//	{0x062b, 0x0646, 1, 1, /*0xFC79*/1, 1},
// 	{0x062b, 0x0647, 1, /*0xFCE6*/1, 1, 1},
//	{0x062b, 0x0649, 1, 1, /*0xFC7a*/1, /*0xFC13*/1},
//	{0x062b, 0x064a, 1, 1, /*0xFC7b*/1, /*0xFC14*/1},
	
// 	{0x062c, 0x062d, /*0xFCA7*/1, 1, 1, /*0xFC15*/1},
// 	{0x062c, 0x0645, /*0xFCA8*/1, 1, 1, /*0xFC16*/1},
// 	{0x062c, 0x0649, 1, 1, /*0xFD1D*/1, /*0xFD01*/1},
// 	{0x062c, 0x064a, 1, 1, /*0xFD1E*/1, /*0xFD02*/1},
	
// 	{0x062d, 0x062c, /*0xFCA9*/1, 1, 1, /*0xFC17*/1},
// 	{0x062d, 0x0645, /*0xFCAA*/1, 1, 1, /*0xFC18*/1},
// 	{0x062d, 0x0649, 1, 1, /*0xFD1B*/1, /*0xFCFF*/1},
// 	{0x062d, 0x064a, 1, 1, /*0xFD1C*/1, /*0xFD00*/1},

// 	{0x062e, 0x062c, /*0xFCAB*/1, 1, 1, /*0xFC19*/1},
// 	{0x062e, 0x062d, 1, 1, 1, /*0xFC1A*/1},
// 	{0x062e, 0x0645, /*0xFCAC*/1, 1, 1, /*0xFC1B*/1},
// 	{0x062e, 0x0649, 1, 1, /*0xFD1F*/1, /*0xFD03*/1},
// 	{0x062e, 0x064a, 1, 1, /*0xFD20*/1, /*0xFD04*/1},

//	{0x0630, /*0x0670*/1, 1, 1, 1, /*0xFC5b*/1},

//	{0x0631, /*0x0670*/1, 1, 1, 1, /*0xFC5c*/1},
	
// 	{0x0633, 0x062c, /*0xFCAD*/1, /*0xFD34*/1, 1, /*0xFC1C*/1},
// 	{0x0633, 0x062d, /*0xFCAE*/1, /*0xFD35*/1, 1, /*0xFC1D*/1},
// 	{0x0633, 0x062e, /*0xFCAF*/1, /*0xFD36*/1, 1, /*0xFC1E*/1},
// 	{0x0634, 0x0631, 1, 1, /*0xFD2A*/1, /*0xFD0e*/1},
// 	{0x0633, 0x0645, /*0xFCB0*/1, /*0xFCE7*/1, 1, /*0xFC1F*/1},
// 	{0x0633, 0x0647, /*0xFD31*/1, /*0xFCE8*/1, 1, 1},
// 	{0x0633, 0x0649, 1, 1, /*0xFD17*/1, /*0xFCFB*/1},
// 	{0x0633, 0x064a, 1, 1, /*0xFD18*/1, /*0xFCFC*/1},

// 	{0x0634, 0x062c, /*0xFD2D*/1, /*0xFD37*/1, /*0xFD25*/1, /*0xFD09*/1},
// 	{0x0634, 0x062d, /*0xFD2E*/1, /*0xFD38*/1, /*0xFD26*/1, /*0xFD0a*/1},
// 	{0x0634, 0x062e, /*0xFD2F*/1, /*0xFD39*/1, /*0xFD27*/1, /*0xFD0b*/1},
// 	{0x0634, 0x0631, 1, 1, /*0xFD29*/1, /*0xFD0d*/1},
// 	{0x0634, 0x0645, /*0xFD30*/1, /*0xFCE9*/1, /*0xFD28*/1, /*0xFD0c*/1},
// 	{0x0634, 0x0647, /*0xFD32*/1, /*0xFCEA*/1, 1, 1},
// 	{0x0634, 0x0649, 1, 1, /*0xFD19*/1, /*0xFCFD*/1},
// 	{0x0634, 0x064a, 1, 1, /*0xFD1A*/1, /*0xFCFE*/1},
	
// 	{0x0635, 0x062d, /*0xFCB1*/1, 1, 1, /*0xFC20*/1},
// 	{0x0635, 0x062e, /*0xFCB2*/1, 1, 1, 1},
// 	{0x0635, 0x0631, 1, 1, /*0xFD2B*/1, /*0xFD0f*/1},
// 	{0x0635, 0x0645, /*0xFCB3*/1, 1, 1, /*0xFC21*/1},
// 	{0x0635, 0x0649, 1, 1, /*0xFD21*/1, /*0xFD05*/1},
// 	{0x0635, 0x064a, 1, 1, /*0xFD22*/1, /*0xFD06*/1},

// 	{0x0636, 0x062c, /*0xFCB4*/1, 1, 1, /*0xFC22*/1},
// 	{0x0636, 0x062d, /*0xFCB5*/1, 1, 1, /*0xFC23*/1},
// 	{0x0636, 0x062e, /*0xFCB6*/1, 1, 1, /*0xFC24*/1},
// 	{0x0636, 0x0631, 1, 1, /*0xFD2C*/1, /*0xFD10*/1},
// 	{0x0636, 0x0645, /*0xFCB7*/1, 1, 1, /*0xFC25*/1},
// 	{0x0636, 0x0649, 1, 1, /*0xFD23*/1, /*0xFD07*/1},
// 	{0x0636, 0x064a, 1, 1, /*0xFD24*/1, /*0xFD08*/1},

// 	{0x0637, 0x062d, /*0xFCB8*/1, 1, 1, /*0xFC26*/1},
//	{0x0637, 0x0645, /*0xFD33*/1, /*0xFD3A*/1, 1, /*0xFC27*/1},
// 	{0x0637, 0x0649, 1, 1, /*0xFD11*/1, /*0xFCF5*/1},
// 	{0x0637, 0x064a, 1, 1, /*0xFD12*/1, /*0xFCF6*/1},
	
// 	{0x0638, 0x0645, /*0xFCB9*/1, /*0xFD3B*/1, 1, /*0xFC28*/1},

// 	{0x0639, 0x062c, /*0xFCBA*/1, 1, 1, /*0xFC29*/1},
// 	{0x0639, 0x0645, /*0xFCBB*/1, 1, 1, /*0xFC2A*/1},
// 	{0x0639, 0x0649, 1, 1, /*0xFD13*/1, /*0xFCF7*/1},
// 	{0x0639, 0x064a, 1, 1, /*0xFD14*/1, /*0xFCF8*/1},

// 	{0x063A, 0x062c, /*0xFCBC*/1, 1, 1, /*0xFC2B*/1},
// 	{0x063A, 0x0645, /*0xFCBD*/1, 1, 1, /*0xFC2C*/1},
// 	{0x063A, 0x0649, 1, 1, /*0xFD15*/1, /*0xFCF9*/1},
// 	{0x063A, 0x064a, 1, 1, /*0xFD16*/1, /*0xFCFA*/1},

// 	{0x0641, 0x062c, /*0xFCBE*/1, 1, 1, /*0xFC2D*/1},
// 	{0x0641, 0x062d, /*0xFCBF*/1, 1, 1, /*0xFC2E*/1},
// 	{0x0641, 0x062e, /*0xFCC0*/1, 1, 1, /*0xFC2F*/1},
// 	{0x0641, 0x0645, /*0xFCC1*/1, 1, 1, /*0xFC30*/1},
//	{0x0641, 0x0649, 1, 1, /*0xFC7c*/1, /*0xFC31*/1},
//	{0x0641, 0x064a, 1, 1, /*0xFC7d*/1, /*0xFC32*/1},

// 	{0x0642, 0x062d, /*0xFCC2*/1, 1, 1, /*0xFC33*/1},
// 	{0x0642, 0x0645, /*0xFCC3*/1, 1, 1, /*0xFC34*/1},
//	{0x0642, 0x0649, 1, 1, /*0xFC7e*/1, /*0xFC35*/1},
//	{0x0642, 0x064a, 1, 1, /*0xFC7f*/1, /*0xFC36*/1},

//	{0x0643, 0x0627, 1, 1, /*0xFC80*/1, /*0xFC37*/1},
// 	{0x0643, 0x062c, /*0xFCC4*/1, 1, 1, /*0xFC38*/1},
// 	{0x0643, 0x062d, /*0xFCC5*/1, 1, 1, /*0xFC39*/1},
// 	{0x0643, 0x062e, /*0xFCC6*/1, 1, 1, /*0xFC3a*/1},
// 	{0x0643, 0x0644, /*0xFCC7*/1, /*0xFCEB*/1, /*0xFC81*/1, /*0xFC3b*/1},
// 	{0x0643, 0x0645, /*0xFCC8*/1, /*0xFCEC*/1, /*0xFC82*/1, /*0xFC3c*/1},
//	{0x0643, 0x0649, 1, 1, /*0xFC83*/1, /*0xFC3d*/1},
//	{0x0643, 0x064a, 1, 1, /*0xFC84*/1, /*0xFC3e*/1},
...
// 	{0x0644, 0x062c, /*0xFCC9*/1, 1, 1, /*0xFC3f*/1},
// 	{0x0644, 0x062d, /*0xFCCA*/1, 1, 1, /*0xFC40*/1},
// 	{0x0644, 0x062e, /*0xFCCB*/1, 1, 1, /*0xFC41*/1},
// 	{0x0644, 0x0645, /*0xFCCC*/1, /*0xFCED*/1, /*0xFC85*/1, /*0xFC42*/1},
// 	{0x0644, 0x0647, /*0xFCCD*/1, 1, 1, 1},
//	{0x0644, 0x0649, 1, 1, /*0xFC86*/1, /*0xFC43*/1},
//	{0x0644, 0x064a, 1, 1, /*0xFC87*/1, /*0xFC44*/1},
	
//	{0x0645, 0x0627, 1, 1, /*0xFC88*/1, 1},
// 	{0x0645, 0x062c, /*0xFCCE*/1, 1, 1, /*0xFC45*/1},
// 	{0x0645, 0x062d, /*0xFCCF*/1, 1, 1, /*0xFC46*/1},
// 	{0x0645, 0x062e, /*0xFCD0*/1, 1, 1, /*0xFC47*/1},
// 	{0x0645, 0x0645, /*0xFCD1*/1, 1, /*0xFC89*/1, /*0xFC48*/1},
//	{0x0645, 0x0649, 1, 1, 1, /*0xFC49*/1},
//	{0x0645, 0x064a, 1, 1, 1, /*0xFC4a*/1},

// 	{0x0646, 0x062c, /*0xFCD2*/1, 1, 1, /*0xFC4b*/1},
// 	{0x0646, 0x062d, /*0xFCD3*/1, 1, 1, /*0xFC4c*/1},
// 	{0x0646, 0x062e, /*0xFCD4*/1, 1, 1, /*0xFC4d*/1},
//	{0x0646, 0x0631, 1, 1, /*0xFC8a*/1, 1},
//	{0x0646, 0x0632, 1, 1, /*0xFC8b*/1, 1},
// 	{0x0646, 0x0645, /*0xFCD5*/1, /*0xFCEE*/1, /*0xFC8c*/1, /*0xFC4e*/1},
//	{0x0646, 0x0646, 1, 1, /*0xFC8d*/1, 1},
// 	{0x0646, 0x0647, /*0xFCD6*/1, /*0xFCEF*/1, 1, 1},
//	{0x0646, 0x0649, 1, 1, /*0xFC8e*/1, /*0xFC4f*/1},
//	{0x0646, 0x064a, 1, 1, /*0xFC8f*/1, /*0xFC50*/1},

// 	{0x0647, 0x062c, /*0xFCD7*/1, 1, 1, /*0xFC51*/1},
// 	{0x0647, 0x0645, /*0xFCD8*/1, 1, 1, /*0xFC52*/1},
// 	{0x0647, 0x0649, 1, 1, 1, /*0xFC53*/1},
// 	{0x0647, 0x064a, 1, 1, 1, /*0xFC54*/1},
// 	{0x0647, /*0x0670*/1, /*0xFCD9*/1, 1, 1, 1},

//	{0x0649, /*0x0670*/1, 1, 1, /*0xFC90*/1, /*0xFC5d*/1},
	
// 	{0x064a, 0x062c, /*0xFCDA*/1, 1, 1, /*0xFC55*/1},
// 	{0x064a, 0x062d, /*0xFCDB*/1, 1, 1, /*0xFC56*/1},
// 	{0x064a, 0x062e, /*0xFCDC*/1, 1, 1, /*0xFC57*/1},
//	{0x064a, 0x0631, 1, 1, /*0xFC91*/1, 1},
//	{0x064a, 0x0632, 1, 1, /*0xFC92*/1, 1},
// 	{0x064a, 0x0645, /*0xFCDD*/1, /*0xFCF0*/1, /*0xFC93*/1, /*0xFC58*/1},
//	{0x064a, 0x0646, 1, 1, /*0xFC94*/1, 1},
// 	{0x064a, 0x0647, /*0xFCDE*/1, /*0xFCF1*/1, 1, 1},
// 	{0x064a, 0x0649, 1, 1, /*0xFC95*/1, /*0xFC59*/1},
// 	{0x064a, 0x064a, 1, 1, /*0xFC96*/1, /*0xFC5a*/1},
...
//	{0x06b1, /*0xFB9C*/1, /*0xFB9D*/1, /*0xFB9B*/1, /*0xFB9A*/1},
// 	{0x06b2, 0xFE, 0xFE, 0xFE, 0xFE},
//	{0x06b3, /*0xFB98*/1, /*0xFB99*/1, /*0xFB97*/1, /*0xFB96*/1},
...
// the following vectors hold ranges of characters that do not require
