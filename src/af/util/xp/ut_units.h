...
ABI_EXPORT UT_sint32 UT_convertToLayoutUnits(const char* s);
...
ABI_EXPORT UT_sint32 UT_docUnitsFromPaperUnits(GR_Graphics * pG, UT_sint32 iPaperUnits);
ABI_EXPORT UT_sint32 UT_layoutUnitsFromPaperUnits(UT_sint32 iPaperUnits);
ABI_EXPORT UT_sint32 UT_paperUnitsFromLayoutUnits(UT_sint32 iLayoutUnits);
