...
XAP_Dialog * XAP_QNXDialog_ClipArt::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	XAP_QNXDialog_ClipArt * p = new XAP_QNXDialog_ClipArt(pFactory,id);
	return p;
}

XAP_QNXDialog_ClipArt::XAP_QNXDialog_ClipArt(XAP_DialogFactory * pDlgFactory,
											   XAP_Dialog_Id id)
	: XAP_Dialog_ClipArt(pDlgFactory,id)
{
}

XAP_QNXDialog_ClipArt::~XAP_QNXDialog_ClipArt(void)
{
}

void XAP_QNXDialog_ClipArt::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
