...
// for more info.
#if 0
static int s_color_wheel_clicked(GtkWidget * area,
                                  GdkEvent * event)
{
...
static int s_color_update(GtkWidget * /* widget */,
						   GdkEvent * /* event */,
						   XAP_QNXDialog_FontChooser * dlg)
{
	UT_ASSERT(dlg);
	dlg->updatePreview();
...
static int s_drawing_area_expose(GtkWidget * w,
								  GdkEventExpose * /* pExposeEvent */)
{
	XAP_QNXDialog_FontChooser * dlg = (XAP_QNXDialog_FontChooser *)
...
#if 0
void XAP_QNXDialog_FontChooser::set_notebook_tab(GtkWidget * notebook, int page_num,
												 GtkWidget * widget)
{
...
#if 0
void * XAP_QNXDialog_FontChooser::create_windowFontSelection(void)
{
