...
#include "xap_QNXDlg_Stub.h"
#include "ut_qnxHelper.h"


/*****************************************************************/

XAP_Dialog * XAP_QNXDialog_Stub::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	XAP_QNXDialog_Stub * p = new XAP_QNXDialog_Stub(pFactory,id);
	return p;
}

XAP_QNXDialog_Stub::XAP_QNXDialog_Stub(XAP_DialogFactory * pDlgFactory,
											   XAP_Dialog_Id id)
	: XAP_Dialog_Stub(pDlgFactory,id)
{
}

XAP_QNXDialog_Stub::~XAP_QNXDialog_Stub(void)
{
}

void XAP_QNXDialog_Stub::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
