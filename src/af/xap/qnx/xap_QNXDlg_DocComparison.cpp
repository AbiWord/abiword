...
#include "xap_QNXDlg_DocComparison.h"
#include "ut_qnxHelper.h"


/*****************************************************************/

XAP_Dialog * XAP_QNXDialog_DocComparison::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	XAP_QNXDialog_DocComparison * p = new XAP_QNXDialog_DocComparison(pFactory,id);
	return p;
}

XAP_QNXDialog_DocComparison::XAP_QNXDialog_DocComparison(XAP_DialogFactory * pDlgFactory,
											   XAP_Dialog_Id id)
	: XAP_Dialog_DocComparison(pDlgFactory,id)
{
}

XAP_QNXDialog_DocComparison::~XAP_QNXDialog_DocComparison(void)
{
}

void XAP_QNXDialog_DocComparison::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
