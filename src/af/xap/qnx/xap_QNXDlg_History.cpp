...
#include "xap_QNXDlg_History.h"
#include "ut_qnxHelper.h"


/*****************************************************************/

XAP_Dialog * XAP_QNXDialog_History::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	XAP_QNXDialog_History * p = new XAP_QNXDialog_History(pFactory,id);
	return p;
}

XAP_QNXDialog_History::XAP_QNXDialog_History(XAP_DialogFactory * pDlgFactory,
											   XAP_Dialog_Id id)
	: XAP_Dialog_History(pDlgFactory,id)
{
}

XAP_QNXDialog_History::~XAP_QNXDialog_History(void)
{
}

void XAP_QNXDialog_History::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
