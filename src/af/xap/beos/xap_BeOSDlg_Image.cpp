...
#include "xap_BeOSDlg_Image.h"

#include "ut_Rehydrate.h"

/*****************************************************************/

XAP_Dialog * XAP_BeOSDialog_Image::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	XAP_BeOSDialog_Image * p = new XAP_BeOSDialog_Image(pFactory,id);
	return p;
}

XAP_BeOSDialog_Image::XAP_BeOSDialog_Image(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: XAP_Dialog_Image(pDlgFactory,id)
{
}

XAP_BeOSDialog_Image::~XAP_BeOSDialog_Image(void)
{
}

void XAP_BeOSDialog_Image::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
