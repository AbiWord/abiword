...
#include "xap_BeOSDlg_Stub.h"

#include "ut_Rehydrate.h"

/*****************************************************************/

XAP_Dialog * XAP_BeOSDialog_Stub::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	XAP_BeOSDialog_Stub * p = new XAP_BeOSDialog_Stub(pFactory,id);
	return p;
}

XAP_BeOSDialog_Stub::XAP_BeOSDialog_Stub(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: XAP_Dialog_Stub(pDlgFactory,id)
{
}

XAP_BeOSDialog_Stub::~XAP_BeOSDialog_Stub(void)
{
}

void XAP_BeOSDialog_Stub::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
