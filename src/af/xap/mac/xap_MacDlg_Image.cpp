...
#include "xap_MacDlg_Image.h"


/*****************************************************************/

XAP_Dialog * XAP_MacDialog_Image::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	XAP_MacDialog_Image * p = new XAP_MacDialog_Image(pFactory,id);
	return p;
}

XAP_MacDialog_Image::XAP_MacDialog_Image(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: XAP_Dialog_Image(pDlgFactory,id)
{
}

XAP_MacDialog_Image::~XAP_MacDialog_Image(void)
{
}

void XAP_MacDialog_Image::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
