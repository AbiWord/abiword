...
#include "xap_MacDlg_Password.h"


/*****************************************************************/

XAP_Dialog * XAP_MacDialog_Password::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	XAP_MacDialog_Password * p = new XAP_MacDialog_Password(pFactory,id);
	return p;
}

XAP_MacDialog_Password::XAP_MacDialog_Password(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: XAP_Dialog_Password(pDlgFactory,id)
{
}

XAP_MacDialog_Password::~XAP_MacDialog_Password(void)
{
}

void XAP_MacDialog_Password::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
