...
#include "xap_MacDlg_ClipArt.h"


/*****************************************************************/

XAP_Dialog * XAP_MacDialog_ClipArt::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	XAP_MacDialog_ClipArt * p = new XAP_MacDialog_ClipArt(pFactory,id);
	return p;
}

XAP_MacDialog_ClipArt::XAP_MacDialog_ClipArt(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: XAP_Dialog_ClipArt(pDlgFactory,id)
{
}

XAP_MacDialog_ClipArt::~XAP_MacDialog_ClipArt(void)
{
}

void XAP_MacDialog_ClipArt::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
