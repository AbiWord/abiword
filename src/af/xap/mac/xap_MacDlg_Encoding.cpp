...
#include "xap_MacDlg_Encoding.h"


/*****************************************************************/

XAP_Dialog * XAP_MacDialog_Encoding::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	XAP_MacDialog_Encoding * p = new XAP_MacDialog_Encoding(pFactory,id);
	return p;
}

XAP_MacDialog_Encoding::XAP_MacDialog_Encoding(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: XAP_Dialog_Encoding(pDlgFactory,id)
{
}

XAP_MacDialog_Encoding::~XAP_MacDialog_Encoding(void)
{
}

void XAP_MacDialog_Encoding::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
