...
#include "xap_MacDlg_PluginManager.h"


/*****************************************************************/

XAP_Dialog * XAP_MacDialog_PluginManager::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	XAP_MacDialog_PluginManager * p = new XAP_MacDialog_PluginManager(pFactory,id);
	return p;
}

XAP_MacDialog_PluginManager::XAP_MacDialog_PluginManager(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: XAP_Dialog_PluginManager(pDlgFactory,id)
{
}

XAP_MacDialog_PluginManager::~XAP_MacDialog_PluginManager(void)
{
}

void XAP_MacDialog_PluginManager::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
