...
/* ID of first AP ALRT resource */
#define AP_FIRST_ALRT			2000
...
/* ID of first AP DITL resource */
#define AP_FIRST_DITL			2000

/* 'STR ' resource IDs */
#define HFDR_STR_ID				128

/* ID of first AP STR resource */
#define AP_FIRST_STR			2000
