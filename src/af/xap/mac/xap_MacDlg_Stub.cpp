...
XAP_Dialog * XAP_MacDialog_Stub::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	XAP_MacDialog_Stub * p = new XAP_MacDialog_Stub(pFactory,id);
	return p;
}

XAP_MacDialog_Stub::XAP_MacDialog_Stub(XAP_DialogFactory * pDlgFactory,
												 XAP_Dialog_Id id)
	: XAP_Dialog_Stub(pDlgFactory,id)
{
}

XAP_MacDialog_Stub::~XAP_MacDialog_Stub(void)
{
}

void XAP_MacDialog_Stub::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
