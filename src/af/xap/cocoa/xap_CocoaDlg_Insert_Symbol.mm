...
XAP_Dialog * XAP_CocoaDialog_Insert_Symbol::static_constructor(XAP_DialogFactory * pFactory,
															  XAP_Dialog_Id id)
{
	XAP_CocoaDialog_Insert_Symbol * p = new XAP_CocoaDialog_Insert_Symbol(pFactory,id);
	return p;
}
...
static gboolean s_ok_clicked(GtkWidget * widget, XAP_CocoaDialog_Insert_Symbol * dlg)
{
	UT_ASSERT(widget && dlg);
	dlg->event_OK();
        return FALSE;
}
static gboolean s_cancel_clicked(GtkWidget * widget, XAP_CocoaDialog_Insert_Symbol * dlg)
{
	UT_ASSERT(widget && dlg);
	dlg->event_Cancel();
        return FALSE;
...
static void s_new_font(GtkWidget * widget, XAP_CocoaDialog_Insert_Symbol * dlg)
{
	UT_ASSERT(widget && dlg);
	dlg->New_Font();
}
...
void XAP_CocoaDialog_Insert_Symbol::runModeless(XAP_Frame * pFrame)
{
	...
	// make a new Cocoa GC
	DELETEP (m_unixGraphics);
	m_unixGraphics = new GR_CocoaGraphics(m_SymbolMap->window, unixapp->getFontManager(), m_pApp);
	...
	// make a new Cocoa GC
	DELETEP (m_unixarea);
	m_unixarea = new GR_CocoaGraphics(m_areaCurrentSym->window, unixapp->getFontManager(), m_pApp);
...
void XAP_CocoaDialog_Insert_Symbol::Key_Pressed(GdkEventKey * e)
{
	int move = 0;
...
void XAP_CocoaDialog_Insert_Symbol::SymbolMap_clicked( GdkEvent * event)
{
	UT_uint32 x, y;
...
void XAP_CocoaDialog_Insert_Symbol::event_WindowDelete(void)
{
	m_answer = XAP_Dialog_Insert_Symbol::a_CANCEL;	
	g_list_free( m_InsertS_Font_list);
...
GtkWidget * XAP_CocoaDialog_Insert_Symbol::_constructWindow(void)
{
...
GtkWidget *XAP_CocoaDialog_Insert_Symbol::_previewNew (int w, int h)
{
...
void XAP_CocoaDialog_Insert_Symbol::CurrentSymbol_clicked(GdkEvent *event)
{
...
GtkWidget *XAP_CocoaDialog_Insert_Symbol::_createComboboxWithFonts (void)
{
...
void XAP_CocoaDialog_Insert_Symbol::_connectSignals (void)
{
	...
	// Code stolen from ev_CocoaGnomeToolbar.cpp
