...
XAP_Dialog * XAP_CocoaDialog_WindowMore::static_constructor(XAP_DialogFactory * pFactory,
													   XAP_Dialog_Id id)
{
	XAP_CocoaDialog_WindowMore * p = new XAP_CocoaDialog_WindowMore(pFactory,id);
	return p;
}
...
static void s_ok_clicked(GtkWidget * widget,
						 XAP_CocoaDialog_WindowMore * dlg)
{
...
void XAP_CocoaDialog_WindowMore::event_WindowDelete(void)
{
	m_answer = XAP_Dialog_WindowMore::a_CANCEL;	
	gtk_main_quit();
}
...
gint XAP_CocoaDialog_WindowMore::_GetFromList(void)
{
...
GtkWidget * XAP_CocoaDialog_WindowMore::_constructWindow(void)
{
