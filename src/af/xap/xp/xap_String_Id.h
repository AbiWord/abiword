...
dcl(DLG_FOSA_RecordToFileTitle,			"Record editting to File")
dcl(DLG_FOSA_ReplayFromFileTitle,		"Replay Editting from File")
...
dcl(DLG_FOSA_RecordToFileLabel,		    "File to record editting:")
dcl(DLG_FOSA_ReplayFromFileLabel,		"File to replay editting:")
