...
dcl(LANG_2,								"English (Canada)")
dcl(LANG_3,								"English (UK)")
dcl(LANG_4,								"English (Ireland)")
dcl(LANG_5,								"English (New Zealand)")
dcl(LANG_6,								"English (South Africa)")
dcl(LANG_7,								"English (US)")
dcl(LANG_8,								"Afrikaans")
dcl(LANG_9,								"Arabic (Egypt)")
dcl(LANG_10,								"Arabic (Saudi Arabia)")
dcl(LANG_11,								"Armenian")
dcl(LANG_12,								"Chinese (Hong Kong)")
dcl(LANG_13,								"Chinese (PRC)")
dcl(LANG_14,								"Chinese (Singapore)")
dcl(LANG_15,								"Chinese (Taiwan)")
dcl(LANG_16,								"Czech")
dcl(LANG_17,								"Danish")
dcl(LANG_18,								"Dutch (Netherlands)")
dcl(LANG_19,								"Farsi")
dcl(LANG_20,								"Finnish")
dcl(LANG_21,								"French (France)")
dcl(LANG_22,								"Georgian")
dcl(LANG_23,								"German (Austria)")
dcl(LANG_24,								"German (Germany)")
dcl(LANG_25,								"Greek")
dcl(LANG_26,								"Hebrew")
dcl(LANG_27,								"Hindi")
dcl(LANG_28,								"Italian (Italy)")
dcl(LANG_29,								"Japanese")
dcl(LANG_30,								"Korean")
dcl(LANG_31,								"Lithuanian")
dcl(LANG_32,								"Norwegian Bokmal")
dcl(LANG_33,								"Norwegian Nynorsk")
dcl(LANG_34,								"Portuguese (Brazil)")
dcl(LANG_35,								"Portuguese (Portugal)")
dcl(LANG_36,								"Russian (Russia)")
dcl(LANG_37,								"Spanish (Mexico)")
dcl(LANG_38,								"Spanish (Spain)")
dcl(LANG_39,								"Swedish")
dcl(LANG_40,								"Thai")
dcl(LANG_41,								"Turkish")
dcl(LANG_42,								"Vietnamese")
