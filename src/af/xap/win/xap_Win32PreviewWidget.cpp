...
#define GWL(hwnd)		(XAP_Win32PreviewWidget *)GetWindowLongW((hwnd), GWL_USERDATA)
#define SWL(hwnd, f)	(XAP_Win32PreviewWidget *)SetWindowLongW((hwnd), GWL_USERDATA,(LONG)(f))
