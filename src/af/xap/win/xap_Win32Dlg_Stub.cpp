...
#include "xap_Win32Dlg_Stub.h"

#include "xap_Win32Resources.rc2"

/*****************************************************************/

XAP_Dialog * XAP_Win32Dialog_Stub::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	XAP_Win32Dialog_Stub * p = new XAP_Win32Dialog_Stub(pFactory,id);
	return p;
}

XAP_Win32Dialog_Stub::XAP_Win32Dialog_Stub(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: XAP_Dialog_Stub(pDlgFactory,id)
{
}

XAP_Win32Dialog_Stub::~XAP_Win32Dialog_Stub(void)
{
}
