...
{	
	...
	m_page.hIcon  = nullptr;
	m_page.pszIcon  = nullptr;	
	m_page.pszTemplate = lpTemplate;
	m_page.pfnDlgProc = m_pfnDlgProc;
	m_page.lParam = (LPARAM) this;
	m_page.pfnCallback = nullptr;
	m_page.pcRefParent  = nullptr;
