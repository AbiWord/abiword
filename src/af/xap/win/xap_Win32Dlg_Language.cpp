...
{		
	...
	{
		pThis = (XAP_Win32Dialog_Language *)GetWindowLongW(hWnd,GWL_USERDATA);
		TVITEMW tvi;   
...
BOOL XAP_Win32Dialog_Language::_onInitDialog(HWND hWnd, WPARAM /*wParam*/, LPARAM /*lParam*/)
{
	...
	gTreeProc = (WHICHPROC) GetWindowLongW(hTree, GWL_WNDPROC);
	SetWindowLongW(hTree, GWL_WNDPROC, (LONG)s_treeProc);
	SetWindowLongW(hTree, GWL_USERDATA, (LONG)this);
