 ...
 *	  - fixed typos
 *  modified: AbiSource, Inc. Aug 7 1998
 *    - updated to use function prototypes
 *  modified: AbiSource, Inc. Jan 2 1999
 *    - wrapped with exclusive include switches
 *    - wrapped TRUE and FALSE declarations to fit with previous
 *      definitions.
 */

#ifndef XAP_UNIXPSPARSEAFM_H
#define XAP_UNIXPSPARSEAFM_H
