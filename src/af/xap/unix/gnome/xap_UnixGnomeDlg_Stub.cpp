...
#include "xap_UnixGnomeDlg_Stub.h"

/*****************************************************************/

XAP_Dialog * XAP_UnixGnomeDialog_Stub::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	XAP_UnixGnomeDialog_Stub * p = new XAP_UnixGnomeDialog_Stub(pFactory,id);
	return p;
}

XAP_UnixGnomeDialog_Stub::XAP_UnixGnomeDialog_Stub(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: XAP_Dialog_Stub(pDlgFactory,id)
{
}

XAP_UnixGnomeDialog_Stub::~XAP_UnixGnomeDialog_Stub(void)
{
}

void XAP_UnixGnomeDialog_Stub::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
