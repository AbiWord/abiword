...
XAP_Dialog * XAP_UnixDialog_DocComparison::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
...
XAP_UnixDialog_DocComparison::XAP_UnixDialog_DocComparison(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
...
/*
	...
	2.  Do a case sensitive global replace on the words DocComparison and DOCCOMPARISON
		in both files. 
