...
XAP_Dialog * XAP_UnixDialog_Stub::static_constructor(XAP_DialogFactory * pFactory,
													 XAP_Dialog_Id id)
{
	XAP_UnixDialog_Stub * p = new XAP_UnixDialog_Stub(pFactory,id);
	return p;
}

XAP_UnixDialog_Stub::XAP_UnixDialog_Stub(XAP_DialogFactory * pDlgFactory,
										 XAP_Dialog_Id id)
	: XAP_Dialog_Stub(pDlgFactory,id)
{
}

XAP_UnixDialog_Stub::~XAP_UnixDialog_Stub(void)
{
}

void XAP_UnixDialog_Stub::runModal(XAP_Frame * pFrame)
{
	UT_ASSERT(pFrame);
