...
GtkWidget * XAP_UnixDialog_About::_constructWindow(void)
{
	...
	g_object_set_data (G_OBJECT (windowAbout), "windowAbout", windowAbout);
	...
	g_object_set_data (G_OBJECT (windowAbout), "hboxAbout", hboxAbout);
	gtk_widget_show (hboxAbout);
	gtk_container_add (GTK_CONTAINER (windowAbout), hboxAbout);

	drawingareaGraphic = createDrawingArea ();
	g_object_set_data (G_OBJECT (windowAbout), "drawingareaGraphic", drawingareaGraphic);
	...
	g_object_set_data (G_OBJECT (windowAbout), "vboxInfo", vboxInfo);
	...
	g_object_set_data (G_OBJECT (windowAbout), "labelTitle", labelTitle);
	...
	g_object_set_data (G_OBJECT (windowAbout), "labelVersion", labelVersion);
	...
	g_object_set_data (G_OBJECT (windowAbout), "textCopyright", textCopyright);
	...
	g_signal_connect(G_OBJECT(buttonURL),
					   "clicked",
					   G_CALLBACK(s_url_clicked),
					   (gpointer) this);

	g_signal_connect(G_OBJECT(windowAbout),
							 "delete_event",
							 G_CALLBACK(s_delete_clicked),
							 (gpointer) this);

	g_signal_connect_after(G_OBJECT(windowAbout),
							 "destroy",
							 NULL,
							 NULL);
