...
class ABI_PLUGIN_EXPORT UT_Multipart
{
...
class ABI_PLUGIN_EXPORT IE_Imp_MHT_Sniffer : public IE_ImpSniffer
{
	friend class IE_Imp;
...
class ABI_PLUGIN_EXPORT IE_Imp_MHT : public IE_Imp_XHTML
{
public:
