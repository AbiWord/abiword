...
{
  UT_return_val_if_fail(text, nullptr);
...
URLDict_removeFromMenus()
{
  ...
  EV_EditMethod * pEM = ev_EditMethod_lookup ( "URLDict_invoke" ) ;
  ...
  pFact->removeMenuItem("Main",nullptr,URLDict_MenuLabel);
  pFact->removeMenuItem("contextText",nullptr,URLDict_MenuLabel);
...
URLDict_addToMenus()
{
  ...
  EV_EditMethod *myEditMethod = new EV_EditMethod(
						  "URLDict_invoke",  // name of callback function
						  URLDict_invoke,    // callback function itself.
  ...
  pFact->addNewLabel(nullptr,newID,URLDict_MenuLabel, URLDict_MenuTooltip);
