...
pt2Constructor DialogGrammar_Constructor = &AP_UnixDialog_Grammar::static_constructor;
...
AP_UnixDialog_Grammar::_constructWindow (void)
{
	...
	std::string ui_path = static_cast<XAP_UnixApp*>(XAP_App::getApp())->getAbiSuiteAppUIDir() + "/UnixDialogGrammar.xml";
