...
GrammarChecker *
DialogGrammar::_getChecker (void)
{
	...
	else
	{
		...
		// TODO GPB check if method is implemented correctly
...
#if 0
bool
DialogGrammar::_grammarCheckSentence (const UT_UCSChar * sentence, size_t len)
{
...
DialogGrammar::DialogGrammar(XAP_DialogFactory * pDlgFactory, XAP_Dialog_Id id)
...
DialogGrammar::~DialogGrammar(void)
{
	UT_DEBUGMSG(("DEBUG: DialogGrammar destructor called\n"));
...
void DialogGrammar::_purgeMistakes(void)
{
...
void DialogGrammar::runModal(XAP_Frame * pFrame)
{
 ...
 */
bool DialogGrammar::nextWrongSentence(void)
{
...
bool DialogGrammar::nextSentenceMistake()
{
...
bool DialogGrammar::makeMistakeVisible()
{
...
void DialogGrammar::ignoreMistake(void)
{
	//m_bSkipSentence = true;
}

bool DialogGrammar::changeMistakeWith(const UT_UCSChar * newword)
{
	bool result = true;
...
void DialogGrammar::_updateSentenceMistakesPos(UT_sint32 iOffset)
{
