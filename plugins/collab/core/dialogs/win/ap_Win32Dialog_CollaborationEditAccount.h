...
#ifndef AP_WIN32DIALOG_COLLABORATIONEDITACCOUNT_H
#define AP_WIN32DIALOG_COLLABORATIONEDITACCOUNT_H
...
#include "ap_Win32Res_DlgCollaborationEditAccount.rc2"

class XAP_Frame;

class AP_Win32Dialog_CollaborationEditAccount : public AP_Dialog_CollaborationEditAccount
{
public:
	AP_Win32Dialog_CollaborationEditAccount(XAP_DialogFactory * pDlgFactory, XAP_Dialog_Id id);
