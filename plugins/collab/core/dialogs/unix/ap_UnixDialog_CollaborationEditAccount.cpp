...
GtkWidget * AP_UnixDialog_CollaborationEditAccount::_constructWindow(void)
{
	...
	std::string ui_path = static_cast<XAP_UnixApp*>(XAP_App::getApp())->getAbiSuiteAppUIDir() + "/ap_UnixDialog_CollaborationEditAccount.xml";
	...
	m_wEmbeddingParent = GTK_VBOX(GTK_WIDGET(object));
