...
GtkWidget * AP_UnixDialog_CollaborationEditAccount::_constructWindow(void)
{
	...
	GtkBuilder* builder = newDialogBuilder("ap_UnixDialog_CollaborationEditAccount.xml");
#else
	GtkBuilder* builder = newDialogBuilder("ap_UnixDialog_CollaborationEditAccount-2.xml");
#endif
