...
class ABI_PLUGIN_EXPORT IE_Imp_WordPerfectGraphics_Sniffer : public IE_ImpGraphicSniffer
{
	friend class IE_Imp;
...
class ABI_PLUGIN_EXPORT IE_Imp_WordPerfectGraphics : public IE_ImpGraphic
{
public:
