...
class ABI_PLUGIN_EXPORT IE_Exp_WordPerfect_Sniffer : public IE_ExpSniffer
{
	friend class IE_Exp;
...
class ABI_PLUGIN_EXPORT IE_Exp_WordPerfect : public IE_Exp
{
...
class ABI_PLUGIN_EXPORT WordPerfect_Listener : public PL_Listener
{
public:
