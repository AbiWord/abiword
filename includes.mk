...
ABI_CFLAGS=@WARNING_CFLAGS@ @DEBUG_CFLAGS@ @OPTIMIZE_CFLAGS@ \
	...
	@PSICONV_CFLAGS@ @WV_CFLAGS@ @LIBPNG_CFLAGS@
...
if WITH_MACOSX
	PLATFORM_LIBS=-framework Carbon -framework CoreServices -framework ApplicationServices
	PLATFORM_CFLAGS=-I'$(top_builddir)/src/af/util/unix' \
		-DXP_MAC_TARGET_MACOSX -DXP_MAC_TARGET_CARBON -DXP_MAC_TARGET_QUARTZ \
		-fpascal-strings -DCARBON_ON_MACH_O=1 -DNO_SYS_ERRLIST -I/Developer/Headers/FlatCarbon
endif

CXXFLAGS=$(ABI_CFLAGS) $(PLATFORM_CFLAGS)
